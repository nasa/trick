...
int VSTest::default_vars()
{
    ...
    snprintf(point_dyn_array[0].point_label_obj.label_text, sizeof(point_dyn_array[0].point_label_obj.label_text),
    ...
    snprintf(point_dyn_array[0].point_dyn_label_array[0].label_text,
        sizeof(point_dyn_array[0].point_dyn_label_array[0].label_text), "Dyn Label 1 for Array Point 1");
    snprintf(point_dyn_array[0].point_dyn_label_array[1].label_text,
        sizeof(point_dyn_array[0].point_dyn_label_array[1].label_text), "Dyn Label 2 for Array Point 1");
    snprintf(point_dyn_array[0].point_static_label_array[0].label_text,
        sizeof(point_dyn_array[0].point_static_label_array[0].label_text), "Static Label 1 for Array Point 1");
    snprintf(point_dyn_array[0].point_static_label_array[1].label_text,
        sizeof(point_dyn_array[0].point_static_label_array[1].label_text), "Static Label 2 for Array Point 1");

    point_dyn_array[1]                 = Point(3.3, 4.4);
    point_dyn_array[1].point_label_obj = PointLabel();
    snprintf(point_dyn_array[1].point_label_obj.label_text, sizeof(point_dyn_array[1].point_label_obj.label_text),
    ...
    snprintf(point_dyn_array[1].point_dyn_label_array[0].label_text,
        sizeof(point_dyn_array[1].point_dyn_label_array[0].label_text), "Dyn Label 1 for Array Point 2");
    snprintf(point_dyn_array[1].point_dyn_label_array[1].label_text,
        sizeof(point_dyn_array[1].point_dyn_label_array[1].label_text), "Dyn Label 2 for Array Point 2");
    snprintf(point_dyn_array[1].point_static_label_array[0].label_text,
        sizeof(point_dyn_array[1].point_static_label_array[0].label_text), "Static Label 1 for Array Point 2");
    snprintf(point_dyn_array[1].point_static_label_array[1].label_text,
        sizeof(point_dyn_array[1].point_static_label_array[1].label_text), "Static Label 2 for Array Point 2");

    point_dyn_array[2]                 = Point(5.5, 6.6);
    point_dyn_array[2].point_label_obj = PointLabel();
    snprintf(point_dyn_array[2].point_label_obj.label_text, sizeof(point_dyn_array[2].point_label_obj.label_text),
    ...
    snprintf(point_dyn_array[2].point_dyn_label_array[0].label_text,
        sizeof(point_dyn_array[2].point_dyn_label_array[0].label_text), "Dyn Label 1 for Array Point 3");
    snprintf(point_dyn_array[2].point_dyn_label_array[1].label_text,
        sizeof(point_dyn_array[2].point_dyn_label_array[1].label_text), "Dyn Label 2 for Array Point 3");

    // Initialize static array of Points
    point_static_array[0]                 = Point(7.7, 8.8);
    point_static_array[0].point_label_obj = PointLabel();
    snprintf(point_static_array[0].point_label_obj.label_text, sizeof(point_static_array[0].point_label_obj.label_text),
    ...
    snprintf(point_static_array[0].point_dyn_label_array[0].label_text,
        sizeof(point_static_array[0].point_dyn_label_array[0].label_text), "Dyn Label 1 for Static Point 1");
    snprintf(point_static_array[0].point_dyn_label_array[1].label_text,
        sizeof(point_static_array[0].point_dyn_label_array[1].label_text), "Dyn Label 2 for Static Point 1");
    snprintf(point_static_array[0].point_static_label_array[0].label_text,
        sizeof(point_static_array[0].point_static_label_array[0].label_text), "Static Label 1 for Static Point 1");
    snprintf(point_static_array[0].point_static_label_array[1].label_text,
        sizeof(point_static_array[0].point_static_label_array[1].label_text), "Static Label 2 for Static Point 1");
    ...
    snprintf(
        p1->point_label_obj.label_text, sizeof(p1->point_label_obj.label_text), "Point 1 (%6.6f, %6.6f)", p1->x, p1->y);
    p1->point_dyn_label_array    = (PointLabel*)TMM_declare_var_s("PointLabel[2]");
    p1->point_dyn_label_array[0] = PointLabel();
    snprintf(p1->point_dyn_label_array[0].label_text, sizeof(p1->point_dyn_label_array[0].label_text),
        "Dyn Label 1 for Point 1");
    snprintf(p1->point_static_label_array[0].label_text, sizeof(p1->point_static_label_array[0].label_text),
        "Static Label 1 for Point 1");
    p1->point_dyn_label_array[1] = PointLabel();
    snprintf(p1->point_dyn_label_array[1].label_text, sizeof(p1->point_dyn_label_array[1].label_text),
        "Dyn Label 2 for Point 1");
    snprintf(p1->point_static_label_array[1].label_text, sizeof(p1->point_static_label_array[1].label_text),
    ...
    snprintf(
        p2->point_label_obj.label_text, sizeof(p2->point_label_obj.label_text), "Point 2 (%6.6f, %6.6f)", p2->x, p2->y);
    p2->point_dyn_label_array    = (PointLabel*)TMM_declare_var_s("PointLabel[2]");
    p2->point_dyn_label_array[0] = PointLabel();
    snprintf(p2->point_dyn_label_array[0].label_text, sizeof(p2->point_dyn_label_array[0].label_text),
        "Dyn Label 1 for Point 2");
    snprintf(p2->point_static_label_array[0].label_text, sizeof(p2->point_static_label_array[0].label_text),
        "Static Label 1 for Point 2");
    p2->point_dyn_label_array[1] = PointLabel();
    snprintf(p2->point_dyn_label_array[1].label_text, sizeof(p2->point_dyn_label_array[1].label_text),
        "Dyn Label 2 for Point 2");
    snprintf(p2->point_static_label_array[1].label_text, sizeof(p2->point_static_label_array[1].label_text),
    ...
    snprintf(
        p3->point_label_obj.label_text, sizeof(p3->point_label_obj.label_text), "Point 3 (%6.6f, %6.6f)", p3->x, p3->y);
    p3->point_dyn_label_array    = (PointLabel*)TMM_declare_var_s("PointLabel[2]");
    p3->point_dyn_label_array[0] = PointLabel();
    snprintf(p3->point_dyn_label_array[0].label_text, sizeof(p3->point_dyn_label_array[0].label_text),
        "Dyn Label 1 for Point 3");
    snprintf(p3->point_static_label_array[0].label_text, sizeof(p3->point_static_label_array[0].label_text),
        "Static Label 1 for Point 3");
    p3->point_dyn_label_array[1] = PointLabel();
    snprintf(p3->point_dyn_label_array[1].label_text, sizeof(p3->point_dyn_label_array[1].label_text),
        "Dyn Label 2 for Point 3");
    snprintf(p3->point_static_label_array[1].label_text, sizeof(p3->point_static_label_array[1].label_text),
...
void VSTest::throw_exception() { throw std::logic_error("Pretend an error has occured for testing"); }
