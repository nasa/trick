...
STLCheckpoint::STLCheckpoint() { return; }
...
int STLCheckpoint::addData()
{
    ...
    vector_vector_vector_double
        = std::vector<std::vector<std::vector<double>>>(5, std::vector<std::vector<double>>(4, std::vector<double>(3)));
...
int STLCheckpoint::test()
{
    ...
    compare_data_structures_with_top(
        priority_queue_vector_int_copy, priority_queue_vector_int, "priority_queue_vector_int");
