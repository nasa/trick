...
template<typename T> void compare_data_structures_with_top(T a, T b, std::string test_name)
{
...
int STLCheckpoint::addData()
{
    ...
    vector_vector_vector_double = std::vector<std::vector<std::vector<double>>>(
        5, std::vector<std::vector<double>>(4, std::vector<double>(3)));
...
int STLCheckpoint::print()
{
    ...
    message_publish(1,
                    "vector_vector_double[1]: %f %f %f\n",
                    vector_vector_double[1][0],
                    vector_vector_double[1][1],
                    vector_vector_double[1][2]);
    message_publish(1,
                    "vector_vector_vector_double[4][2]: %f %f %f\n",
                    vector_vector_vector_double[4][2][0],
                    vector_vector_vector_double[4][2][1],
                    vector_vector_vector_double[4][2][2]);
...
int STLCheckpoint::test()
{
    ...
    compare_data_structures_with_top(priority_queue_vector_int_copy,
