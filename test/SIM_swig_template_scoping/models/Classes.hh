...
template <class T> int Foo<T>::POTATO = 2;
...
namespace peer
{
    ...
    struct Leek
    {
            template <class T> class Eggplant
            {
            };
    };
    ...
    namespace nested
    {
        template <class T> class Broccoli
        {
        };
...
namespace prime
{
    ...
    namespace nested
    {
        ...
        struct Artichoke
        {
                template <class T> class Asparagus
                {
                };
        };
    }
    ...
    struct Onion
    {
            ...
            template <class T> class InnerOnion
            {
            }; // onions have layers!
