...
SegmentA::SegmentA(std::string in_segment_name, std::string enter_job_class_str, std::string exit_job_class_str,
...
SegmentB::SegmentB(std::string in_segment_name, std::string enter_job_class_str, std::string exit_job_class_str,
    Trick::IntegLoopScheduler& in_integ_sched)
    : Trick::Segment(in_segment_name, enter_job_class_str, exit_job_class_str)
    , integ_sched(in_integ_sched) { };
