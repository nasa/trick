...
class STLIPTest
{
    ...
    public:
        ...
        void addCharToVector(std::vector<char16_t>& vec, int value) { vec.push_back(static_cast<char16_t>(value)); }
        ...
        // Add a character to the vector (accepts int for Python compatibility)
        void addCharToVector(std::vector<char32_t>& vec, int value) { vec.push_back(static_cast<char32_t>(value)); }
        // Get a character from the vector (returns as int for Python compatibility)
