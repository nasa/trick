...
print('  Data file for variable monte_carlo.x_file_lookup[0] includes this line:')
print('  0 1 2 3 4')
print('  Which has only 5 values.')
print('  Variable monte_carlo.x_file_lookup[0] uses the value from position 9, which does not exist in this line')
print('**************************************************************************************************')
