...
mc_var = trick.MonteCarloVariableRandomUniform( "monte_carlo.x_uniform", 77545, 100.0, 100000.0)
...
mc_var = trick.MonteCarloVariableRandomUniformInt( "monte_carlo.x_integer", 77001, 100, 100000)
mc_var.thisown = False
monte_carlo.mc_master.add_variable(mc_var)
