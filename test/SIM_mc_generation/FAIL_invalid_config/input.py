...
print('  Error in attempting to make monte_carlo.x_file_lookup[1] be dependent on test.x_file_lookup[0].')
print('  monte_carlo.x_file_lookup[1] cannot be marked as dependent when it has dependencies of its own.')
...
mc_var2 = trick.MonteCarloVariableFile( "monte_carlo.x_file_lookup[1]",
                                        "Modified_data/datafile.txt",
                                        3)
