...
print('  Could not generate a value for monte_carlo.x_normal_trunc[#] within the specified domain within')
...
mc_var = trick.MonteCarloVariableRandomNormal( "monte_carlo.x_normal_trunc[0]", 9956453, 10, 3.5)
...
# give some crazy initial values to the class
mc_var = trick.MonteCarloVariableRandomNormal( "monte_carlo.x_normal_trunc[1]", 99565644453, 10, 3.5)
mc_var.thisown = False
...
# give some crazy initial values to the class
mc_var = trick.MonteCarloVariableRandomNormal( "monte_carlo.x_normal_trunc[2]", 99565644453, 10, 3.5)
mc_var.thisown = False
