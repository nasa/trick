...
template<class T, class U, class V> class MyTemplate
{
public:
    T var1;
    U var2;
...
template<class T> class MyPrivTemplate
{
    T var1;
};

template<class A, class B> class TTT
{
public:
    TTT()
    {
