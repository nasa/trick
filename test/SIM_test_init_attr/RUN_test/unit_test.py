...
if outer_attr != None:
    ...
    TRICK_EXPECT_TRUE(
        field_type == trick.TRICK_STRUCTURED, suite_name, "first_outer_attr_field_type"
    )
    TRICK_EXPECT_TRUE(
        field_type_name == "Inner", suite_name, "first_outer_attr_field_type_name"
    )
    ...
    TRICK_EXPECT_TRUE(
        another_inner_attr != None, suite_name, "another_inner_type_attr_present"
    )
    TRICK_EXPECT_TRUE(another_inner_name == "j", suite_name, "another_inner_name")
    TRICK_EXPECT_TRUE(
        another_inner_type_name == "int", suite_name, "another_inner_type_name"
    )
