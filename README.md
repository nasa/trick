...
Before opening an issue or pull request, please read the [contributing guidelines](https://github.com/nasa/trick/blob/master/CONTRIBUTING.md). Issues and pull requests that do not follow them will be closed.
