    ...
    _currQPIdx(0)
{
    ...
    _dpFilterModel = new DPFilterProxyModel(_commonParams);
...
//
void SnapDiff::_createDPPages(const QString& dpfile)
{
...
void SnapDiff::_dpTreeViewClicked(const QModelIndex &idx)
{
    Q_UNUSED(idx);
...
void SnapDiff::_dpTreeViewCurrentChanged(const QModelIndex &currIdx,
...
void SnapDiff::_dpSearchBoxTextChanged(const QString &rx)
{
...
bool SnapDiff::_isDP(const QString& fp)
{
    bool ret = false ;
    QFileInfo fi(fp);
...
QString SnapDiff::_descrPlotTitle(DPPlot *plot)
{
