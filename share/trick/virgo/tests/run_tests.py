...
from Virgo import *
# WorkflowCommon is used for Job()-ifying the tasks
sys.path.append(os.path.abspath(os.path.join(this_dir, '../../trickops/')))
from WorkflowCommon import WorkflowCommon, Job
...
def run_tests(args):
    ...
    print(f"doctest verbose output can be found in tests/*{log_prepend}")
