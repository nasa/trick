...
## Core files
* Trickified_Library - Your trickfieid library, and the whole reason you read this document.
...
# makefile/convenience features
    * rebuild-trickify - Your original trick-ify command. Rebuilds the trickified library.
    * clean_trickify - Removes all build artifacts, and other files not needed for running your sim.
    * spotless trickify - Removes your library and python module. Leaves only the makefiles. Also performs clean_trickify.
    * nuke_trickify - Removes everything EXCEPT this makefile.
