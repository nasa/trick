...
| --------------: | :-----: | :---------------------: | :------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [gcc] and `g++` |  8.5+   |     C/C++ Compiler      |          Compiles Trick and Trick simulations.           |                                                                                                                                                                                                         |
|  [clang]/[llvm] | 14 - 22 |     C/C++ Compiler      |        Utilized by the interface code generator.         | Trick Versions <= 19.3 should use LLVM <= 9. Trick Versions < 25.0 should use LLVM < 20. Please open an issue if you encounter a problem related to newer versions of LLVM.                             |
