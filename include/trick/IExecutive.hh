...
#ifndef IEXECUTIVE_HH
#define IEXECUTIVE_HH
    ...
    class IExecutive : public Trick::Scheduler {
        ...
        //     std::string current_version;            /**< trick_units(--) */
            ...
            /**
             ...
             @return void
            */
            virtual void reset_job_cycle_times() = 0;

            /**
             @userdesc Command to reset job call times when a new start time is inputed
             @return void
            */
            virtual void reset_job_call_times() = 0;

            /**
             Internal call to test if thread is ready to run
             @return bool
            */
            virtual bool isThreadReadyToRun( Trick::Threads * curr_thread , long long time_tics) = 0;
        ...
        public:
            ...
            /**
             ...
             @return always 0
            */
            virtual int get_all_jobs_vector(std::vector<Trick::JobData *> & in_jobs_vector) = 0;
            ...
            */
            virtual bool get_attach_debugger() = 0;
            ...
            */
            virtual const std::string & get_current_version() = 0;
            ...
            */
            virtual const std::string & get_debugger_command() = 0;
            ...
            */
            virtual SIM_COMMAND get_exec_command() = 0;
            ...
            */
            virtual bool get_enable_freeze() = 0;
            ...
            */
            virtual bool get_freeze_command() = 0;
            ...
            */
            virtual bool get_freeze_on_frame_boundary() = 0;
            ...
            */
            virtual double get_freeze_frame() = 0;
            ...
            */
            virtual long long get_freeze_frame_tics() = 0;
            ...
            */
            virtual unsigned int get_num_threads() = 0;
            ...
            */
            virtual int get_old_time_tic_value() = 0;
            ...
            */
            virtual int get_scheduled_start_index() = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int get_sim_objects(std::vector<Trick::SimObject *> & in_sim_objects) = 0;
            ...
            */
            virtual double get_software_frame() = 0;
            ...
            */
            virtual long long get_software_frame_tics() = 0;
            ...
            */
            virtual long long get_frame_count() = 0;
            ...
            */
            virtual long long get_freeze_frame_count() = 0;
            ...
            */
            virtual pthread_t get_pthread_id(unsigned int thread_id) = 0;
            ...
            */
            virtual bool get_stack_trace() = 0;
            ...
            */
            virtual double get_terminate_time() = 0;
            ...
            */
            virtual double get_thread_amf_cycle_time(unsigned int thread_id) = 0;
            ...
            */
            virtual int get_time_tic_value() = 0;
            ...
            */
            virtual long long get_time_tics() = 0;
            ...
            */
            virtual long long get_freeze_time_tics() = 0;
            ...
            */
            virtual bool get_trap_sigbus() = 0;
            ...
            */
            virtual bool get_trap_sigfpe() = 0;
            ...
            */
            virtual bool get_trap_sigsegv() = 0;
            ...
            /**
             ...
             @return boolean (C integer 0/1) Executive::trap_sigsegv
            */
            virtual bool get_trap_sigabrt() = 0;
            ...
            /**
             ...
             @return boolean (C integer 0/1) Executive::trap_sigsegv
            */
            virtual bool get_trap_sigchld() = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_attach_debugger(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_debugger_command(std::string command) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_enable_freeze(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_freeze_command(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_freeze_on_frame_boundary(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
             */
            virtual int set_freeze_frame(double in_frame) = 0;
            ...
            */
            virtual int set_exec_command(SIM_COMMAND in_command) = 0;
            ...
            /**
             ...
             @return always 0
             */
            virtual int set_rt_nap(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_software_frame(double in_frame) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_stack_trace(bool on_off) = 0;
            ...
            */
            virtual int set_time(double in_time) = 0;
            ...
            */
            virtual int set_time_tics(long long in_tics) = 0;
            ...
            */
            virtual int set_time_tic_value(int in_tics) = 0;
            ...
            /**
             ...
             @param in_time - simulation time in seconds
            */
            virtual int set_terminate_time(double in_time) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_trap_sigbus(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_trap_sigfpe(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_trap_sigsegv(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_trap_sigabrt(bool on_off) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int set_trap_sigchld(bool on_off) = 0;
            ...
            */
             ...
             */
            virtual unsigned int get_process_id() = 0;
             ...
             */
             virtual int get_freeze_job(std::string sim_object_name) = 0;
             ...
             */
            virtual Trick::JobData * get_job(std::string job_name, unsigned int j_instance = 1 ) = 0;

            /**
             Get the current executive job executing in the current thread.
             @return Trick::JobData pointer to the job
             */
            virtual Trick::JobData * get_curr_job() = 0;
             ...
             */
            virtual double get_job_cycle(std::string job_name) = 0;
             ...
             */
            virtual int set_job_onoff(std::string job_name, int instance_num, int on) = 0;
             ...
             */
            virtual int set_job_cycle(std::string job_name, int instance_num, double in_cycle) = 0;
            ...
            /**
             ...
             @return 0 if successful or -1 if the job cannot be found
             */
            virtual int set_sim_object_onoff(std::string sim_object_name, int on) = 0;
             ...
             */
            virtual int set_version_date_tag(std::string tag) = 0;
            ...
            /**
             ...
             @return 0 if successful
             */
            virtual int set_build_date(std::string date) = 0;
            ...
            /**
             ...
             @return 0 if successful
             */
            virtual int set_current_version(std::string version) = 0;
             ...
             */
            virtual int call_default_data() = 0;

            /**
             * Calls the input_processor jobs.
             * @return 0 for no errors or throws exception otherwise.
             */
            virtual int call_input_processor() = 0;

            /**
             * Calls the initialization jobs.
             * @return 0 for no errors or throws exception otherwise.
             */
            virtual int call_initialization() = 0;
             ...
             * @return error code or 0 for no errors.
             */
            virtual int clear_scheduled_queues() = 0;
             ...
             * @return always 0
             */
            virtual int write_s_run_summary( FILE * fp ) = 0;

            /**
             * Starts all of the child threads.
             * @return always 0
             */
            virtual int create_threads() = 0;
             ...
             */
            virtual int add_scheduled_job_class( std::string in_name ) = 0;
             ...
             * @return always 0
             */
            virtual int add_sim_object(Trick::SimObject * in_object ) = 0;
            virtual int add_sim_object(Trick::SimObject * in_object , const char * in_name ) = 0;
             ...
             * @return always 0
             */
            virtual int add_jobs_to_queue(Trick::SimObject * sim_object, bool restart = false ) = 0;
             ...
             * @return always 0
             */
            virtual int add_job_to_queue( Trick::JobData * job_data ) = 0;
             ...
             * @return always 0
             */
            virtual int delete_sim_object(Trick::SimObject * in_object ) = 0;
             ...
             * @return always 0
             */
            virtual int remove_jobs(Trick::SimObject * sim_object ) = 0;
             ...
             */
            virtual int add_depends_on_job( std::string target_job , unsigned int t_instance , std::string depend_job , unsigned int d_instance ) = 0;

            /**
             * Check to see all jobs in the simulation are handled .
             * @return always 0
             */
            virtual int check_all_jobs_handled( ) = 0;

            /**
             * Check to see all jobs are scheduled with exact frequencies
             * @return always 0
             */
            virtual int check_all_job_cycle_times() = 0;
             ...
             * @return always 0
             */
            virtual int init_signal_handlers() = 0;
             ...
             * @return always 0
             */
            virtual void ctrl_c_handler() = 0;

            /**
             * @brief Handles signal SIGTERM
             * @return always 0
             */
            virtual void term_handler() = 0;

            /**
             * @brief Handles signal SIGTERM
             * @return always 0
             */
            virtual void usr1_handler() = 0;

            /**
             * Handles signal handlers for SIGSEGV, SIGBUS, and SIGINT if directed so in initialization jobs.
             * @return always 0
             */
            virtual void fpe_handler(siginfo_t * sip) = 0;
            ...
            */
            virtual Trick::Threads * get_thread(unsigned int thread_id) = 0;
            ...
            */
            virtual int set_thread_enabled(unsigned int thread_id , bool enabled) = 0;
            ...
            */
            virtual int set_thread_process_type(unsigned int thread_id , int process_type) = 0;
            ...
            */
            virtual int set_thread_amf_cycle_time(unsigned int thread_id , double cycle_time) = 0;
            ...
            */
            virtual int set_thread_async_wait(unsigned int thread_id , bool yes_no) = 0;
            ...
            /**
             ...
             @return 0 if successful, -2 if thread does not exist.
            */
            virtual int set_thread_rt_semaphores(unsigned int thread_id , bool yes_no) = 0;
            ...
            /**
             ...
             @return 0 if successful, -2 if thread does not exist.
            */
            virtual int set_thread_priority(unsigned int thread_id , unsigned int req_priority) = 0;
            ...
            /**
             ...
             @return 0 if successful, -2 if thread does not exist.
            */
            virtual int set_thread_cpu_affinity(unsigned int thread_id , int cpu_num) = 0;
            ...
            */
            ...
            /**
             ...
             @return always 0
            */
            virtual int freeze(double in_time) = 0;
            ...
            */
            ...
            /**
             ...
             @param in_time - simulation time in seconds
            */
            virtual int stop(double in_time) = 0;
            ...
            */
            virtual int instrument_job_before(std::string in_job, unsigned int instance = 1) = 0;
            ...
            */
            ...
            /**
             ...
             @return number of times the job was inserted
            */
            virtual int instrument_job_after(std::string in_job , unsigned int instance = 1 ) = 0;
            /**
            ...
            */
            ...
            /**
             ...
             @return always 0
            */
            virtual int register_scheduler(Trick::Scheduler * scheduler ) = 0;
            ...
            /**
             ...
             @return always 0
            */
            virtual int exec_terminate(const char *file_name, const char *error) = 0;
            
            /* deleted functions  */
      private:
            /* SWIG doesn't like the Executive assignment operator because of ofstream init_log_stream */
            IExecutive& operator=(const IExecutive&); /* = delete; '= delete' is not compatible with SWIG 2.0.
