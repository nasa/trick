    ...
    class AttributesUtils
    {
        public:
            ...
            struct TraversalResult
            {
                    ...
                    bool is_in_anonymous_member
                        = false; // True if the offset falls in an anonymous or otherwise unnamed member region
            };
             ...
             */
            static int traverse_for_offset(size_t reference_offset, ATTRIBUTES* struct_attr, TraversalResult& result);
