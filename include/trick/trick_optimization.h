...
extern "C"
{
     ...
     */
    int dPDIP_linear_solver(int num_variables, double* objective_fn, int num_equalities, double** eq_constraints,
        double* constraints_rhs, double* xvals, double* init_lambda, double* init_nu, double epsilon, double alpha,
        double beta, double mu, double mu_scaling_factor, int max_iterations, int max_backtrack_cycles);
