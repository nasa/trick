...
public:
    ...
    /**
     @brief Add a message subscriber to this publisher's subscriber list, which will output published messages in some
     manner.
     @param in_ms - an instance of Trick::MessageSubscriber that wants to subscribe to this publisher.
     */
    void subscribe(MessageSubscriber * in_ms)
    {
        subscribers.push_back(in_ms);
    }
     ...
     */
    void unsubscribe(MessageSubscriber * in_ms)
    {
        subscribers.remove(in_ms);
    }
