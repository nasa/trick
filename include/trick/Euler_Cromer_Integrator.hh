...
{
protected:
    er7_utils::SymplecticEulerIntegratorConstructor helper_integ_constructor; /* --
                                                       The integrator constructor associated with Euler Cromer
                                                       integration. */
};
 ...
 */
class Euler_Cromer_Integrator : protected Euler_Cromer_IntegratorHelper,
...
public:
    ...
    Euler_Cromer_Integrator(int state_size, double delta_t)
        : Euler_Cromer_IntegratorHelper(),
          TrickSecondOrderOdeIntegrator(helper_integ_constructor, state_size, delta_t, true)
    {
    }
    ...
    {
        std::memcpy(state + half_state_size, er7_deriv, half_state_size * sizeof(double));
