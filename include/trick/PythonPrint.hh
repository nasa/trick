...
public:
     ...
     */
    virtual void assign_rvalue(std::ostream & chkpnt_os, void * address, ATTRIBUTES * attr, int curr_dim, int offset);
    /**
     Restore Checkpoint.
     */
    ...
    /**
     ...
     @param offset - if the object specified by address and attr is arrayed, then this
                     ...
                     to be written.
     */
    static void write_singleton(std::ostream & chkpnt_os,
                                void * address,
                                ATTRIBUTES * attr,
                                int offset,
                                bool write_units = true,
                                bool in_list = false);

    /**
     I NEED DOCUMENTATION!
     */
    static void write_rvalue(std::ostream & chkpnt_os,
                             void * address,
                             ATTRIBUTES * attr,
                             int curr_dim,
                             int offset,
