        ...
        public:
            ...
            /**
             ...
             @param offset - if the object specified by address and attr is arrayed, then this
                             ...
                             to be written.
             */
            static void write_singleton(
                std::ostream& chkpnt_os, void* address, ATTRIBUTES* attr, int offset, bool write_units, bool in_list);

            /**
             I NEED DOCUMENTATION!
             */
            static void write_rvalue(std::ostream& chkpnt_os, void* address, ATTRIBUTES* attr, int curr_dim, int offset,
                bool write_units, bool in_list, int* startingIndex);
