    ...
    class IPPythonEvent : public Trick::Event
    {
        public:
            ...
            */
            ...
            /**
             @brief @userdesc Command to make event evaluation require that ALL of event's conditions be true to make
             action(s) run.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to make event evaluation require that ANY of event's conditions be true to make
             action(s) run (this is the default).
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to manually fire the event next cycle and hold it fired (enter manual mode,
             bypasses normal condition processing).
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to manually fire the event once NOW (enter manual mode, bypasses normal condition
             processing).
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to manually set the event as not fired (enter manual mode, bypasses normal
            ...
            */
            ...
            /**
             @brief @userdesc Command to return to normal event processing (needed to end manual mode after any manual
             commands).
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to create a new condition and set its input string (or reset an existing condition
             string), num is index starting at 0.
             @par Python Usage:
             ...
             @param ref     - optional reference to a model variable to be used for the condition (this parameter for
             internal use only!)
             @param job     - optional pointer to job to be called as the condition (this parameter for internal use
             only!)
             @return always 0
            */
            ...
            /**
             @brief @userdesc Command to create a new condition using a boolean model variable (or reset an existing
             condition variable), num is index starting at 0. Using a model variable is more optimal than a normal
             condition() because there is no Python string to parse.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to create a new condition using a model job return val (or reset an existing
             condition job), num is index starting at 0. Using a model job return value is more optimal than a normal
             condition() because there is no Python string to parse.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to set an existing condition to hold, so that when it fires it stays in the fired
             state.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to enable an existing condition (default is enabled) so that it is evaluated
            ...
            */
            ...
            /**
             @brief @userdesc Command to disable an existing condition so that it is not evaluated during event
             processing.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Accessor function to test if the condition, indicated by num, fired (is currently in the
             fired state).
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to create a new action and set its input string (or reset an existing action
             string), num is index starting at 0.
             @par Python Usage:
             ...
             @param str - the action input statement(s), using Python syntax, to be run (processed) when this event is
             fired
             @param comment - optional description to be displayed in mtv (defaults to 1st 50 characters of str)
             @param job     - optional pointer to job to be called in the action (this parameter for internal use only!)
             @param act_type - optional type of action string: 0=python 1=Job ON, 2=Job OFF, 3=Job Call (this parameter
            ...
            */
            ...
            /**
             @brief @userdesc Command to create a new action using a model job (or reset an existing action job), num is
             index starting at 0. Using a model job is more optimal than a normal action() because there is no Python
             string to parse.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to enable an existing action (default is enabled) so that it is run when fired
             during event processing.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to disable an existing action so that it is not run when fired during event
             processing.
             @par Python Usage:
