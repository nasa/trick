...
namespace Trick
{
    ...
    class IntegrationManager
    {
        public:
             ...
             */
            bool is_empty() { return sim_objects_info.empty(); }
             ...
             */
            Trick::IntegLoopScheduler* get_integrated_by(Trick::SimObject* sim_object);
             ...
             */
            void set_integrated_by(Trick::SimObject* sim_object, Trick::IntegLoopScheduler* integrator);
             ...
             */
            void add_jobs_to_queue(const std::string& job_class_name, int job_class_id, Trick::SimObject* sim_object,
        ...
        private:
            ...
            {
                    FindSimObject(const Trick::SimObject* s)
                        : to_find(s)
                    {
                    }

                    bool operator()(const SimObjectIntegInfo& info) { return info.sim_object == to_find; }
            ...
            {
                    FindDerivedSimObject(const void* s)
                        : to_find(s)
                    {
                    }
             ...
             */
            SimObjectIntegInfo* find_sim_object_info(const Trick::SimObject* sim_object, bool allow_rebuild = true);
             ...
             *                            and if this flag is set.
             */
            SimObjectIntegInfo* find_sim_object_info(const void* derived_sim_object, bool allow_rebuild = true);
