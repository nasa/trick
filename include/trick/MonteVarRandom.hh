...
namespace Trick
{
    ...
    class MonteVarRandom : public Trick::MonteVar
    {
        ...
        public:
             ...
             * @param engine this variables's pseudo-random number 'engine'. Defaulted to NO_ENGINE (use Trick
             * algorithms)
             */
            MonteVarRandom(std::string name, Distribution distribution, std::string unit = "",
