...
extern "C"
{
     ...
     *
     */
    int dLU_Choleski(double** A, double** L, double* y, int n, double* b, double* x, int mode);

    /**
     * @ingroup TRICK_MATH
     */
    int dLU_solver(double** A, double** L, double* y, int n, double* b, double* x, int mode);

    /**
     * @ingroup TRICK_MATH
     */
    int dLDLt_solver(double** A, double** L, double* D, double* y, int n, double* b, double* x, int mode);

    /**
     * @ingroup TRICK_MATH
     */
    double dS_function(double x, double zero_point, double mid_point, double one_point, double sign);

    /**
     * @ingroup TRICK_MATH
     */
    int euler123(double angle[3], double mat[3][3], int method, double* prev, const char* file, int lineno);

    /**
     * @ingroup TRICK_MATH
     */
    int euler132(double angle[3], double mat[3][3], int method, double* prev, const char* file, int lineno);

    /**
     * @ingroup TRICK_MATH
     */
    int euler213(double angle[3], double mat[3][3], int method, double* prev, const char* file, int lineno);

    /**
     * @ingroup TRICK_MATH
     */
    int euler231(double angle[3], double mat[3][3], int method, double* prev, const char* file, int lineno);

    /**
     * @ingroup TRICK_MATH
     */
    int euler312(double angle[3], double mat[3][3], int method, double* prev, const char* file, int lineno);

    /**
     * @ingroup TRICK_MATH
     */
    int euler321(double angle[3], double mat[3][3], int method, double* prev, const char* file, int lineno);

    /**
     * @ingroup TRICK_MATH
     */
    int euler123_quat(double angle[3], double quat[4], int method, double* prev);

    /**
     * @ingroup TRICK_MATH
     */
    int euler132_quat(double angle[3], double quat[4], int method, double* prev);

    /**
     * @ingroup TRICK_MATH
     */
    int euler213_quat(double angle[3], double quat[4], int method, double* prev);

    /**
     * @ingroup TRICK_MATH
     */
    int euler231_quat(double angle[3], double quat[4], int method, double* prev);

    /**
     * @ingroup TRICK_MATH
     */
    int euler312_quat(double angle[3], double quat[4], int method, double* prev);

    /**
     * @ingroup TRICK_MATH
     */
    int euler321_quat(double angle[3], double quat[4], int method, double* prev);
     ...
     *
     */
    void dsingle_axis_rot(int problem, double* phi, double rot_vec[3], double trans_mat[3][3]);
     ...
     */
    int eigen_jacobi(double** k, double** mass, double** v, double* alpha, int m, int mmax, int sort);

    /**
     * @ingroup TRICK_MATH
     * This is a super-duper number munching algorithm that presumably does something useful.
     */
    void eigen_jacobi_4(double k[4][4], double mass[4][4], double v[4][4], double alpha[4], int m, int mmax, int sort);
     ...
     */
    int euler_matrix(double angle[3], double mat[3][3], int method, Euler_Seq sequence);
     ...
     */
    int euler_quat(double angle[3], double quat[4], int method, Euler_Seq sequence);
     ...
     * @ingroup TRICK_MATH
     */
    void mat_permute(double** A_coeff, double* B_coeff, double** A_star, double* B_star, int* new_dof, int num_states);
     ...
     */
    void trns_fnct_1o(
        int num_vars, double in_0[], double in_t[], double dt, double tau[], double out_0[], double out_t[], int* init);

    /**
     * @ingroup TRICK_MATH
     */
    void trns_fnct_2o(
        double* z, double* wn, double dt, double* in, double* inwk, double* out, double* outwk, int nd, int* init);
 ...
 */
#define deuler_123(ang, mat, method) euler123(ang, mat, method, (double*)0, __FILE__, __LINE__)
#define deuler_132(ang, mat, method) euler132(ang, mat, method, (double*)0, __FILE__, __LINE__)
#define deuler_213(ang, mat, method) euler213(ang, mat, method, (double*)0, __FILE__, __LINE__)
#define deuler_231(ang, mat, method) euler231(ang, mat, method, (double*)0, __FILE__, __LINE__)
#define deuler_312(ang, mat, method) euler312(ang, mat, method, (double*)0, __FILE__, __LINE__)
#define deuler_321(ang, mat, method) euler321(ang, mat, method, (double*)0, __FILE__, __LINE__)
#define euler_123(ang, mat, method, prev) euler123(ang, mat, method, prev, __FILE__, __LINE__)
#define euler_132(ang, mat, method, prev) euler132(ang, mat, method, prev, __FILE__, __LINE__)
#define euler_213(ang, mat, method, prev) euler213(ang, mat, method, prev, __FILE__, __LINE__)
#define euler_231(ang, mat, method, prev) euler231(ang, mat, method, prev, __FILE__, __LINE__)
#define euler_312(ang, mat, method, prev) euler312(ang, mat, method, prev, __FILE__, __LINE__)
#define euler_321(ang, mat, method, prev) euler321(ang, mat, method, prev, __FILE__, __LINE__)

#define deuler_123_quat(ang, quat, method) euler123_quat(ang, quat, method, (double*)0)
#define deuler_132_quat(ang, quat, method) euler132_quat(ang, quat, method, (double*)0)
#define deuler_213_quat(ang, quat, method) euler213_quat(ang, quat, method, (double*)0)
#define deuler_231_quat(ang, quat, method) euler231_quat(ang, quat, method, (double*)0)
#define deuler_312_quat(ang, quat, method) euler312_quat(ang, quat, method, (double*)0)
#define deuler_321_quat(ang, quat, method) euler321_quat(ang, quat, method, (double*)0)
