...
namespace Trick
{
    ...
    class DataRecordGroup : public Trick::SimObject
    {
        public:
            ...
            /** Vector of buffers - one for every change variable added with
             * Trick::DataRecordGroup::add_change_variable.\n */
            ...
            */
            ...
            /**
             @brief @userdesc Command to set the job class of the group's data_record() function (default is data_record
             class).
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to set the size of each variable buffer in the group used to hold recorded
             variable values (default is 100000). The buffer size will be set during initialization in
            ...
            */
            ...
            /**
             @brief @userdesc Command to print double variable values as single precision (float) in the log file to
             save space.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief Transfer data in recording buffer to disk, implemented in derived group classes DRAscii, DRBinary,
             DRHDF5.
             @returns always 0
            */
