...
extern "C"
{
    ...
    typedef struct ATTRIBUTES_tag
    {
            ...
            const char*
                type_name; /**< -- Character string representation of the C/C++ data type or user-defined type. */
            ...
            const char* stl_elem_type_name; /**< -- Element type name of STL container
                                                    Character string representation of the C/C++ data type or
                                               user-defined type. */
            ...
            void* (*get_stl_element)(
                void* start_address, size_t index); /**< ** Function to get pointer to STL element at index */
            void (*set_stl_element)(void* start_address, size_t index,
                void* value_ptr); /**< ** Function to set STL element at index (for vector<bool> write-back) */
