...
extern "C"
{
    ...
    void dr_set_verif_onoff(int on);
    void dr_set_warning_level(int level);

#ifdef __cplusplus
    int add_data_record_group(Trick::DataRecordGroup * in_group,
                              Trick::DR_Buffering buffering = Trick::DR_Not_Specified);
