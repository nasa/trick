...
template<typename T>
static int typemap_in_1dp(PyObject * input, const char * basetype, const char * symname, T ** output)
{
    // INT *
    void * argp2;
    int ret;
        ...
        if(!strncmp(basetype, "char", 4))
        {
            ...
            else
            {
                PyErr_SetString(PyExc_TypeError,
                                "swig_int (char): Input must be of type List, string, or a pointer type");
                return -1;
            }
        }
        else
