...
public:
    ...
    */
    void set_thread(unsigned int in_thread)
    {
        thread_id = in_thread;
    }
    ...
    */
    void set_before_after(EventBeforeAfter in_before_after)
    {
        before_after = in_before_after;
    }

    /**
     @brief gets the event's cyclic status, or is it set to run before/after a job.
    */
    EventBeforeAfter get_before_after()
    {
        return before_after;
    }
    ...
    /**
     ...
     @return always 0
    */
    void set_cycle(double rate)
    {
        cycle = rate;
        cycle_tics = (long long)(cycle * exec_get_time_tic_value());
    }
    ...
    */
    long long get_cycle_tics() const
    {
        return cycle_tics;
    }
    ...
    */
    void set_target_name(std::string in_name)
    {
        target_name = in_name;
    }
    ...
    */
    void set_target_inst(unsigned int in_target_inst)
    {
        target_inst = in_target_inst;
    }
