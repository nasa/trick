    ...
    class DebugPause
    {
        public:
            ...
            /**
             ...
             Calls Trick::Executive::instrument_job_before to insert the debug_pause routine before every job to pause
             at.
             @return always 0
             */
            int debug_pause_on();
            ...
            /**
             ...
             Calls Trick::Executive::instrument_job_remove to remove the debug_pause routine from all job queues that it
             was inserted in.
             @return always 0
             */
            int debug_pause_off();
