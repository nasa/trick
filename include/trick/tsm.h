...
extern "C"
{
    ...
    typedef struct
    {
            ...
            char key_file[256]; /* -- An existing file name to use in generating key, in combination with proj_id,
                                   (ftok) for shared memory */
            int proj_id; /* -- A value to use, in combination with the key_file, (ftok) for shared memory. Use 1..255 to
                            create 255 different keys */
