...
{
protected:
    er7_utils::RKFehlberg78IntegratorConstructor helper_integ_constructor; /* --
 ...
 */
class RKF78_Integrator : protected RKF78_IntegratorHelper,
...
public:
    ...
    {
        return Runge_Kutta_Fehlberg_78;
    }
};
