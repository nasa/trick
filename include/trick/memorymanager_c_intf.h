...
extern "C"
{
    ...
    void* TMM_declare_operatornew_var_with_name(
        const char* class_name, unsigned int alloc_size, unsigned int element_size, const char* alloc_name);

    void* TMM_declare_ext_var(void* addr, TRICK_TYPE type, const char* class_name, int n_stars, const char* var_name,
        int n_cdims, int* cdims);
