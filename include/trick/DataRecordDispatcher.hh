...
public:
    ...
    virtual int write_s_job_execution(FILE * fp __attribute__((unused)))
    {
        return 0;
    }

    virtual int instrument_job_before(Trick::JobData * instrument_job __attribute__((unused)))
    {
        return 0;
    }

    virtual int instrument_job_after(Trick::JobData * instrument_job __attribute__((unused)))
    {
        return 0;
    }

    virtual int instrument_job_remove(std::string in_job __attribute__((unused)))
    {
        return 0;
    }
