...
namespace Trick
{
    ...
    {
        protected:
            er7_utils::MM4IntegratorConstructor helper_integ_constructor; /* --
     ...
     */
    class MM4_Integrator : protected MM4_IntegratorHelper, public er7_utils::TrickSecondOrderOdeIntegrator
    {
        public:
            ...
            MM4_Integrator(int state_size, double delta_t)
                ...
                , TrickSecondOrderOdeIntegrator(helper_integ_constructor, state_size, delta_t)
            {
            }
