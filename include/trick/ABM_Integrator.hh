...
namespace Trick
{
    ...
    {
        protected:
            er7_utils::ABM4IntegratorConstructor helper_integ_constructor; /* --
     ...
     */
    class ABM_Integrator : protected ABM_IntegratorHelper, public er7_utils::TrickFirstOrderOdeIntegrator
    {
        public:
