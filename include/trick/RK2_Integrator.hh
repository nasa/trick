...
namespace Trick
{
    ...
    {
        protected:
            er7_utils::RK2HeunIntegratorConstructor helper_integ_constructor; /* --
     ...
     */
    class RK2_Integrator : protected RK2_IntegratorHelper, public er7_utils::TrickFirstOrderOdeIntegrator
    {
        public:
