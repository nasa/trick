    ...
    class EventManager
    {
        public:
            ...
            */
            ...
            /**
             @brief @userdesc Command to insert a user's input file event into the input processor's list of events to
             process. The event will be processed at the top of each execution frame.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Command to insert an instrument job (containing in_event) into job queue before target
             job. The event will be processed immediately before the target job.
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Activates an event with a specific name. If you have the <event_object> created by
             new_event(), it's more conventional to call <event_object>.activate().
             @par Python Usage:
            ...
            */
            ...
            /**
             @brief @userdesc Deactivates an event with a specific name. If you have the <event_object> created by
             new_event(), it's more conventional to call <event_object>.deactivate().
             @par Python Usage:
