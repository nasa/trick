...
template<class FIRST,
         class SECOND,
         typename std::enable_if<!is_stl_container<FIRST>::value && !is_stl_container<SECOND>::value>::type *>
int checkpoint_stl(std::pair<FIRST, SECOND> & in_pair, std::string object_name, std::string var_name)
{
    ...
    var_declare << type_string << " " << object_name << "_" << var_name << "_first[1]";
    ...
    if(first)
    {
        ...
        var_declare << type_string << " " << object_name << "_" << var_name << "_second[1]";
        temp_str = var_declare.str();
...
int checkpoint_stl(std::pair<FIRST, SECOND> & in_pair, std::string object_name, std::string var_name)
{
    ...
    if(first)
    {
        ...
        var_declare.str("");
        var_declare.clear();
        var_declare << "std::string " << object_name << "_" << var_name << "_second[1]";
        temp_str = var_declare.str();
...
int checkpoint_stl(std::pair<FIRST, SECOND> & in_pair, std::string object_name, std::string var_name)
{
    ...
    var_declare << "std::string " << object_name << "_" << var_name << "_first[1]";
    temp_str = var_declare.str();
