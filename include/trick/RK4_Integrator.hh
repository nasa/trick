...
namespace Trick
{
    ...
    {
        protected:
            er7_utils::RK4IntegratorConstructor helper_integ_constructor; /* --
     ...
     */
    class RK4_Integrator : protected RK4_IntegratorHelper, public er7_utils::TrickFirstOrderOdeIntegrator
    {
        public:
