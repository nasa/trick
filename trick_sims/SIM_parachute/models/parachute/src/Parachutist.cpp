...
const double air_density_array[NUM_ELEMENTS] = {1.347, 1.225, 1.112, 1.007, 0.9093, 0.8194, 0.7364, 0.6601, 0.5900,
...
const double gravity_array[NUM_ELEMENTS] = {9.810, 9.807, 9.804, 9.801, 9.797, 9.794, 9.791, 9.788, 9.785, 9.782, 9.779,
...
int Parachutist::state_init() { return (0); }
