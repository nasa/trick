...
namespace ros
{
    namespace message_traits
    {
        ...
        // '__hash__', '__init__', '__module__', '__ne__', '__new__', '__reduce__', '__reduce_ex__', '__repr__',
        // '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '__weakref__', '_parsed_fields', 'constants',
        // 'fields', 'full_name', 'has_header', 'header_present', 'names', 'package', 'parsed_fields', 'short_name',
        // 'text', 'types']

        template <class ContainerAllocator> struct IsFixedSize<::trick_msgs::Num_<ContainerAllocator>> : FalseType
        {
        };

        template <class ContainerAllocator> struct IsFixedSize<::trick_msgs::Num_<ContainerAllocator> const> : FalseType
        {
        };

        template <class ContainerAllocator> struct IsMessage<::trick_msgs::Num_<ContainerAllocator>> : TrueType
        {
        };

        template <class ContainerAllocator> struct IsMessage<::trick_msgs::Num_<ContainerAllocator> const> : TrueType
        {
        };

        template <class ContainerAllocator> struct HasHeader<::trick_msgs::Num_<ContainerAllocator>> : FalseType
        {
        };

        template <class ContainerAllocator> struct HasHeader<::trick_msgs::Num_<ContainerAllocator> const> : FalseType
        {
        };

        template <class ContainerAllocator> struct MD5Sum<::trick_msgs::Num_<ContainerAllocator>>
        {
                static const char* value() { return "345b622c1a8704503c97d4d3be56b05d"; }
        ...
        template <class ContainerAllocator> struct DataType<::trick_msgs::Num_<ContainerAllocator>>
        {
                static const char* value() { return "trick_msgs/Num"; }

                static const char* value(const ::trick_msgs::Num_<ContainerAllocator>&) { return value(); }
        };

        template <class ContainerAllocator> struct Definition<::trick_msgs::Num_<ContainerAllocator>>
        {
...
namespace ros
{
    namespace message_operations
    {
        ...
        template <class ContainerAllocator> struct Printer<::trick_msgs::Num_<ContainerAllocator>>
        {
                template <typename Stream>
                static void stream(
                    Stream& s, const std::string& indent, const ::trick_msgs::Num_<ContainerAllocator>& v)
                {
                    s << indent << "first_name: ";
                    ...
                    s << indent << "date: ";
                    Printer<std::basic_string<char, std::char_traits<char>,
                        typename ContainerAllocator::template rebind<char>::other>>::stream(s, indent + "  ", v.date);
                    s << indent << "points: ";
