...
template<class ContainerAllocator> struct Num_
{
    ...
    typedef boost::shared_ptr<const ::trick_msgs::Num_<ContainerAllocator>> ConstPtr;
...
typedef boost::shared_ptr<const ::trick_msgs::Num> NumConstPtr;
...
template<class ContainerAllocator> struct IsFixedSize<const ::trick_msgs::Num_<ContainerAllocator>> : FalseType
{
};
...
template<class ContainerAllocator> struct IsMessage<const ::trick_msgs::Num_<ContainerAllocator>> : TrueType
{
};
...
template<class ContainerAllocator> struct HasHeader<const ::trick_msgs::Num_<ContainerAllocator>> : FalseType
{
};
...
template<class ContainerAllocator> struct MD5Sum<::trick_msgs::Num_<ContainerAllocator>>
{
    ...
    static const char * value(const ::trick_msgs::Num_<ContainerAllocator> &)
    {
        return value();
    }
...
template<class ContainerAllocator> struct Printer<::trick_msgs::Num_<ContainerAllocator>>
{
    ...
    static void stream(Stream & s, const std::string & indent, const ::trick_msgs::Num_<ContainerAllocator> & v)
    {
        s << indent << "first_name: ";
