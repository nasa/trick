...
******************************************************************************/
void BODY::calcforce() { MxV(force, rotate, FORCE_INIT); };
...
int BODY::integ()
{
    ...
    load_state(&pos[0], &pos[1], &pos[2], &vel[0], &vel[1], &vel[2], &angle[0], &angle[1], &angle[2], &omega[0],
        &omega[1], &omega[2],

        NULL);

    load_deriv(&vel[0], &vel[1], &vel[2], &acc[0], &acc[1], &acc[2], &omega[0], &omega[1], &omega[2], &omegaDot[0],
    ...
    unload_state(&pos[0], &pos[1], &pos[2], &vel[0], &vel[1], &vel[2], &angle[0], &angle[1], &angle[2], &omega[0],
        &omega[1], &omega[2],
