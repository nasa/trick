...
TRICK_USER_LINK_LIBS += models/fluid/src/gpuCode.o models/fluid/src/sph_gpu.o models/fluid/graphics/src/opengl_caller.o models/fluid/graphics/src/opengl.o models/fluid/graphics/src/gui.o models/fluid/graphics/src/sph.o -L/usr/local/cuda/lib64 -lcudart -lcudadevrt -lglfw -lGL -lGLEW -pthread
...
models/fluid/graphics/src/sph.o: models/fluid/graphics/src/sph.cpp
	g++ -c models/fluid/graphics/src/sph.cpp -o models/fluid/graphics/src/sph.o
...
models/fluid/src/gpuCode.o: models/fluid/src/sph_gpu.o
	nvcc -arch=sm_35 -dlink models/fluid/src/sph_gpu.o models/fluid/graphics/src/opengl_caller.o models/fluid/graphics/src/opengl.o models/fluid/graphics/src/gui.o models/fluid/graphics/src/sph.o $(S_OBJECTS) -o models/fluid/src/gpuCode.o
