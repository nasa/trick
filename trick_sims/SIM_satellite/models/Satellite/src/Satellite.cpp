...
Satellite::Satellite(Planet* planet_p) { initialize(planet_p); }
...
int Satellite::compute_state()
{
    ...
    load_state(&P[0], &P[1], &P[2], &pos[0], &pos[1], &pos[2], &L[0], &L[1], &L[2], &R[0][0], &R[0][1], &R[0][2],
        &R[1][0], &R[1][1], &R[1][2], &R[2][0], &R[2][1], &R[2][2], NULL);

    load_deriv(&force[0], &force[1], &force[2], &vel[0], &vel[1], &vel[2], &torque[0], &torque[1], &torque[2],
        &Rdot[0][0], &Rdot[0][1], &Rdot[0][2], &Rdot[1][0], &Rdot[1][1], &Rdot[1][2], &Rdot[2][0], &Rdot[2][1],
        &Rdot[2][2], NULL);

    ipass = integrate();

    unload_state(&P[0], &P[1], &P[2], &pos[0], &pos[1], &pos[2], &L[0], &L[1], &L[2], &R[0][0], &R[0][1], &R[0][2],
        &R[1][0], &R[1][1], &R[1][2], &R[2][0], &R[2][1], &R[2][2], NULL);
