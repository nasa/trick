...
WaypointList::WaypointList() { length = 0; }
...
void WaypointList::clear() { length = 0; }
...
std::string WaypointList::getImage(int index) { return img[index]; }

int WaypointList::size() { return length; }
