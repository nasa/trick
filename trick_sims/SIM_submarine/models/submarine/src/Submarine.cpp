...
int Submarine::state_init() { return (0); }
...
double Submarine::calc_gravity_force() { return -calc_total_mass() * GRAVITY; }
...
double Submarine::calc_buoyancy_force() { return (calc_total_displaced_volume() * DENSITY_SALT_WATER * GRAVITY); }
...
int Submarine::state_post_integ() { return (0); }
