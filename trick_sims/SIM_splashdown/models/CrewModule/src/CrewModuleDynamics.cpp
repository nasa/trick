...
CrewModuleDynamics::CrewModuleDynamics() { init_defaults(); }
...
void CrewModuleDynamics::calcDragTorque() { V_SCALE(torque_drag, angular_velocity, -5000.0); }
...
void CrewModuleDynamics::calcMassDisplaced() { mass_displaced = density_of_water * volume_displaced; }
...
void CrewModuleDynamics::calcGravityForce() { V_SCALE(force_gravity, acceleration_of_gravity, mass_vehicle); }

void CrewModuleDynamics::calcDragForce() { V_SCALE(force_drag, velocity, -2000.0); }
...
{
    int ipass;
    load_state(&momentum[0], &momentum[1], &momentum[2], &position[0], &position[1], &position[2], &angular_momentum[0],
        &angular_momentum[1], &angular_momentum[2], &R[0][0], &R[0][1], &R[0][2], &R[1][0], &R[1][1], &R[1][2],
        &R[2][0], &R[2][1], &R[2][2], NULL);
    load_deriv(&force_total[0], &force_total[1], &force_total[2], &velocity[0], &velocity[1], &velocity[2],
        &torque_total[0], &torque_total[1], &torque_total[2], &Rdot[0][0], &Rdot[0][1], &Rdot[0][2], &Rdot[1][0],
        &Rdot[1][1], &Rdot[1][2], &Rdot[2][0], &Rdot[2][1], &Rdot[2][2], NULL);
    ipass = integrate();
    unload_state(&momentum[0], &momentum[1], &momentum[2], &position[0], &position[1], &position[2],
        &angular_momentum[0], &angular_momentum[1], &angular_momentum[2], &R[0][0], &R[0][1], &R[0][2], &R[1][0],
        &R[1][1], &R[1][2], &R[2][0], &R[2][1], &R[2][2], NULL);
    int axis = 0;
