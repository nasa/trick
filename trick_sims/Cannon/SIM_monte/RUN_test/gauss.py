...
var0 = trick.MonteVarRandom(
    "dyn.baseball.time_to_fire_jet_1",
    trick.MonteVarRandom.GAUSSIAN,
    "s",
    trick.MonteVarRandom.NO_ENGINE,
)  # NO_ENGINE is default
var0.set_seed(1)
...
var0.set_sigma_range(
    0
)  # 1 is default, so usually set to zero to turn off the algorithm

var1 = trick.MonteVarRandom(
    "dyn.baseball.time_to_fire_jet_2", trick.MonteVarRandom.GAUSSIAN
)
var1.set_seed(2)
...
var2 = trick.MonteVarRandom(
    "dyn.baseball.time_to_fire_jet_3", trick.MonteVarRandom.GAUSSIAN, "s"
)
var2.set_seed(3)
...
var3 = trick.MonteVarRandom(
    "dyn.baseball.time_to_fire_jet_4", trick.MonteVarRandom.GAUSSIAN
)
var3.set_seed(4)
