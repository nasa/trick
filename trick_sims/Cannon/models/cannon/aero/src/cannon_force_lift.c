...
int cannon_force_lift(CANNON_AERO * C)
{
    ...
    switch(C->lift_method)
    {
        ...
        case Tombras:
            ...
            /* k = 1/2*rho*Cl*A*V^2 */
            k = (0.5) * C->air_density * C->coefficient_lift * C->ball_area * speed * speed;
        ...
        case Adair_Giordano:
            ...
            C->coefficient_lift = (2 * k * V_MAG(w_cross_v)) / (C->air_density * C->ball_area * speed * speed);
            break;
    }
