...
DifferentialDriveController::DifferentialDriveController(double DistanceBetweenWheels, double WheelRadius,
    double WheelSpeedLimit, double HeadingRateLimit, double SlowDownDistance,
    MotorSpeedController& RightMotorController, MotorSpeedController& LeftMotorController)
    ...
    headingctrl(1.0, 0.08, 0.5, headingRateLimit, -headingRateLimit, 0.1, 0.1)
    , wheelspeedctrl(1.0, 0.082, 0.5, wheelSpeedLimit, -wheelSpeedLimit, 0.1, 0.1)
{
}
