...
VehicleController::VehicleController(std::vector<Point>* wayPoints, Navigator& theNavigator,
    DifferentialDriveController& theDriveController, double arrival_distance)
...
bool VehicleController::getStatus() { return endofWaypoints; }
