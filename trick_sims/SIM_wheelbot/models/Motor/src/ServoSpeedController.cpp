...
void ServoSpeedController::setCommandedSpeed(double commandedSpeed)
{
    ...
    if(_side == 'L')
    {
        ...
        PulseWidth = 9.1296697267545980e+001 * pow(desiredspeed, 0) + 1.3551549019843796e+000 * pow(desiredspeed, 1) +
                     -2.5748263162935388e-002 * pow(desiredspeed, 2) + -3.7691759514032080e-003 * pow(desiredspeed, 3) +
                     3.8490572015823302e-004 * pow(desiredspeed, 4) + 4.5526955758039407e-005 * pow(desiredspeed, 5) +
