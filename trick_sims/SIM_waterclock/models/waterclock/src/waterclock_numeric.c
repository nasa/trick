...
int waterclock_deriv(WATERCLOCK* WC)
{
    ...
    if (WC->intake_water_level > WC->intake_clock_spout_height)
        WC->intake_clock_spout_flowrate
            = spout_area * sqrt(2 * WC->gravity * (WC->intake_water_level - WC->intake_clock_spout_height));
    else
    ...
    if (WC->intake_water_level > WC->intake_overflow_height)
        WC->intake_overflow_flowrate
            = overflow_area * sqrt(2 * WC->gravity * (WC->intake_water_level - WC->intake_overflow_height));
    else
