...
void GST_secs_time(double JD, double* GST)
{
    ...
    cap_theta_0 = 24110.54842 + (8640184.812866 * T) + (0.093104 * T * T) - (0.0000062 * T * T * T);
...
void LST_secs_time(double GST, double longitude, double* LST) { *LST = GST - (longitude * (3600.0 / 15.0)); }
