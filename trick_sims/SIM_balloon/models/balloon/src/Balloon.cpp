...
double Balloon::calc_total_mass() { return (fixed_mass + calc_envelope_air_mass()); }
...
double Balloon::volume_of_a_cone(double r, double h) { return ((M_PI * r * r * h) / 3.0); /* Equation #6 */ }
...
double Balloon::calc_buoyancy_force() { return (calc_displaced_air_mass() * US_STD_gravity(pos[1])); /* Equation 9 */ }
...
double Balloon::calc_fixed_mass() { return (envelope_mass + basket_mass + burner_system_mass + payload_mass); }
