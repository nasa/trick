      ...
      den(1u)
{
    if(dval != 0.0)
    {
        ...
        Ratio128 rval = Ratio128((unsigned long long)(fnorm * 0x1p53), 1ull << 53, sign);
        if(expo > 0)
        {
            if(expo >= (128 - 53))
            {
...
void Ratio128::swap(Ratio128 & other)
{
...
Ratio128 Ratio128::inverse() const
{
...
Ratio128 & Ratio128::operator+=(const Ratio128 & other)
{
    if(num == 0ull)
    {
        *this = other;
...
bool operator<(const Ratio128 & a, const Ratio128 & b)
{
    if(a.sign < b.sign)
    {
        return true;
...
double Ratio128::to_double() const
{
...
Ratio128::operator double() const
{
...
Ratio128::operator std::string() const
{
    std::string result;
    if(sign < 0)
    {
...
std::ostream & operator<<(std::ostream & stream, const Ratio128 & rat)
{
    stream << std::string(rat);
    return stream;
}

void Ratio128::make_ratio(int64_t num_in, int64_t den_in)
{
    if(den_in == 0)
    {
