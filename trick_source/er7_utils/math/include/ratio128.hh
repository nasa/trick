...
namespace er7_utils
{
    ...
    class Ratio128
    {
        ...
        public:
             ...
             */
            Ratio128(unsigned long long num_in, unsigned long long den_in = 1ull, int sign_in = 1)
             ...
             * plus optional denominator and sign.
             */
            Ratio128(unsigned long num_in, unsigned long den_in = 1ull, int sign_in = 1)
             ...
             * and sign.
             */
            Ratio128(unsigned int num_in, unsigned int den_in = 1u, int sign_in = 1)
                : sign((num_in == 0ull) ? 0 : ((sign_in < 0) ? -1 : 1))
                , num(num_in)
                , den(den_in)
            {
             ...
             */
            Ratio128(long long num_in, long long den_in = 1LL)
                : sign(0)
                , num(0ull)
                , den(1ull)
            {
             ...
             */
            Ratio128(long num_in, long den_in = 1L)
                : sign(0)
                , num(0ull)
                , den(1ull)
            {
             ...
             */
            Ratio128(int num_in, int den_in = 1LL)
                : sign(0)
                , num(0ull)
                , den(1ull)
            {
            ...
            friend void swap(Ratio128& a, Ratio128& b) { a.swap(b); }
             ...
             */
            friend Ratio128 operator+(const Ratio128& a) { return a; }
             ...
             * Returns a+b.
             */
            template <typename T> friend Ratio128 operator+(T a, const Ratio128& b)
            {
             ...
             * Returns a+b.
             */
            template <typename T> friend Ratio128 operator+(const Ratio128& a, T b)
            {
                Ratio128 result  = a;
                result          += Ratio128(b);
                return result;
             ...
             * Returns a&lt;b.
             */
            template <typename T> friend bool operator<(T a, const Ratio128& b) { return Ratio128(a) < b; }

            /**
             * Returns a&lt;b.
             */
            template <typename T> friend bool operator<(const Ratio128& a, T b) { return a < Ratio128(b); }

            /**
             * Returns a>=b.
             */
            friend bool operator>=(const Ratio128& a, const Ratio128& b) { return !(a < b); }
