...
namespace er7_utils
{
    ...
    class UInt128
    {
        ...
        public:
             ...
             */
            void divide(UInt128 divisor, UInt128& quotient, UInt128& remainder);
             ...
             */
            UInt128& operator++() { return operator+=(1ull); }
             ...
             * @return True if a and b are equal, false otherwise.
             */
            friend bool operator==(const UInt128& a, unsigned long long b) { return (a.high == 0ull) && (a.low == b); }
             ...
             * @return True if a and b are equal, false otherwise.
             */
            friend bool operator==(const UInt128& a, unsigned long b) { return (a.high == 0ull) && (a.low == b); }
             ...
             * @return True if a and b are equal, false otherwise.
             */
            friend bool operator==(unsigned long long a, const UInt128& b) { return (b == a); }
             ...
             * @return True if a and b are equal, false otherwise.
             */
            friend bool operator==(unsigned long a, const UInt128& b) { return (b == a); }
