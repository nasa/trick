...
namespace er7_utils
{
    ...
    namespace trick_interface
    {
         ...
         * @return Demangled type name.
         */
        template <typename T> inline const std::string type_name(std::string) { return alloc::demangle(typeid(T)); }
#else
        /**
         ...
         * @return Type name.
         */
        template <typename T> inline const std::string type_name(std::string name_of_type)
        {
            if (name_of_type.find("::") == 0)
            {
                name_of_type.erase(0, 2);
            }
            else if ((name_of_type.find("Trick::") != 0) && (name_of_type.find("er7_utils::") != 0))
            {
         ...
         */
        template <typename T> inline T* trick_alloc(std::string name_of_type, unsigned int count)
        {
            name_of_type = type_name<T>(name_of_type);
            T* ptr       = reinterpret_cast<T*>(TMM_declare_var_1d(name_of_type.c_str(), count));
            if (!ptr)
            {
                throw std::bad_alloc();
            }
         ...
         * @return Array of allocated objects.
         */
        template <typename T> inline T* alloc_object(std::string name_of_type)
        {
         ...
         */
        template <typename T> inline void delete_object(T*& obj)
        {
            if (obj)
            {
 ...
 */
#define ER7_UTILS_ALLOC_PRIM_ARRAY(size, type) er7_utils::trick_interface::trick_alloc<type>(#type, size)
 ...
 */
#define ER7_UTILS_ALLOC_CLASS_OBJECT(type, cotr) new (er7_utils::trick_interface::alloc_object<type>(#type)) type cotr

/**
 * Delete a previously allocated array.
 * @param arr Array to be deleted.
 */
#define ER7_UTILS_DELETE_ARRAY(arr) er7_utils::trick_interface::delete_object(arr)

/**
 * Delete a previously allocated instance of a class.
 * @param obj Object to be deleted.
 */
#define ER7_UTILS_DELETE_OBJECT(obj) er7_utils::trick_interface::delete_object(obj)
...
#define ER7_UTILS_ALLOC_PRIM_ARRAY(size, type) JEOD_ALLOC_PRIM_ARRAY(size, type)

#define ER7_UTILS_ALLOC_CLASS_OBJECT(type, cotr) JEOD_ALLOC_PRIM_ARRAY(type, cotr)

#define ER7_UTILS_DELETE_ARRAY(arr) JEOD_DELETE_ARRAY(arr)

#define ER7_UTILS_DELETE_OBJECT(obj) JEOD_DELETE_OBJECT(obj)
...
namespace er7_utils
{
    namespace default_interface
    {
        ...
        template <typename T> inline T* allocate_array(std::size_t size)
        {
            T* arr = new T[size];
        ...
        template <typename T> inline void delete_array(T*& obj)
        {
            if (obj)
            {
                delete[] obj;
...
#define ER7_UTILS_ALLOC_PRIM_ARRAY(size, type) er7_utils::default_interface::allocate_array<type>(size)

#define ER7_UTILS_ALLOC_CLASS_OBJECT(type, cotr) new type cotr

#define ER7_UTILS_DELETE_ARRAY(arr) er7_utils::default_interface::delete_array(arr)

#define ER7_UTILS_DELETE_OBJECT(obj) er7_utils::default_interface::delete_object(obj)
...
namespace er7_utils
{
    ...
    namespace alloc
    {
         ...
         */
        template <typename T> inline T* allocate_object() { return ER7_UTILS_ALLOC_CLASS_OBJECT(T, ()); }
         ...
         * @return      Allocated object.
         */
        template <typename T> inline T* replicate_object(const T& src)
        {
         ...
         * @return       Allocated object.
         */
        template <typename T, typename A1> inline T* allocate_object(A1 arg1)
        {
         ...
         * @return       Allocated object.
         */
        template <typename T, typename A1, typename A2> inline T* allocate_object(A1 arg1, A2 arg2)
        {
        ...
        inline T* allocate_object(A1 arg1, A2 arg2, A3 arg3)
        {
        ...
        inline T* allocate_object(A1 arg1, A2 arg2, A3 arg3, A4 arg4)
        {
        ...
        inline T* allocate_object(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5)
        {
            return ER7_UTILS_ALLOC_CLASS_OBJECT(T, (arg1, arg2, arg3, arg4, arg5));
        }
        ...
        inline T* allocate_object(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6)
        {
            return ER7_UTILS_ALLOC_CLASS_OBJECT(T, (arg1, arg2, arg3, arg4, arg5, arg6));
        }
         ...
         */
        template <typename T> inline void delete_object(T*& obj) { ER7_UTILS_DELETE_OBJECT(obj); }
         ...
         */
        template <typename T> inline T* allocate_array(unsigned int size)
        {
         ...
         * @return      Allocated array.
         */
        inline double* allocate_array(unsigned int size) { return ER7_UTILS_ALLOC_PRIM_ARRAY(size, double); }
         ...
         * @return      Allocated array.
         */
        template <typename T> inline T* replicate_array(unsigned int size, const T* src)
        {
         ...
         */
        template <typename T> inline void deallocate_array(T*& arr) { ER7_UTILS_DELETE_ARRAY(arr); }
         ...
         */
        template <typename T> inline void initialize_array(unsigned int size, T* arr)
        {
            std::memset(arr, 0, size * sizeof(T));
        }
         ...
         */
        template <typename T, unsigned int M> inline void initialize_2D_array(T* arr[M])
        {
         ...
         * @param[out]    arr   Array to be initialized
         */
        template <unsigned int M> inline void initialize_2D_array(double* arr[M]) { initialize_array<double*>(M, arr); }
         ...
         */
        template <typename T, unsigned int M> inline void allocate_2D_array(unsigned int size, T* arr[M])
        {
         ...
         * @param[out]    arr   Array to be allocated
         */
        template <unsigned int M> inline void allocate_2D_array(unsigned int size, double* arr[M])
        {
         ...
         */
        template <typename T> inline T** allocate_2D_array(unsigned int outer, unsigned int inner)
        {
        ...
        inline void replicate_2D_array(unsigned int size, T* const src[M], T* tgt[M])
        {
        ...
        inline void replicate_2D_array(unsigned int size, double* const src[M], double* tgt[M])
        {
            for (unsigned int ii = 0; ii < M; ++ii)
            {
                if (ii == 0)
         ...
         */
        template <typename T> inline T** replicate_2D_array(unsigned int outer, unsigned int inner, T** source)
        {
         ...
         */
        template <typename T, unsigned int M> inline void deallocate_2D_array(T* arr[M])
        {
         ...
         * @param[in,out] arr   Array to be deallocated
         */
        template <unsigned int M> inline void deallocate_2D_array(double* arr[M]) { deallocate_array<double>(arr[0]); }
         ...
         * @param[in,out] arr   Array to be deallocated
         */
        template <typename T> inline void deallocate_2D_array(unsigned int, T**& arr)
        {
            if (arr != NULL)
            {
                deallocate_array<T>(arr[0]);
