 ...
 * @return Demangled type name.
 */
template<typename T> inline const std::string type_name(std::string)
{
 ...
 */
template<typename T> inline T * allocate_object()
{
 ...
 * @return       Allocated object.
 */
template<typename T, typename A1, typename A2, typename A3> inline T * allocate_object(A1 arg1, A2 arg2, A3 arg3)
{
 ...
 */
template<typename T> inline void deallocate_array(T *& arr)
{
 ...
 * @param[out]    arr   Array to be initialized
 */
template<unsigned int M> inline void initialize_2D_array(double * arr[M])
{
 ...
 */
template<typename T, unsigned int M> inline void replicate_2D_array(unsigned int size, T * const src[M], T * tgt[M])
{
 ...
 * @param[out]    tgt   Array to be allocated and populated
 */
template<unsigned int M> inline void replicate_2D_array(unsigned int size, double * const src[M], double * tgt[M])
{
    for(unsigned int ii = 0; ii < M; ++ii)
    {
        if(ii == 0)
 ...
 * @param[in,out] arr   Array to be deallocated
 */
template<unsigned int M> inline void deallocate_2D_array(double * arr[M])
{
