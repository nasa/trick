...
protected:
     ...
     * @param[in,out] controls       Integration controls
     */
    RKNystrom4SecondOrderODEIntegrator(unsigned int position_size,
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RKNystrom4GeneralizedStepSecondOrderODEIntegrator(const RKNystrom4GeneralizedStepSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RKNystrom4SecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RKNystrom4GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                                                      unsigned int velocity_size,
                                                      const GeneralizedPositionStepFunctions & step_funs,
                                                      IntegrationControls & controls)
        : Er7UtilsDeletable(),
     ...
     * @param[in] src  Object to be copied.
     */
    RKNystrom4GeneralizedStepSecondOrderODEIntegrator & operator=(RKNystrom4GeneralizedStepSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
