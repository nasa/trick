...
// Copy constructor.
RKNystrom4SecondOrderODEIntegrator::RKNystrom4SecondOrderODEIntegrator(const RKNystrom4SecondOrderODEIntegrator & src)
    : Er7UtilsDeletable(),
...
RKNystrom4SecondOrderODEIntegrator::RKNystrom4SecondOrderODEIntegrator(unsigned int size,
...
RKNystrom4GeneralizedStepSecondOrderODEIntegrator * RKNystrom4GeneralizedStepSecondOrderODEIntegrator::create_copy()
    const
{
    return alloc::replicate_object(*this);
}
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE simple_rkn4_step_one(const double * ER7_UTILS_RESTRICT accel,
                                                         double hdt,
                                                         int size,
 ...
 * @param[in,out] velocity     Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE simple_rkn4_step_three(const double * ER7_UTILS_RESTRICT init_pos,
...
simple_rkn4_step_four(const double * ER7_UTILS_RESTRICT init_pos,
                      const double * ER7_UTILS_RESTRICT init_vel,
                      const double * ER7_UTILS_RESTRICT accel,
                      ...
                      double * ER7_UTILS_RESTRICT velocity)
{
    ...
    const double * ER7_UTILS_RESTRICT veldot_0 = veldot_hist[0];
    const double * ER7_UTILS_RESTRICT veldot_1 = veldot_hist[1];
    const double * ER7_UTILS_RESTRICT veldot_2 = veldot_hist[2];
...
// position.
IntegratorResult RKNystrom4SimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
...
#else
            simple_rkn4_step_three(init_pos,
                                   init_vel,
                                   accel,
                                   0.5 * dyn_dt,
                                   state_size[0],
 ...
 * @param[in,out] velocity     Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE generalized_rkn4_step_one_velocity(const double * ER7_UTILS_RESTRICT accel,
                                                                       double hdt,
                                                                       int size,
                                                                       double * ER7_UTILS_RESTRICT init_vel,
 ...
 * @param[in,out] velocity     Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE generalized_rkn4_step_three_velocity(const double * ER7_UTILS_RESTRICT init_vel,
                                                                         const double * ER7_UTILS_RESTRICT accel,
                                                                         double delta_t,
                                                                         int size,
                                                                         double * ER7_UTILS_RESTRICT dtheta,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE
generalized_rkn4_step_four_velocity(const double * ER7_UTILS_RESTRICT init_vel,
                                    const double * ER7_UTILS_RESTRICT accel,
                                    const double * ER7_UTILS_RESTRICT const * ER7_UTILS_RESTRICT veldot_hist,
                                    double delta_t,
                                    int size,
                                                                              ...
                                                                              double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        case 1:
            ...
            generalized_rkn4_step_one_velocity(accel,
                                               0.5 * dyn_dt,
                                               state_size[1],
                                               init_vel,
                                               dtheta,
...
#else
            generalized_rkn4_step_three_velocity(init_vel,
                                                 accel,
                                                 0.5 * dyn_dt,
                                                 state_size[1],
                                                 dtheta,
