...
void ABM4SimpleSecondOrderODEIntegrator::technique_save_derivatives(int,
...
IntegratorResult ABM4SimpleSecondOrderODEIntegrator::technique_integrate(double dyn_dt,
...
// Save derivatives during priming
void ABM4GeneralizedDerivSecondOrderODEIntegrator::technique_save_derivatives(
    int,
    const double * ER7_UTILS_RESTRICT accel,
    const double * ER7_UTILS_RESTRICT velocity,
