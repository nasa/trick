...
ABM4FirstOrderODEIntegrator::ABM4FirstOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                                         unsigned int size,
...
void ABM4FirstOrderODEIntegrator::technique_save_derivatives(int,
...
IntegratorResult ABM4FirstOrderODEIntegrator::technique_integrate(double dt,
                                                                  ...
                                                                  double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 2:
            ...
            abm::corrector_step<4>(init_state,
                                   velocity,
                                   deriv_hist,
                                   corrector_weights,
                                   wscale,
