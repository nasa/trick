...
IntegratorConstructor * ABM4IntegratorConstructor::create_copy(void) const
{
...
SecondOrderODEIntegrator * ABM4IntegratorConstructor::create_second_order_ode_integrator(
    unsigned int size, IntegrationControls & controls) const
{
    return integ_utils::allocate_integrator<ABM4SimpleSecondOrderODEIntegrator>(*primer_constructor, size, controls);
}
...
{
    return integ_utils::allocate_integrator<ABM4GeneralizedDerivSecondOrderODEIntegrator>(*primer_constructor,
                                                                                          position_size,
                                                                                          velocity_size,
                                                                                          deriv_funs,
                                                                                          controls);
