...
protected:
     ...
     */
    ABM4SecondOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                 unsigned int size,
...
private:
     ...
     * Not implemented.
     */
    ABM4SecondOrderODEIntegrator & operator=(const ABM4SecondOrderODEIntegrator &);
};
 ...
 */
class ABM4SimpleSecondOrderODEIntegrator : public ABM4SecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    ABM4SimpleSecondOrderODEIntegrator(const ABM4SimpleSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
     ...
     */
    ABM4SimpleSecondOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                       unsigned int size,
     ...
     * @param[in] src  Object to be copied.
     */
    ABM4SimpleSecondOrderODEIntegrator & operator=(ABM4SimpleSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
...
protected:
     ...
     */
    virtual void technique_save_derivatives(int countdown,
     ...
     */
    virtual IntegratorResult technique_integrate(double dyn_dt,
 ...
 */
class ABM4GeneralizedDerivSecondOrderODEIntegrator : public ABM4SecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    ABM4GeneralizedDerivSecondOrderODEIntegrator(const ABM4GeneralizedDerivSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          ABM4SecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls_in         Integration controls
     */
    ABM4GeneralizedDerivSecondOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                                 unsigned int position_size,
                                                 unsigned int velocity_size,
                                                 const GeneralizedPositionDerivativeFunctions & deriv_funs,
                                                 IntegrationControls & controls_in)
        : Er7UtilsDeletable(),
          ABM4SecondOrderODEIntegrator(primer_constructor, position_size, velocity_size, deriv_funs, controls_in)
    {
    }
     ...
     * @param[in] src  Object to be copied.
     */
    ABM4GeneralizedDerivSecondOrderODEIntegrator & operator=(ABM4GeneralizedDerivSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
