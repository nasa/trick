...
public:
     ...
     */
    ABM4FirstOrderODEIntegrator(const ABM4FirstOrderODEIntegrator & src);
     ...
     */
    ABM4FirstOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                unsigned int size,
     ...
     */
    ABM4FirstOrderODEIntegrator & operator=(ABM4FirstOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
