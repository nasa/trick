...
SymplecticEulerSecondOrderODEIntegrator::SymplecticEulerSecondOrderODEIntegrator(unsigned int size,
...
// position.
IntegratorResult SymplecticEulerSimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
...
IntegratorResult SymplecticEulerGeneralizedDerivSecondOrderODEIntegrator::integrate(
    double dyn_dt,
    unsigned int target_stage,
    const double * ER7_UTILS_RESTRICT accel,
    double * ER7_UTILS_RESTRICT velocity,
