...
namespace er7_utils
{
    ...
    class SymplecticEulerIntegratorConstructor : public IntegratorConstructor
    {
        ...
        public:
             ...
             */
            virtual const char* get_class_name(void) const { return "SymplecticEulerIntegratorConstructor"; }
             ...
             */
            virtual unsigned int get_transition_table_size(void) const { return 1; }
    };
