...
namespace er7_utils
{
     ...
     */
    class SymplecticEulerSecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            SymplecticEulerSecondOrderODEIntegrator(const SymplecticEulerSecondOrderODEIntegrator& src);
             ...
             */
            SymplecticEulerSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls);
             ...
             * @param[in,out] controls       Integration controls
             */
            SymplecticEulerSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        ...
        private:
             ...
             * Not implemented.
             */
            SymplecticEulerSecondOrderODEIntegrator& operator=(const SymplecticEulerSecondOrderODEIntegrator&);
    };
     ...
     */
    class SymplecticEulerSimpleSecondOrderODEIntegrator : public SymplecticEulerSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            SymplecticEulerSimpleSecondOrderODEIntegrator(const SymplecticEulerSimpleSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
             ...
             * @param[in,out] controls  Integration controls
             */
            SymplecticEulerSimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
                : Er7UtilsDeletable()
             ...
             * @param[in] src  Object to be copied.
             */
            SymplecticEulerSimpleSecondOrderODEIntegrator& operator=(SymplecticEulerSimpleSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class SymplecticEulerGeneralizedDerivSecondOrderODEIntegrator : public SymplecticEulerSecondOrderODEIntegrator
    {
            ER7_UTILS_MAKE_SIM_INTERFACES(SymplecticEulerGeneralizedDerivSecondOrderODEIntegrator)
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            SymplecticEulerGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                unsigned int velocity_size, const GeneralizedPositionDerivativeFunctions& deriv_funs,
                IntegrationControls& controls)
                : Er7UtilsDeletable()
                , SymplecticEulerSecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
            {
            }
             ...
             * @return Clone of 'this'.
             */
            virtual SymplecticEulerGeneralizedDerivSecondOrderODEIntegrator* create_copy() const;
     ...
     * the generalized position and generalized velocity.
     */
    class SymplecticEulerGeneralizedStepSecondOrderODEIntegrator : public SymplecticEulerSecondOrderODEIntegrator
    {
            ER7_UTILS_MAKE_SIM_INTERFACES(SymplecticEulerGeneralizedStepSecondOrderODEIntegrator)
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            SymplecticEulerGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                unsigned int velocity_size, const GeneralizedPositionStepFunctions& step_funs,
                IntegrationControls& controls)
                : Er7UtilsDeletable()
                , SymplecticEulerSecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
            {
            }
             ...
             * @return Clone of 'this'.
             */
            virtual SymplecticEulerGeneralizedStepSecondOrderODEIntegrator* create_copy() const;
