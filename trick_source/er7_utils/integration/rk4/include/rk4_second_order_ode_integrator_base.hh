...
namespace er7_utils
{
    ...
    class RK4SecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            RK4SecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls);
             ...
             * @param[in,out] controls       Integration controls
             */
            RK4SecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        ...
        private:
             ...
             * Not implemented.
             */
            RK4SecondOrderODEIntegrator& operator=(const RK4SecondOrderODEIntegrator&);
    };
