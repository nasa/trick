...
namespace er7_utils
{
     ...
     */
    class RK4SimpleSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             */
            RK4SimpleSecondOrderODEIntegrator(const RK4SimpleSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
             ...
             */
            RK4SimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
                : Er7UtilsDeletable()
             ...
             * @param[in] src  Object to be copied.
             */
            RK4SimpleSecondOrderODEIntegrator& operator=(RK4SimpleSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class RK4GeneralizedDerivSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            RK4GeneralizedDerivSecondOrderODEIntegrator(const RK4GeneralizedDerivSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
                , RK4SecondOrderODEIntegrator(src)
            {
            }
             ...
             * @param[in,out] controls       Integration controls
             */
            RK4GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
             ...
             * @param[in] src  Object to be copied.
             */
            RK4GeneralizedDerivSecondOrderODEIntegrator& operator=(RK4GeneralizedDerivSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class RK4GeneralizedStepSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            RK4GeneralizedStepSecondOrderODEIntegrator(const RK4GeneralizedStepSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
                , RK4SecondOrderODEIntegrator(src)
            {
            }
             ...
             * @param[in,out] controls       Integration controls
             */
            RK4GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
             ...
             * @param[in] src  Object to be copied.
             */
            RK4GeneralizedStepSecondOrderODEIntegrator& operator=(RK4GeneralizedStepSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
