...
// position.
IntegratorResult RK4SimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                              ...
                                                              double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
         ...
         */
        case 2:
            rk::rk_two_state_intermediate_step(init_pos,
                                               init_vel,
                                               accel,
                                               0.5 * dyn_dt,
                                               state_size[0],
         ...
         */
        case 4:
            rk::rk4_two_state_final_step(init_pos,
                                         init_vel,
                                         posdot_hist,
                                         veldot_hist,
                                         accel,
...
IntegratorResult RK4GeneralizedDerivSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                        unsigned int target_stage,
                                                                        const double * ER7_UTILS_RESTRICT accel,
                                                                        double * ER7_UTILS_RESTRICT velocity,
                                                                        double * ER7_UTILS_RESTRICT position)
...
IntegratorResult RK4GeneralizedStepSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                       unsigned int target_stage,
                                                                       const double * ER7_UTILS_RESTRICT accel,
                                                                       double * ER7_UTILS_RESTRICT velocity,
                                                                       double * ER7_UTILS_RESTRICT position)
