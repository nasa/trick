...
public:
     ...
     */
    RKFehlberg45FirstOrderODEIntegrator(const RKFehlberg45FirstOrderODEIntegrator & src);
     ...
     */
    RKFehlberg45FirstOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     */
    RKFehlberg45FirstOrderODEIntegrator & operator=(RKFehlberg45FirstOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
