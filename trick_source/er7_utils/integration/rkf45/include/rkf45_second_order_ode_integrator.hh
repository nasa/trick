...
protected:
     ...
     */
    RKFehlberg45SecondOrderODEIntegrator(const RKFehlberg45SecondOrderODEIntegrator & src);
     ...
     */
    RKFehlberg45SecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     * @param[in,out] controls       Integration controls
     */
    RKFehlberg45SecondOrderODEIntegrator(unsigned int position_size,
...
private:
     ...
     * Not implemented.
     */
    RKFehlberg45SecondOrderODEIntegrator & operator=(const RKFehlberg45SecondOrderODEIntegrator &);
};
 ...
 */
class RKFehlberg45SimpleSecondOrderODEIntegrator : public RKFehlberg45SecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RKFehlberg45SimpleSecondOrderODEIntegrator(const RKFehlberg45SimpleSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
     ...
     * @param[in,out] controls  Integration controls
     */
    RKFehlberg45SimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls)
        : Er7UtilsDeletable(),
     ...
     * @param[in] src  Object to be copied.
     */
    RKFehlberg45SimpleSecondOrderODEIntegrator & operator=(RKFehlberg45SimpleSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
 ...
 */
class RKFehlberg45GeneralizedDerivSecondOrderODEIntegrator : public RKFehlberg45SecondOrderODEIntegrator
{
    ER7_UTILS_MAKE_SIM_INTERFACES(RKFehlberg45GeneralizedDerivSecondOrderODEIntegrator)
...
public:
     ...
     * @param[in,out] controls       Integration controls
     */
    RKFehlberg45GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                                                         unsigned int velocity_size,
                                                         const GeneralizedPositionDerivativeFunctions & deriv_funs,
                                                         IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RKFehlberg45SecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
    {
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RKFehlberg45GeneralizedDerivSecondOrderODEIntegrator * create_copy() const;
 ...
 * the generalized position and generalized velocity.
 */
class RKFehlberg45GeneralizedStepSecondOrderODEIntegrator : public RKFehlberg45SecondOrderODEIntegrator
{
    ER7_UTILS_MAKE_SIM_INTERFACES(RKFehlberg45GeneralizedStepSecondOrderODEIntegrator)
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RKFehlberg45GeneralizedStepSecondOrderODEIntegrator(const RKFehlberg45GeneralizedStepSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RKFehlberg45SecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RKFehlberg45GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                                                        unsigned int velocity_size,
                                                        const GeneralizedPositionStepFunctions & step_funs,
                                                        IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RKFehlberg45SecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
    {
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RKFehlberg45GeneralizedStepSecondOrderODEIntegrator * create_copy() const;
