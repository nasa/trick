...
namespace er7_utils
{
    ...
    class RKFehlberg45SecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKFehlberg45SecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
    ...
    class RKFehlberg45GeneralizedDerivSecondOrderODEIntegrator : public RKFehlberg45SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKFehlberg45GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
    ...
    class RKFehlberg45GeneralizedStepSecondOrderODEIntegrator : public RKFehlberg45SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKFehlberg45GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionStepFunctions& step_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
