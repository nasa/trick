...
namespace er7_utils
{
    ...
    class RKFehlberg45IntegratorConstructor : public IntegratorConstructor
    {
        ...
        public:
             ...
             */
            virtual const char* get_class_name(void) const { return "RKFehlberg45IntegratorConstructor"; }
             ...
             */
            virtual unsigned int get_transition_table_size(void) const { return 6; }
    };
