...
RKFehlberg45FirstOrderODEIntegrator::RKFehlberg45FirstOrderODEIntegrator(unsigned int size,
...
IntegratorResult RKFehlberg45FirstOrderODEIntegrator::integrate(double dt,
    ...
    switch(target_stage)
    {
        ...
        case 1:
            integ_utils::inplace_euler_step_save_both(velocity,
                                                      RKFehlberg45ButcherTableau::RKa[1][0] * dt,
                                                      state_size,
                                                      init_state,
                                                      deriv_hist[0],
                                                      position);
        ...
        case 6:
            integ_utils::weighted_step<6>(init_state,
                                          velocity,
                                          deriv_hist,
