...
rkf45_simple_intermediate_step(double dyn_dt,
                               int state_size[2],
                               ...
                               double * ER7_UTILS_RESTRICT position)
{
    ...
    integ_utils::two_state_weighted_step_save_derivs<target_stage>(init_pos,
                                                                   init_vel,
                                                                   accel,
                                                                   RKFehlberg45ButcherTableau::RKa[target_stage],
                                                                   dyn_dt,
                                                                   state_size[0],
                                                                   posdot_hist,
                                                                   veldot_hist,
...
template<int target_stage>
inline double ER7_UTILS_ALWAYS_INLINE
rkf45_generalized_deriv_intermediate_step(GeneralizedPositionDerivativeFunctions::FirstDerivative deriv_fun,
                                          double dyn_dt,
                                          int state_size[2],
                                          const double * ER7_UTILS_RESTRICT init_pos,
                                          const double * ER7_UTILS_RESTRICT init_vel,
...
template<int target_stage>
inline double ER7_UTILS_ALWAYS_INLINE
rkf45_generalized_step_intermediate_step(GeneralizedPositionStepFunctions::DexpinvTransformVelocity xform_fun,
...
RKFehlberg45SecondOrderODEIntegrator::RKFehlberg45SecondOrderODEIntegrator(unsigned int size,
...
RKFehlberg45GeneralizedStepSecondOrderODEIntegrator * RKFehlberg45GeneralizedStepSecondOrderODEIntegrator::create_copy()
    const
{
    return alloc::replicate_object(*this);
}
...
// position.
IntegratorResult RKFehlberg45SimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                       ...
                                                                       double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 2:
            step_factor = rkf45_simple_intermediate_step<2>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 3:
            step_factor = rkf45_simple_intermediate_step<3>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 4:
            step_factor = rkf45_simple_intermediate_step<4>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 5:
            step_factor = rkf45_simple_intermediate_step<5>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 6:
            integ_utils::two_state_weighted_step<6>(init_pos,
                                                    init_vel,
                                                    accel,
                                                    posdot_hist,
                                                    veldot_hist,
                                                    RKFehlberg45ButcherTableau::RKb5,
                                                    dyn_dt,
                                                    state_size[0],
                                                    position,
                                                    velocity);
                                                                                 ...
                                                                                 double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        // Update state per RKF45 RKa[target_stage] (target_stage elements).
        case 2:
            step_factor = rkf45_generalized_deriv_intermediate_step<2>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 3:
            step_factor = rkf45_generalized_deriv_intermediate_step<3>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 4:
            step_factor = rkf45_generalized_deriv_intermediate_step<4>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 5:
            step_factor = rkf45_generalized_deriv_intermediate_step<5>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
                                                                                ...
                                                                                double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 6:
            ...
            integ_utils::weighted_step<6>(init_vel,
                                          accel,
                                          veldot_hist,
                                          RKFehlberg45ButcherTableau::RKb5,
                                          dyn_dt,
