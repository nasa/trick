...
namespace er7_utils
{
    ...
    PrimingIntegratorConstructor::PrimingIntegratorConstructor(void)
        : Er7UtilsDeletable()
    ...
    PrimingIntegratorConstructor::PrimingIntegratorConstructor(const IntegratorConstructor& primer)
        : Er7UtilsDeletable()
        , IntegratorConstructor()
    ...
    PrimingIntegratorConstructor::PrimingIntegratorConstructor(const PrimingIntegratorConstructor& src)
        : Er7UtilsDeletable()
        , IntegratorConstructor()
    ...
    void PrimingIntegratorConstructor::swap(PrimingIntegratorConstructor& src)
    {
        std::swap(primer_constructor, src.primer_constructor);
    }

    // PrimingIntegratorConstructor destructor.
    PrimingIntegratorConstructor::~PrimingIntegratorConstructor(void) { alloc::delete_object(primer_constructor); }
