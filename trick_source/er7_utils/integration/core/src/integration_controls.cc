...
namespace er7_utils
{
    ...
    IntegrationControls::IntegrationControls(void)
        : Er7UtilsDeletable()
    ...
    IntegrationControls::IntegrationControls(const IntegrationControls& source)
        : Er7UtilsDeletable()
    ...
    IntegrationControls::IntegrationControls(unsigned int number_stages_in)
        : Er7UtilsDeletable()
        , time_scale_factor(0.0)
        , integ_starttime(0.0)
        , integ_simdt(0.0)
    ...
    IntegrationControls::~IntegrationControls(void) { alloc::deallocate_array(transition_table); }
