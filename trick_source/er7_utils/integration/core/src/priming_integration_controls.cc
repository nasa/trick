...
namespace er7_utils
{
    ...
    PrimingIntegrationControls::PrimingIntegrationControls(const IntegratorConstructor& primer_constructor,
        unsigned int history_buffer_size, unsigned int number_operating_stages)
    ...
    // Destructor.
    PrimingIntegrationControls::~PrimingIntegrationControls(void) { alloc::delete_object(priming_controls); }

    // Non-throwing swap.
    void PrimingIntegrationControls::swap(PrimingIntegrationControls& other)
    {
    ...
    PrimingIntegrationControls* PrimingIntegrationControls::create_copy() const
    {
        return alloc::replicate_object(*this);
    }

    // Reset the integration controls.
    void PrimingIntegrationControls::reset_integrator(void)
    {
    ...
    void PrimingIntegrationControls::start_integration_tour(void)
    {
