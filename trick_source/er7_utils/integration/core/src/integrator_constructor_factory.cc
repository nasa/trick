   ...
   case Integration::GaussJackson:
      ...
      break;
        ...
        case Integration::Unspecified:
            MessageHandler::fail(
                __FILE__, __LINE__, IntegrationMessages::invalid_request, "Unspecified integration technique.");
            break;

        case Integration::Unsupported:
            MessageHandler::fail(
                __FILE__, __LINE__, IntegrationMessages::invalid_request, "Unsupported integration technique.");
            break;
