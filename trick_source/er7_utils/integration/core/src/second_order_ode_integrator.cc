...
namespace er7_utils
{
    ...
    SecondOrderODEIntegrator::SecondOrderODEIntegrator(void)
        : Er7UtilsDeletable()
    ...
    SecondOrderODEIntegrator::SecondOrderODEIntegrator(const SecondOrderODEIntegrator& src)
        : Er7UtilsDeletable()
    ...
    SecondOrderODEIntegrator::SecondOrderODEIntegrator(unsigned int size, IntegrationControls&)
        : Er7UtilsDeletable()
        , StateIntegratorInterface()
        , compute_posdot(NULL)
        , compute_posdotdot(NULL)
    ...
    // SecondOrderODEIntegrator non-default constructor.
    SecondOrderODEIntegrator::SecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls&)
        : Er7UtilsDeletable()
        , StateIntegratorInterface()
        ...
        , problem_type(Integration::GeneralizedDerivSecondOrderODE)
    {
        ...
        {
            MessageHandler::fail(__FILE__, __LINE__, IntegrationMessages::invalid_request,
    ...
    // SecondOrderODEIntegrator non-default constructor.
    SecondOrderODEIntegrator::SecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        const GeneralizedPositionStepFunctions& step_funs, IntegrationControls&)
        : Er7UtilsDeletable()
        , StateIntegratorInterface()
        , compute_posdot(NULL)
        , compute_posdotdot(NULL)
        ...
        , problem_type(Integration::GeneralizedStepSecondOrderODE)
    {
        ...
        if ((compute_expmap_position_step == NULL) || (compute_dexpinv_velocity_transform == NULL))
        {
            MessageHandler::fail(__FILE__, __LINE__, IntegrationMessages::invalid_request,
                "The function pointers provided to\n"
                "the SecondOrderODEIntegrator constructor must be non-null.");
    ...
    void SecondOrderODEIntegrator::set_position_derivative_functions(
        const GeneralizedPositionDerivativeFunctions& deriv_funs)
    {
        if ((deriv_funs.first_deriv_fun == NULL) || (deriv_funs.second_deriv_fun == NULL))
        {
            MessageHandler::fail(__FILE__, __LINE__, IntegrationMessages::invalid_request,
    ...
    void SecondOrderODEIntegrator::set_position_step_functions(const GeneralizedPositionStepFunctions& step_funs)
    {
        if ((step_funs.expmap_step_fun == NULL) || (step_funs.dexpinv_xform_fun == NULL))
        {
            MessageHandler::fail(__FILE__, __LINE__, IntegrationMessages::invalid_request,
    ...
    // Swap
    void SecondOrderODEIntegrator::swap(SecondOrderODEIntegrator& other)
    {
        std::swap(compute_posdot, other.compute_posdot);
        std::swap(compute_posdotdot, other.compute_posdotdot);
        std::swap(compute_expmap_position_step, other.compute_expmap_position_step);
        std::swap(compute_dexpinv_velocity_transform, other.compute_dexpinv_velocity_transform);
