...
namespace er7_utils
{
    ...
    // Default constructor.
    PrimingFirstOrderODEIntegrator::PrimingFirstOrderODEIntegrator(void)
        : Er7UtilsDeletable()
    ...
    // Copy constructor.
    PrimingFirstOrderODEIntegrator::PrimingFirstOrderODEIntegrator(const PrimingFirstOrderODEIntegrator& src)
        : Er7UtilsDeletable()
    ...
    PrimingFirstOrderODEIntegrator::PrimingFirstOrderODEIntegrator(unsigned int priming_size,
        ...
        , primed(false)
    {
        ...
        primer = primer_constructor.create_first_order_ode_integrator(size, controls_in);
    }
    ...
    // Non-throwing swap.
    void PrimingFirstOrderODEIntegrator::swap(PrimingFirstOrderODEIntegrator& other)
    {
    ...
    void PrimingFirstOrderODEIntegrator::set_controls(IntegrationControls& controls_in)
    {
        controls = &controls_in;
    ...
    // Integrate state
    IntegratorResult PrimingFirstOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
