 ...
 */
static inline void ER7_UTILS_ALWAYS_INLINE truncate_vector(const double * ER7_UTILS_RESTRICT in,
 ...
 * @param[out] out    Scaled vector
 */
static inline void ER7_UTILS_ALWAYS_INLINE scale_vector(const double * ER7_UTILS_RESTRICT in,
                                                        const double scale,
                                                        double * ER7_UTILS_RESTRICT out)
{
    out[0] = scale * in[0];
 ...
 * @param[out] out    Scaled vector
 */
static inline void ER7_UTILS_ALWAYS_INLINE scale_and_truncate_vector(const double * ER7_UTILS_RESTRICT in,
                                                                     const double scale,
                                                                     double * ER7_UTILS_RESTRICT out)
{
...
void LeftQuaternionGeneralizedPositionStepFunctions::expmap(const double quat_init[4],
                                                            ...
                                                            double quat_end[4])
{
    ...
    if(h_dtheta_sq < 0.001685)
    {
        ...
        double omcos_hwdt = 0.5 * h_dtheta_sq * (1.0 - ONE_OVER_12 * h_dtheta_sq * (1.0 - ONE_OVER_30 * h_dtheta_sq));
        // Approximate sin(0.5*dtheta)
        double sin_hwdt = h_dtheta_mag *
                          (1.0 - ONE_OVER_6 * h_dtheta_sq *
                                     (1.0 - ONE_OVER_20 * h_dtheta_sq * (1.0 - ONE_OVER_42 * h_dtheta_sq)));
...
void LeftQuaternionGeneralizedPositionStepFunctions::dexpinv(const double angular_vel_in[3],
                                                             const double dtheta[3],
