      ...
      primed(false)
{
    ...
    primer = primer_constructor.create_generalized_deriv_second_order_ode_integrator(position_size,
                                                                                     velocity_size,
                                                                                     deriv_funs,
                                                                                     controls_in);
}
...
{
    // Create the integrator used to prime the state.
    primer = primer_constructor.create_generalized_step_second_order_ode_integrator(position_size,
                                                                                    velocity_size,
                                                                                    step_funs,
                                                                                    controls_in);
}
...
// Integrate state
IntegratorResult PrimingSecondOrderODEIntegrator::integrate(double dyn_dt,
