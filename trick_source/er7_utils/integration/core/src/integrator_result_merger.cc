...
bool IntegratorResultMerger::merge_integrator_result(const IntegratorResult & new_result,
...
IntegratorResultMerger * IntegratorResultMerger::create_copy() const
{
...
IntegratorResultMerger * BogusIntegratorResultMerger::create_copy() const
{
    return alloc::replicate_object(*this);
}
