...
namespace er7_utils
{
    ...
    class IntegratorResult
    {
        ...
        public:
             ...
             */
            IntegratorResult(bool is_integrated = true) ER7_UTILS_ALWAYS_INLINE : time_scale(1.0),
                                                                                  failure_mode(0),
             ...
             */
            IntegratorResult(double step_factor) ER7_UTILS_ALWAYS_INLINE : time_scale(step_factor),
                                                                           failure_mode(0),
                                                                           merge_count(1)
            {
            }
             ...
             */
            double get_time_scale() const ER7_UTILS_ALWAYS_INLINE { return time_scale; }

            /**
             * Determine whether the integration attained the target stage.
             */
            bool get_passed() const ER7_UTILS_ALWAYS_INLINE { return failure_mode == 0; }

            /**
             * Get the IntegratorResult's failure_mode data member.
             */
            int get_failure_mode() const ER7_UTILS_ALWAYS_INLINE { return failure_mode; }

            /**
             * Get the IntegratorResult's merge_count data member.
             */
            int get_merge_count() const ER7_UTILS_ALWAYS_INLINE { return merge_count; }

            /**
             * Set the IntegratorResult's time_scale to the specified value.
             */
            void set_time_scale(double value) ER7_UTILS_ALWAYS_INLINE { time_scale = value; }

            /**
             * Denote that the integration has attained the target stage.
             */
            void set_passed() ER7_UTILS_ALWAYS_INLINE { failure_mode = 0; }

            /**
             * Denote that the integration has failed to attain the target stage.
             */
            void set_failed() ER7_UTILS_ALWAYS_INLINE { failure_mode = 1; }

            /**
             * Set the IntegratorResult's failure_mode to the specified value.
             */
            void set_failure_mode(int value) ER7_UTILS_ALWAYS_INLINE { failure_mode = value; }
             ...
             */
            void mark_as_integrated() ER7_UTILS_ALWAYS_INLINE { merge_count = 1; }
             ...
             */
            void mark_as_not_integrated() ER7_UTILS_ALWAYS_INLINE { merge_count = 0; }

            /**
             * Increment the IntegratorResult's merge_count by the specified value.
             */
            void increment_merge_count(int value = 1) ER7_UTILS_ALWAYS_INLINE { merge_count += value; }
