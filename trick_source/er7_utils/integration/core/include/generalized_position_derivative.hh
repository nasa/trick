...
namespace er7_utils
{
    ...
    class GeneralizedPositionDerivativeFunctions
    {
        public:
             ...
             */
            typedef void (*FirstDerivative)(const double* ER7_UTILS_RESTRICT position,
                const double* ER7_UTILS_RESTRICT velocity, double* ER7_UTILS_RESTRICT position_derivative);
             ...
             */
            typedef void (*SecondDerivative)(const double* ER7_UTILS_RESTRICT position,
                const double* ER7_UTILS_RESTRICT velocity, const double* ER7_UTILS_RESTRICT acceleration,
             ...
             */
            GeneralizedPositionDerivativeFunctions(
                FirstDerivative first_deriv_fun_in, SecondDerivative second_deriv_fun_in)
    ...
    class GeneralizedPositionStepFunctions
    {
        public:
             ...
             */
            typedef void (*ExpMapPositionStep)(const double* position, const double* dtheta, double* updated_position);
            ...
            typedef void (*DexpinvTransformVelocity)(
                const double* subject_velocity, const double* dtheta, double* xform_velocity);
             ...
             */
            GeneralizedPositionStepFunctions(
                ExpMapPositionStep expmap_step_fun_in, DexpinvTransformVelocity dexpinv_xform_fun_in)
