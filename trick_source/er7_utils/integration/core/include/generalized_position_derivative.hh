...
public:
     ...
     */
    GeneralizedPositionDerivativeFunctions(FirstDerivative first_deriv_fun_in, SecondDerivative second_deriv_fun_in)
...
public:
     ...
     */
    typedef void (*DexpinvTransformVelocity)(const double * subject_velocity,
                                             const double * dtheta,
     ...
     */
    GeneralizedPositionStepFunctions(ExpMapPositionStep expmap_step_fun_in,
