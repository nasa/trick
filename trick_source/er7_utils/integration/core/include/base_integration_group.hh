...
namespace er7_utils
{
    ...
    class BaseIntegrationGroup
    {
        ...
        public:
             ...
             */
            bool get_first_step_derivs_flag() { return integ_interface->get_first_step_derivs_flag(); }
             ...
             */
            int integrate_group(double sim_begtime, double sim_deltime) ER7_UTILS_ALWAYS_INLINE
            {
                return integ_controls->integrate(sim_begtime, sim_deltime, *time_interface, *integ_interface, *this);
            }
             ...
             * @return            Integrator step number, zero = done
             */
            int integrate_group_from(double sim_begtime) ER7_UTILS_ALWAYS_INLINE
            {
             ...
             * @return            Integrator step number, zero = done
             */
            int integrate_group_to(double sim_endtime) ER7_UTILS_ALWAYS_INLINE
            {
             ...
             */
            virtual void update_integration_interface(unsigned int step_number)
            {
             ...
             */
            virtual IntegratorResult integrate_bodies(double cycle_dyndt, unsigned int target_stage) = 0;
        ...
        protected:
             ...
             */
            BaseIntegrationGroup(
                IntegratorConstructor& integ_cotr, IntegratorInterface& integ_inter, TimeInterface& time_if);

            /**
             * BaseIntegrationGroup copy constructor.
             * @param[in] source       Object to be copied
             */
            BaseIntegrationGroup(const BaseIntegrationGroup& source);
             ...
             * @param[in] time_if      Time interface
             */
            void set_interfaces(IntegratorInterface& integ_inter, TimeInterface& time_if)
            {
