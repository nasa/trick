...
namespace er7_utils
{
     ...
     */
    class LeftQuaternionGeneralizedPositionDerivativeFunctions : public GeneralizedPositionDerivativeFunctions
    {
        public:
            /**
             ...
             */
            static void derivative(const double* ER7_UTILS_RESTRICT quaternion,
                const double* ER7_UTILS_RESTRICT angular_vel, double* ER7_UTILS_RESTRICT quaternion_deriv);
             ...
             */
            static void second_derivative(const double* ER7_UTILS_RESTRICT quaternion,
                const double* ER7_UTILS_RESTRICT angular_vel, const double* ER7_UTILS_RESTRICT angular_acc,
     ...
     *    in body frame coordinates.
     */
    class LeftQuaternionGeneralizedPositionStepFunctions : public GeneralizedPositionStepFunctions
    {
        public:
            /**
             ...
             */
            static void expmap(const double* quaternion_init, const double* dtheta, double* quaternion_end);
             ...
             */
            static void dexpinv(const double* angular_vel_in, const double* dtheta, double* angular_vel_out);
    };
     ...
     */
    class LeftQuaternionGeneralizedPositionFunctions : public LeftQuaternionGeneralizedPositionDerivativeFunctions,
