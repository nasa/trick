 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE rotate_history(double * ER7_UTILS_RESTRICT posdot_hist[hist_len],
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE predictor_step(const double * ER7_UTILS_RESTRICT velocity,
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE predictor_weighted_sum(const double * ER7_UTILS_RESTRICT position,
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE predictor_step(const double * ER7_UTILS_RESTRICT accel,
                                                   const double * ER7_UTILS_RESTRICT weights,
                                                   double wscale,
                                                   double deltat,
                                                   int state_size,
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE predictor_step(const double * ER7_UTILS_RESTRICT posdot,
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE predictor_step(const double * ER7_UTILS_RESTRICT position,
                                                   ...
                                                   double * ER7_UTILS_RESTRICT velocity)
{
    ...
    predictor_weighted_sum<hist_len>(position,
                                     posdot,
                                     weights,
                                     wscaled_dt,
                                     state_size[0],
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE corrector_step(const double * ER7_UTILS_RESTRICT init_pos,
                                                   const double * ER7_UTILS_RESTRICT velocity,
                                                   const double * ER7_UTILS_RESTRICT const deriv_hist[hist_len],
                                                   const double * ER7_UTILS_RESTRICT weights,
                                                   double wscaled_dt,
                                                   int size,
                                                   double * ER7_UTILS_RESTRICT position)
{
    ...
    const double * ER7_UTILS_RESTRICT hist_weights = weights + 1;
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE corrector_weighted_sum(const double * ER7_UTILS_RESTRICT velocity,
                                                           const double * ER7_UTILS_RESTRICT const deriv_hist[hist_len],
                                                           const double * ER7_UTILS_RESTRICT weights,
                                                           double wscaled_dt,
                                                           int size,
...
inline void ER7_UTILS_ALWAYS_INLINE corrector_step(const double * ER7_UTILS_RESTRICT init_pos,
                                                   ...
                                                   const double * ER7_UTILS_RESTRICT const posdot_hist[hist_len],
                                                   const double * ER7_UTILS_RESTRICT const veldot_hist[hist_len],
                                                   const double * ER7_UTILS_RESTRICT weights,
                                                   double wscale,
                                                   double deltat,
                                                   int state_size,
 ...
 */
template<int hist_len>
inline void ER7_UTILS_ALWAYS_INLINE corrector_step(const double * ER7_UTILS_RESTRICT init_vel,
                                                   const double * ER7_UTILS_RESTRICT posdot,
                                                   const double * ER7_UTILS_RESTRICT veldot,
                                                   const double * ER7_UTILS_RESTRICT const posdot_hist[hist_len],
                                                   const double * ER7_UTILS_RESTRICT const veldot_hist[hist_len],
