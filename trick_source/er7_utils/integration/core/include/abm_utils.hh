...
namespace er7_utils
{
    ...
    namespace abm
    {
        ...
        inline void ER7_UTILS_ALWAYS_INLINE rotate_history(double* ER7_UTILS_RESTRICT deriv_hist[hist_len])
        {
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE rotate_history(
            double* ER7_UTILS_RESTRICT posdot_hist[hist_len], double* ER7_UTILS_RESTRICT veldot_hist[hist_len])
        {
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE predictor_step(double const* ER7_UTILS_RESTRICT velocity,
            double const* ER7_UTILS_RESTRICT weights, double wscaled_dt, int size,
            double* ER7_UTILS_RESTRICT deriv_hist[hist_len], double* ER7_UTILS_RESTRICT init_pos,
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE predictor_weighted_sum(double const* ER7_UTILS_RESTRICT position,
            double const* ER7_UTILS_RESTRICT velocity, double const* ER7_UTILS_RESTRICT weights, double wscaled_dt,
            int size, double* ER7_UTILS_RESTRICT deriv_hist[hist_len], double* ER7_UTILS_RESTRICT init_pos,
        ...
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE predictor_step(double const* ER7_UTILS_RESTRICT velocity,
            double const* ER7_UTILS_RESTRICT weights, double wscale, double deltat, int size,
            double* ER7_UTILS_RESTRICT deriv_hist[hist_len], double* ER7_UTILS_RESTRICT init_pos,
            double* ER7_UTILS_RESTRICT position)
        {
            predictor_step<hist_len>(velocity, weights, wscale * deltat, size, deriv_hist, init_pos, position);
        }
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE predictor_step(double const* ER7_UTILS_RESTRICT accel,
            double const* ER7_UTILS_RESTRICT weights, double wscale, double deltat, int state_size,
            double* ER7_UTILS_RESTRICT posdot_hist[hist_len], double* ER7_UTILS_RESTRICT veldot_hist[hist_len],
            double* ER7_UTILS_RESTRICT init_pos, double* ER7_UTILS_RESTRICT init_vel,
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE predictor_step(double const* ER7_UTILS_RESTRICT posdot,
            double const* ER7_UTILS_RESTRICT veldot, double const* ER7_UTILS_RESTRICT weights, double wscale,
            double deltat, int state_size[2], double* ER7_UTILS_RESTRICT posdot_hist[hist_len],
            double* ER7_UTILS_RESTRICT veldot_hist[hist_len], double* ER7_UTILS_RESTRICT init_pos,
            double* ER7_UTILS_RESTRICT init_vel, double* ER7_UTILS_RESTRICT position,
            double* ER7_UTILS_RESTRICT velocity)
        {
            double wscaled_dt = wscale * deltat;

            predictor_step<hist_len>(posdot, weights, wscaled_dt, state_size[0], posdot_hist, init_pos, position);

            predictor_step<hist_len>(veldot, weights, wscaled_dt, state_size[1], veldot_hist, init_vel, velocity);
        }
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE predictor_step(double const* ER7_UTILS_RESTRICT position,
            double const* ER7_UTILS_RESTRICT posdot, double const* ER7_UTILS_RESTRICT veldot,
            double const* ER7_UTILS_RESTRICT weights, double wscale, double deltat, int state_size[2],
            double* ER7_UTILS_RESTRICT posdot_hist[hist_len], double* ER7_UTILS_RESTRICT veldot_hist[hist_len],
            double* ER7_UTILS_RESTRICT init_pos, double* ER7_UTILS_RESTRICT init_vel,
            double* ER7_UTILS_RESTRICT delta_pos, double* ER7_UTILS_RESTRICT velocity)
        {
            double wscaled_dt = wscale * deltat;

            predictor_weighted_sum<hist_len>(
                position, posdot, weights, wscaled_dt, state_size[0], posdot_hist, init_pos, delta_pos);
      ...
      double * ER7_UTILS_RESTRICT velocity)
   {
      ...
      for (int ii = 0; ii < state_size; ++ii) {
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE corrector_step(double const* ER7_UTILS_RESTRICT init_pos,
            double const* ER7_UTILS_RESTRICT velocity, double const* ER7_UTILS_RESTRICT const deriv_hist[hist_len],
            double const* ER7_UTILS_RESTRICT weights, double wscaled_dt, int size, double* ER7_UTILS_RESTRICT position)
        {
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE corrector_weighted_sum(double const* ER7_UTILS_RESTRICT velocity,
            double const* ER7_UTILS_RESTRICT const deriv_hist[hist_len], double const* ER7_UTILS_RESTRICT weights,
            double wscaled_dt, int size, double* ER7_UTILS_RESTRICT delta_pos)
        {
            double der_weight                             = weights[0];
            double const* ER7_UTILS_RESTRICT hist_weights = weights + 1;
        ...
        inline void ER7_UTILS_ALWAYS_INLINE corrector_step(double const* ER7_UTILS_RESTRICT init_pos,
            ...
            double* ER7_UTILS_RESTRICT position)
        {
            corrector_step<hist_len>(init_pos, velocity, deriv_hist, weights, wscale * deltat, size, position);
        }
        ...
        inline void ER7_UTILS_ALWAYS_INLINE corrector_step(double const* ER7_UTILS_RESTRICT init_pos,
            ...
            double const* ER7_UTILS_RESTRICT const veldot_hist[hist_len], double const* ER7_UTILS_RESTRICT weights,
            double wscale, double deltat, int state_size, double* ER7_UTILS_RESTRICT position,
            double* ER7_UTILS_RESTRICT velocity)
        {
            double wscaled_dt                             = wscale * deltat;
            double der_weight                             = weights[0];
        ...
        inline void ER7_UTILS_ALWAYS_INLINE corrector_step(double const* ER7_UTILS_RESTRICT init_pos,
            ...
            double const* ER7_UTILS_RESTRICT veldot, double const* ER7_UTILS_RESTRICT const posdot_hist[hist_len],
            double const* ER7_UTILS_RESTRICT const veldot_hist[hist_len], double const* ER7_UTILS_RESTRICT weights,
            double wscale, double deltat, int state_size[2], double* ER7_UTILS_RESTRICT position,
            double* ER7_UTILS_RESTRICT velocity)
        {
            double wscaled_dt = wscale * deltat;

            corrector_step<hist_len>(init_pos, posdot, posdot_hist, weights, wscaled_dt, state_size[0], position);

            corrector_step<hist_len>(init_vel, veldot, veldot_hist, weights, wscaled_dt, state_size[1], velocity);
        }
         ...
         */
        template <int hist_len>
        inline void ER7_UTILS_ALWAYS_INLINE corrector_step(double const* ER7_UTILS_RESTRICT init_vel,
            double const* ER7_UTILS_RESTRICT posdot, double const* ER7_UTILS_RESTRICT veldot,
            double const* ER7_UTILS_RESTRICT const posdot_hist[hist_len],
            double const* ER7_UTILS_RESTRICT const veldot_hist[hist_len], double const* ER7_UTILS_RESTRICT weights,
            double wscale, double deltat, int state_size[2], double* ER7_UTILS_RESTRICT delta_pos,
            double* ER7_UTILS_RESTRICT velocity)
        {
            double wscaled_dt = wscale * deltat;

            corrector_weighted_sum<hist_len>(posdot, posdot_hist, weights, wscaled_dt, state_size[0], delta_pos);
