...
namespace er7_utils
{
    ...
    class PrimingSecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            PrimingSecondOrderODEIntegrator(const PrimingSecondOrderODEIntegrator&);
             ...
             * @param[in,out] controls_in         Integration controls
             */
            PrimingSecondOrderODEIntegrator(unsigned int priming_size, const IntegratorConstructor& primer_constructor,
                unsigned int size, IntegrationControls& controls_in);
             ...
             */
            virtual void technique_save_derivatives(int countdown, const double* ER7_UTILS_RESTRICT accel,
                const double* ER7_UTILS_RESTRICT velocity, const double* ER7_UTILS_RESTRICT position) = 0;
        ...
        private:
             ...
             * Not implemented.
             */
            PrimingSecondOrderODEIntegrator& operator=(const PrimingSecondOrderODEIntegrator&);
    };
