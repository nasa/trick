...
public:
     ...
     */
    virtual void set_position_derivative_functions(const GeneralizedPositionDerivativeFunctions & deriv_funs);
     ...
     */
    virtual void set_position_step_functions(const GeneralizedPositionStepFunctions & step_funs);
...
protected:
     ...
     * @param[in,out] controls  Integration controls (unused)
     */
    SecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     * @param[in,out] controls       Integration controls (unused)
     */
    SecondOrderODEIntegrator(unsigned int position_size,
    ...
    GeneralizedPositionDerivativeFunctions::FirstDerivative compute_posdot; /**< trick_io(**) @n
                                                               External function that computes the time derivative of
                                                               generalized position. */

    GeneralizedPositionDerivativeFunctions::SecondDerivative compute_posdotdot; /**< trick_io(**) @n
                                                                External function that computes the second time
                                                                derivative of generalized position. */

    GeneralizedPositionStepFunctions::ExpMapPositionStep compute_expmap_position_step; /**< trick_io(**) @n
                                                            External function that advances generalized position. */

    GeneralizedPositionStepFunctions::DexpinvTransformVelocity compute_dexpinv_velocity_transform; /**< trick_io(**) @n
                                                                  External function that transforms velocity per the Lie
                                                                  algebra dexpinv operator. */
