...
namespace er7_utils
{
    ...
    class IntegrationControls : virtual public Er7UtilsDeletable
    {
        ...
        public:
             ...
             */
            double ER7_UTILS_ALWAYS_INLINE get_simtime(void) const { return integ_simtime; }

            /**
             * Get the final_stage data member.
             * @return final_stage value.
             */
            unsigned int ER7_UTILS_ALWAYS_INLINE get_final_stage(void) const { return final_stage; }

            /**
             * Get the step_number data member.
             * @return step_number value.
             */
            unsigned int ER7_UTILS_ALWAYS_INLINE get_step_number(void) const { return step_number; }

            /**
             * Determine whether the controller is in the initial cycle of a loop.
             * @return True if first cycle of a loop, false otherwise.
             */
            bool ER7_UTILS_ALWAYS_INLINE in_initial_cycle(void) const { return step_number == 0; }

            /**
             * Determine the expected step number, assuming integration succeeds.
             * @return Expected step number.
             */
            unsigned int ER7_UTILS_ALWAYS_INLINE get_expected_step_number(void) const
            {
             ...
             */
            bool ER7_UTILS_ALWAYS_INLINE get_reset_needed(bool value ER7_UTILS_UNUSED) const { return reset_needed; }

            /**
             * Set the reset_needed flag.
             */
            void ER7_UTILS_ALWAYS_INLINE set_reset_needed() { reset_needed = true; }
             ...
             */
            unsigned int get_transition_table_element(unsigned int index) const { return transition_table[index]; }
             ...
             */
            void set_transition_table_element(unsigned int index, unsigned int value)
            {
             ...
             */
            virtual unsigned int integrate(double start_time, double sim_dt, TimeInterface& time_interface,
                IntegratorInterface& integ_interface, BaseIntegrationGroup& integ_group) = 0;
