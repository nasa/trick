...
public:
     ...
     */
    double ER7_UTILS_ALWAYS_INLINE get_simtime(void) const
    {
     ...
     */
    unsigned int ER7_UTILS_ALWAYS_INLINE get_final_stage(void) const
    {
        return final_stage;
    }
     ...
     */
    unsigned int ER7_UTILS_ALWAYS_INLINE get_step_number(void) const
    {
        return step_number;
    }
     ...
     */
    bool ER7_UTILS_ALWAYS_INLINE in_initial_cycle(void) const
    {
     ...
     */
    bool ER7_UTILS_ALWAYS_INLINE get_reset_needed(bool value ER7_UTILS_UNUSED) const
    {
        return reset_needed;
    }
     ...
     */
    void ER7_UTILS_ALWAYS_INLINE set_reset_needed()
    {
        reset_needed = true;
    }
     ...
     */
    unsigned int get_transition_table_element(unsigned int index) const
    {
