...
public:
     ...
     */
    virtual bool merge_integrator_result(const IntegratorResult & new_result, IntegratorResult & merged_result) const;
...
public:
     ...
     * Croak.
     */
    virtual bool merge_integrator_result(const IntegratorResult &, IntegratorResult &) const;
