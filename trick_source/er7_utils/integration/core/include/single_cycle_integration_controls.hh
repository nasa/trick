    ...
    */
    class SingleCycleIntegrationControls : public IntegrationControls
    {
        ...
        public:
             ...
             */
            SingleCycleIntegrationControls& operator=(SingleCycleIntegrationControls src)
            {
                swap(src);
                return *this;
            }
             ...
             */
            virtual unsigned int integrate(double start_time, double sim_dt, TimeInterface& time_if,
