...
namespace er7_utils
{
    ...
    class IntegrableObject
    {
        ...
        public:
             ...
             */
            virtual void create_integrators(const IntegratorConstructor& generator, IntegrationControls& controls,
             ...
             */
            virtual IntegratorResult integrate(double dyn_dt, unsigned int target_stage) = 0;

            /**
             * Setter for the integration group.
             * @param[in] integ_group_in New integration group
             */
            void set_integration_group(BaseIntegrationGroup& integ_group_in)
            {
                if (integ_group != NULL)
                {
                    destroy_integrators();
             ...
             */
            BaseIntegrationGroup* get_integration_group(void) { return integ_group; }
        ...
        protected:
             ...
             */
            IntegrableObject(const IntegrableObject&)
                : integ_group(NULL)
            {
            }
