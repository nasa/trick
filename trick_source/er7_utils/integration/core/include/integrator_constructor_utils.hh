...
namespace er7_utils
{
    ...
    namespace integ_utils
    {
        ...
        inline T* allocate_controls(
            const IntegratorConstructor& primer_constructor, unsigned int history_length, unsigned int nstages)
        {
            return alloc::allocate_object<T, const IntegratorConstructor&, unsigned int, unsigned int>(
         ...
         */
        template <typename T>
        inline T* allocate_integrator(unsigned int position_size, unsigned int velocity_size,
            const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls& controls)
        {
            return alloc::allocate_object<T, unsigned int, unsigned int, const GeneralizedPositionDerivativeFunctions&,
         ...
         */
        template <typename T>
        inline T* allocate_integrator(const IntegratorConstructor& primer_constructor, unsigned int position_size,
            unsigned int velocity_size, const GeneralizedPositionDerivativeFunctions& deriv_funs,
            IntegrationControls& controls)
        {
            return alloc::allocate_object<T, const IntegratorConstructor&, unsigned int, unsigned int,
                const GeneralizedPositionDerivativeFunctions&, IntegrationControls&>(
        ...
        {
            return alloc::allocate_object<T, unsigned int, unsigned int, const GeneralizedPositionStepFunctions&,
                IntegrationControls&>(position_size, velocity_size, step_funs, controls);
        }
        ...
        {
            return alloc::allocate_object<T, const IntegratorConstructor&, unsigned int, unsigned int,
                const GeneralizedPositionStepFunctions&, IntegrationControls&>(
                primer_constructor, position_size, velocity_size, step_funs, controls);
        }
