 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE rk_initial_step(const double * ER7_UTILS_RESTRICT deriv,
                                                    double deltat,
                                                    int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE rk_two_state_initial_step(const double * ER7_UTILS_RESTRICT posdot,
 ...
 * @param[in,out] velocity     Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE rk_two_state_initial_step(const double * ER7_UTILS_RESTRICT accel,
                                                              double deltat,
                                                              int size,
                                                              double * ER7_UTILS_RESTRICT init_pos,
                                                              double * ER7_UTILS_RESTRICT init_vel,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE rk_intermediate_step(const double * ER7_UTILS_RESTRICT init_state,
                                                         const double * ER7_UTILS_RESTRICT curr_deriv,
                                                         double deltat,
                                                         int size,
 ...
 * @param[in,out] velocity      Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE rk_two_state_intermediate_step(const double * ER7_UTILS_RESTRICT init_pos,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE rk2_heun_final_step(const double * ER7_UTILS_RESTRICT init_state,
                                                        const double * ER7_UTILS_RESTRICT deriv1,
                                                        const double * ER7_UTILS_RESTRICT deriv2,
                                                        double deltat,
                                                        int size,
                                                        double * ER7_UTILS_RESTRICT state)
{
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE
rk4_final_step(const double * ER7_UTILS_RESTRICT init_state,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE
rk4_two_state_final_step(const double * ER7_UTILS_RESTRICT init_pos,
                         const double * ER7_UTILS_RESTRICT init_vel,
                         const double * ER7_UTILS_RESTRICT const * ER7_UTILS_RESTRICT saved_vel,
                         const double * ER7_UTILS_RESTRICT const * ER7_UTILS_RESTRICT saved_acc,
                         const double * ER7_UTILS_RESTRICT posdot,
                         const double * ER7_UTILS_RESTRICT veldot,
                         double deltat,
                         int size[2],
