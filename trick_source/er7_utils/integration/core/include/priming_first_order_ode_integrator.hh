...
namespace er7_utils
{
    ...
    class PrimingFirstOrderODEIntegrator : public FirstOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            PrimingFirstOrderODEIntegrator(const PrimingFirstOrderODEIntegrator&);
             ...
             * @param[in,out] controls_in         Integration controls
             */
            PrimingFirstOrderODEIntegrator(unsigned int priming_size, const IntegratorConstructor& primer_constructor,
             ...
             */
            virtual void technique_save_derivatives(int countdown, const double* ER7_UTILS_RESTRICT velocity,
            ...
            virtual IntegratorResult technique_integrate(double dyn_dt, unsigned int target_stage,
                const double* ER7_UTILS_RESTRICT velocity, double* ER7_UTILS_RESTRICT position) = 0;
        ...
        private:
             ...
             * Not implemented.
             */
            PrimingFirstOrderODEIntegrator& operator=(const PrimingFirstOrderODEIntegrator&);
    };
