 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE copy_array(const double * ER7_UTILS_RESTRICT src,
                                               int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE two_state_copy_array(const double * ER7_UTILS_RESTRICT source_0,
                                                         const double * ER7_UTILS_RESTRICT source_1,
                                                         int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE scale_array(const double * ER7_UTILS_RESTRICT src,
                                                double scale,
                                                int size,
                                                double * ER7_UTILS_RESTRICT dest)
{
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_euler_step(const double * ER7_UTILS_RESTRICT deriv,
                                                       double deltat,
                                                       int size,
 ...
 * @param[in,out] state       State vector, updated in place
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_euler_step_save_state(const double * ER7_UTILS_RESTRICT deriv,
                                                                  double deltat,
                                                                  int size,
 ...
 * @param[in,out] state       State vector, updated in place
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_euler_step_save_deriv(const double * ER7_UTILS_RESTRICT deriv,
                                                                  double deltat,
                                                                  int size,
 ...
 * @param[in,out] state       State vector, updated in place
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_euler_step_save_both(const double * ER7_UTILS_RESTRICT deriv,
                                                                 double deltat,
                                                                 int size,
                                                                 double * ER7_UTILS_RESTRICT init_state,
                                                                 double * ER7_UTILS_RESTRICT init_deriv,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE euler_step(const double * ER7_UTILS_RESTRICT old_state,
 ...
 * @param[out] new_state    Updated state vector
 */
inline void ER7_UTILS_ALWAYS_INLINE euler_step_save_deriv(const double * ER7_UTILS_RESTRICT old_state,
                                                          const double * ER7_UTILS_RESTRICT deriv,
                                                          double deltat,
                                                          int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE euler_step_save_both(const double * ER7_UTILS_RESTRICT old_state,
                                                         const double * ER7_UTILS_RESTRICT deriv,
                                                         double deltat,
                                                         int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_two_state_euler_step(const double * ER7_UTILS_RESTRICT posdot,
                                                                 const double * ER7_UTILS_RESTRICT veldot,
                                                                 double deltat,
                                                                 int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_two_state_euler_step_save_all(const double * ER7_UTILS_RESTRICT accel,
                                                                          double deltat,
                                                                          int size,
 ...
 * @param[in,out] velocity     Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_two_state_euler_step_save_all(const double * ER7_UTILS_RESTRICT posdot,
                                                                          const double * ER7_UTILS_RESTRICT veldot,
                                                                          double deltat,
                                                                          int size[2],
                                                                          double * ER7_UTILS_RESTRICT init_pos,
...
inplace_two_state_euler_step_save_pos_vel_acc(const double * ER7_UTILS_RESTRICT accel,
                                              double deltat,
                                              int size,
                                              double * ER7_UTILS_RESTRICT init_pos,
                                              double * ER7_UTILS_RESTRICT init_vel,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE
inplace_two_state_euler_step_save_pos_vel_acc(const double * ER7_UTILS_RESTRICT posdot,
                                              const double * ER7_UTILS_RESTRICT veldot,
                                              double deltat,
                                              int size[2],
                                              double * ER7_UTILS_RESTRICT init_pos,
 ...
 * @param[in,out] velocity     Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_two_state_euler_step_save_pos_vel(const double * ER7_UTILS_RESTRICT accel,
                                                                              double deltat,
                                                                              int size,
                                                                              double * ER7_UTILS_RESTRICT init_pos,
                                                                              double * ER7_UTILS_RESTRICT init_vel,
 ...
 * @param[in,out] velocity     Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE inplace_two_state_euler_step_save_pos_vel(const double * ER7_UTILS_RESTRICT posdot,
                                                                              const double * ER7_UTILS_RESTRICT veldot,
                                                                              double deltat,
                                                                              int size[2],
                                                                              double * ER7_UTILS_RESTRICT init_pos,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE two_state_euler_step(const double * ER7_UTILS_RESTRICT init_pos,
...
inline void ER7_UTILS_ALWAYS_INLINE two_state_euler_step(const double * ER7_UTILS_RESTRICT init_pos,
                                                         const double * ER7_UTILS_RESTRICT init_vel,
                                                         const double * ER7_UTILS_RESTRICT posdot,
                                                         const double * ER7_UTILS_RESTRICT veldot,
                                                         double deltat,
                                                         int size[2],
                                                         double * ER7_UTILS_RESTRICT position,
...
inline void ER7_UTILS_ALWAYS_INLINE
weighted_sum(const double * ER7_UTILS_RESTRICT const * ER7_UTILS_RESTRICT deriv_hist,
             const double * ER7_UTILS_RESTRICT weights,
             double deltat,
             int size,
...
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE
weighted_sum(const double * ER7_UTILS_RESTRICT deriv,
...
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE
weighted_sum_save_newest(const double * ER7_UTILS_RESTRICT deriv,
                         const double * ER7_UTILS_RESTRICT weights,
                         double deltat,
                         int size,
...
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE
weighted_step(const double * ER7_UTILS_RESTRICT init_state,
              const double * ER7_UTILS_RESTRICT deriv,
              const double * ER7_UTILS_RESTRICT const * ER7_UTILS_RESTRICT deriv_hist,
              const double * ER7_UTILS_RESTRICT weights,
              double deltat,
...
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE
weighted_step_save_deriv(const double * ER7_UTILS_RESTRICT init_state,
                         const double * ER7_UTILS_RESTRICT deriv,
                         const double * ER7_UTILS_RESTRICT weights,
                         double deltat,
                         int size,
 ...
 */
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE weighted_step_save_both(const double * ER7_UTILS_RESTRICT init_state,
                                                            const double * ER7_UTILS_RESTRICT deriv,
                                                            const double * ER7_UTILS_RESTRICT weights,
                                                            double deltat,
                                                            int size,
...
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE
two_state_weighted_step(const double * ER7_UTILS_RESTRICT init_pos,
                        const double * ER7_UTILS_RESTRICT init_vel,
                        const double * ER7_UTILS_RESTRICT posdot,
                        const double * ER7_UTILS_RESTRICT veldot,
                        const double * ER7_UTILS_RESTRICT const * ER7_UTILS_RESTRICT posdot_hist,
                        const double * ER7_UTILS_RESTRICT const * ER7_UTILS_RESTRICT veldot_hist,
                        const double * ER7_UTILS_RESTRICT weights,
                        double deltat,
                        int size[2],
                        double * ER7_UTILS_RESTRICT position,
...
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE
two_state_weighted_step_save_veldot(const double * ER7_UTILS_RESTRICT init_pos,
                                    const double * ER7_UTILS_RESTRICT init_vel,
                                    const double * ER7_UTILS_RESTRICT veldot,
                                    const double * ER7_UTILS_RESTRICT weights,
                                    double deltat,
...
template<int nweights>
inline void ER7_UTILS_ALWAYS_INLINE
two_state_weighted_step_save_derivs(const double * ER7_UTILS_RESTRICT init_pos,
                                    const double * ER7_UTILS_RESTRICT init_vel,
                                    const double * ER7_UTILS_RESTRICT accel,
                                    const double * ER7_UTILS_RESTRICT weights,
                                    double deltat,
