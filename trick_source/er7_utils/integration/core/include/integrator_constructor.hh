...
public:
     ...
     *
     */
    virtual bool provides(Integration::ODEProblemType problem_type ER7_UTILS_UNUSED) const
    {
        return true;
    }
     ...
     *
     */
    virtual bool implements(Integration::ODEProblemType problem_type ER7_UTILS_UNUSED) const
    {
        return true;
    }
