...
namespace er7_utils
{
    ...
    class IntegratorConstructor : virtual public Er7UtilsDeletable
    {
        ...
        public:
             ...
             *
             */
            virtual bool provides(Integration::ODEProblemType problem_type ER7_UTILS_UNUSED) const { return true; }
             ...
             *
             */
            virtual bool implements(Integration::ODEProblemType problem_type ER7_UTILS_UNUSED) const { return true; }
             ...
             */
            virtual bool need_first_step_derivatives(void) const { return true; }
             ...
             */
            virtual bool is_fixed_step_integrator(void) const { return true; }
             ...
             */
            virtual bool is_second_order_ode_technique(void) const { return false; }
             ...
             */
            virtual unsigned int get_buffer_size(void) const { return get_transition_table_size(); }
             ...
             */
            virtual IntegrationControls* create_integration_controls(void) const = 0;
             ...
             */
            virtual IntegratorResultMerger* create_integrator_results_merger(void) const;
            ...
            virtual SecondOrderODEIntegrator* create_generalized_step_second_order_ode_integrator(
                unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionStepFunctions& step_funs, IntegrationControls& controls) const;
        ...
        protected:
             ...
             */
            IntegratorConstructor& operator=(const IntegratorConstructor&) { return *this; }
    };
