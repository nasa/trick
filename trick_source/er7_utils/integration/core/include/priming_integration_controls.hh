...
namespace er7_utils
{
    ...
    class PrimingIntegrationControls : public StandardIntegrationControls
    {
        ...
        public:
             ...
             */
            PrimingIntegrationControls(const PrimingIntegrationControls& src)
                : Er7UtilsDeletable()
                , StandardIntegrationControls(src)
                , priming_controls(src.priming_controls ? src.priming_controls->create_copy() : NULL)
             ...
             */
            PrimingIntegrationControls(const IntegratorConstructor& primer_constructor,
             ...
             */
            IntegrationControls& get_priming_controls() { return *priming_controls; }
