...
namespace er7_utils
{
    ...
    class PrimingIntegratorConstructor : public IntegratorConstructor
    {
        ...
        public:
             ...
             */
            const IntegratorConstructor& get_primer_constructor(void) const { return *primer_constructor; }
             ...
             */
            virtual bool is_fixed_step_integrator(void) const { return primer_constructor->is_fixed_step_integrator(); }
        ...
        private:
             ...
             * Not implemented.
             */
            PrimingIntegratorConstructor& operator=(const PrimingIntegratorConstructor&);
    };
