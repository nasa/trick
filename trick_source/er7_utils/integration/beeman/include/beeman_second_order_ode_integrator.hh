...
protected:
     ...
     */
    BeemanSecondOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                   unsigned int size,
...
public:
     ...
     */
    BeemanSimpleSecondOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                         unsigned int size,
...
public:
    ...
    BeemanGeneralizedDerivSecondOrderODEIntegrator(const IntegratorConstructor & primer_constructor,
                                                   ...
                                                   IntegrationControls & controls_in)
        : Er7UtilsDeletable(),
          BeemanSecondOrderODEIntegrator(primer_constructor, position_size, velocity_size, deriv_funs, controls_in)
    {
    }
     ...
     * @param[in] src  Object to be copied.
     */
    BeemanGeneralizedDerivSecondOrderODEIntegrator & operator=(BeemanGeneralizedDerivSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
