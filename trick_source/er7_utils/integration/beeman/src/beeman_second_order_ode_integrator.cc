...
void BeemanSimpleSecondOrderODEIntegrator::technique_save_derivatives(int,
...
// Save derivatives during priming
void BeemanGeneralizedDerivSecondOrderODEIntegrator::technique_save_derivatives(
    int,
    const double * ER7_UTILS_RESTRICT accel,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE simple_beeman_step_one(const double * ER7_UTILS_RESTRICT accel,
                                                           const double * ER7_UTILS_RESTRICT prev_acc,
                                                           double deltat,
                                                           int size,
 ...
 * @param[in,out] velocity    Updated velocity vector
 */
inline void ER7_UTILS_ALWAYS_INLINE generalized_beeman_velocity_step_one(const double * ER7_UTILS_RESTRICT accel,
                                                                         const double * ER7_UTILS_RESTRICT prev_acc,
                                                                         double deltat,
                                                                         int size,
                                                                         double * ER7_UTILS_RESTRICT init_vel,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE generalized_beeman_position_step_one(const double * ER7_UTILS_RESTRICT init_posddot,
                                                                         const double * ER7_UTILS_RESTRICT prev_posddot,
                                                                         double deltat,
                                                                         int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE beeman_step_two(const double * ER7_UTILS_RESTRICT init_vel,
                                                    const double * ER7_UTILS_RESTRICT accel,
                                                    const double * ER7_UTILS_RESTRICT prev_acc,
...
// position.
IntegratorResult BeemanSimpleSecondOrderODEIntegrator::technique_integrate(double dyn_dt,
...
IntegratorResult BeemanGeneralizedDerivSecondOrderODEIntegrator::technique_integrate(
    double dyn_dt,
    unsigned int target_stage,
    const double * ER7_UTILS_RESTRICT accel,
    double * ER7_UTILS_RESTRICT velocity,
