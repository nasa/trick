...
namespace er7_utils
{
    ...
    SecondOrderODEIntegrator* BeemanIntegratorConstructor::create_second_order_ode_integrator(
        unsigned int size, IntegrationControls& controls) const
    {
        return integ_utils::allocate_integrator<BeemanSimpleSecondOrderODEIntegrator>(
    ...
    {
        return integ_utils::allocate_integrator<BeemanGeneralizedDerivSecondOrderODEIntegrator>(
