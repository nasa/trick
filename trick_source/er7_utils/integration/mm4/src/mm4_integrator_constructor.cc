...
IntegratorConstructor * MM4IntegratorConstructor::create_copy(void) const
{
...
{
    return integ_utils::allocate_integrator<MM4GeneralizedDerivSecondOrderODEIntegrator>(position_size,
                                                                                         velocity_size,
                                                                                         deriv_funs,
                                                                                         controls);
}
