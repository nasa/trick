...
second_order_mm4_step_one(const double * ER7_UTILS_RESTRICT accel,
                          double hdt,
                          int size,
 ...
 */
static inline void ER7_UTILS_ALWAYS_INLINE
second_order_mm4_step_one(const double * ER7_UTILS_RESTRICT posdot,
 ...
 */
static inline void ER7_UTILS_ALWAYS_INLINE
second_order_mm4_step_two(const double * ER7_UTILS_RESTRICT accel,
                          double dt,
                          int size,
                          double * ER7_UTILS_RESTRICT * ER7_UTILS_RESTRICT pos_hist,
                          double * ER7_UTILS_RESTRICT * ER7_UTILS_RESTRICT vel_hist,
 ...
 */
static inline void ER7_UTILS_ALWAYS_INLINE
second_order_mm4_step_two(const double * ER7_UTILS_RESTRICT posdot,
                          const double * ER7_UTILS_RESTRICT veldot,
                          double dt,
                          int size[2],
                          double * ER7_UTILS_RESTRICT * ER7_UTILS_RESTRICT pos_hist,
 ...
 */
static inline void ER7_UTILS_ALWAYS_INLINE first_order_mm4_step_three(const double * ER7_UTILS_RESTRICT deriv,
                                                                      const double * ER7_UTILS_RESTRICT step1_state,
                                                                      const double * ER7_UTILS_RESTRICT step2_state,
                                                                      double hdt,
                                                                      int size,
 ...
 */
static inline void ER7_UTILS_ALWAYS_INLINE second_order_mm4_step_three(const double * ER7_UTILS_RESTRICT accel,
                                                                       const double * ER7_UTILS_RESTRICT step1_pos,
                                                                       const double * ER7_UTILS_RESTRICT step2_pos,
                                                                       const double * ER7_UTILS_RESTRICT step1_vel,
                                                                       const double * ER7_UTILS_RESTRICT step2_vel,
                                                                       double hdt,
                                                                       int size,
                                                                       double * ER7_UTILS_RESTRICT position,
                                                                       double * ER7_UTILS_RESTRICT velocity)
...
MM4SecondOrderODEIntegrator::MM4SecondOrderODEIntegrator(unsigned int position_size,
...
// position.
IntegratorResult MM4SimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                              ...
                                                              double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 3:
            second_order_mm4_step_three(accel,
                                        pos_hist[1],
                                        pos_hist[2],
                                        vel_hist[1],
                                        vel_hist[2],
...
IntegratorResult MM4GeneralizedDerivSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                        unsigned int target_stage,
                                                                        const double * ER7_UTILS_RESTRICT accel,
                                                                        double * ER7_UTILS_RESTRICT velocity,
                                                                        double * ER7_UTILS_RESTRICT position)
