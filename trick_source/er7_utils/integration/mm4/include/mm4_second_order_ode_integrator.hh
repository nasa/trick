...
namespace er7_utils
{
    ...
    class MM4SecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            MM4SecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls);
             ...
             * @param[in,out] controls            Integration controls
             */
            MM4SecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        ...
        private:
             ...
             * Not implemented.
             */
            MM4SecondOrderODEIntegrator& operator=(const MM4SecondOrderODEIntegrator&);
    };
     ...
     */
    class MM4SimpleSecondOrderODEIntegrator : public MM4SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            MM4SimpleSecondOrderODEIntegrator(const MM4SimpleSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
             ...
             * @param[in,out] controls  Integration controls
             */
            MM4SimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
                : Er7UtilsDeletable()
             ...
             * @param[in] src  Object to be copied.
             */
            MM4SimpleSecondOrderODEIntegrator& operator=(MM4SimpleSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class MM4GeneralizedDerivSecondOrderODEIntegrator : public MM4SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            MM4GeneralizedDerivSecondOrderODEIntegrator(const MM4GeneralizedDerivSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
                , MM4SecondOrderODEIntegrator(src)
            {
            }
             ...
             * @param[in,out] controls       Integration controls
             */
            MM4GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
                , MM4SecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
            {
            }
             ...
             * @param[in] src  Object to be copied.
             */
            MM4GeneralizedDerivSecondOrderODEIntegrator& operator=(MM4GeneralizedDerivSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
