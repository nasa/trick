...
namespace er7_utils
{
    ...
    PositionVerletSecondOrderODEIntegrator::PositionVerletSecondOrderODEIntegrator(void)
        : Er7UtilsDeletable()
    ...
    PositionVerletSecondOrderODEIntegrator::PositionVerletSecondOrderODEIntegrator(unsigned int position_size,
    ...
    // Non-throwing swap.
    void PositionVerletSecondOrderODEIntegrator::swap(PositionVerletSecondOrderODEIntegrator& other)
    {
    ...
    PositionVerletSimpleSecondOrderODEIntegrator* PositionVerletSimpleSecondOrderODEIntegrator::create_copy() const
    {
    ...
    PositionVerletGeneralizedDerivSecondOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }
    ...
    PositionVerletGeneralizedStepSecondOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }
     ...
     */
    inline void ER7_UTILS_ALWAYS_INLINE position_verlet_step2(double const* ER7_UTILS_RESTRICT init_vel,
        double const* ER7_UTILS_RESTRICT accel, double deltat, int size, double* ER7_UTILS_RESTRICT position,
        double* ER7_UTILS_RESTRICT velocity, double* ER7_UTILS_RESTRICT saved_acc)
    {
    ...
    // position.
    IntegratorResult PositionVerletSimpleSecondOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
        ...
        double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
        {
            ...
            integ_utils::inplace_euler_step(velocity, hdt, state_size[0], position);
            ...
            if (restart)
            {
                ...
                integ_utils::inplace_euler_step_save_state(accel, hdt, state_size[1], init_vel, velocity);
            }
            else
            {
                integ_utils::inplace_euler_step_save_state(prev_accel, hdt, state_size[1], init_vel, velocity);
            }
        ...
        // the end velocity.
        case 2:
            position_verlet_step2(init_vel, accel, dyn_dt, state_size[0], position, velocity, prev_accel);
            step_factor = 1.0;
            break;
    ...
    IntegratorResult PositionVerletGeneralizedDerivSecondOrderODEIntegrator::integrate(double dyn_dt,
        ...
        double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
        {
            ...
            integ_utils::inplace_euler_step(posdot, hdt, state_size[0], position);
        ...
        case 2:
            integ_utils::euler_step_save_deriv(init_vel, accel, dyn_dt, state_size[1], prev_accel, velocity);

            compute_posdot(position, velocity, posdot);
            integ_utils::inplace_euler_step(posdot, 0.5 * dyn_dt, state_size[0], position);
            step_factor = 1.0;
            break;
    ...
    // function.
    IntegratorResult PositionVerletGeneralizedStepSecondOrderODEIntegrator::integrate(double dyn_dt,
        unsigned int target_stage, double const* ER7_UTILS_RESTRICT accel, double* ER7_UTILS_RESTRICT velocity,
        double* ER7_UTILS_RESTRICT position)
    {
        double step_factor;
        ...
        case 1:
            ...
            if (restart)
            {
                ...
                integ_utils::scale_array(velocity, 0.5 * dyn_dt, state_size[1], h_dtheta);
                compute_expmap_position_step(position, h_dtheta, midpoint);

                // Integrate generalized velocity.
                integ_utils::inplace_euler_step(accel, 0.5 * dyn_dt, state_size[1], velocity);
            }
            ...
            else
            {
                ...
                integ_utils::inplace_euler_step(prev_accel, 0.5 * dyn_dt, state_size[1], velocity);
            }
