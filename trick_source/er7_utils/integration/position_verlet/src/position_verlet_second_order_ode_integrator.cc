...
PositionVerletSecondOrderODEIntegrator::PositionVerletSecondOrderODEIntegrator(unsigned int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE position_verlet_step2(const double * ER7_UTILS_RESTRICT init_vel,
...
// position.
IntegratorResult PositionVerletSimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
