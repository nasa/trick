...
namespace er7_utils
{
    ...
    {
        return integ_utils::allocate_integrator<PositionVerletGeneralizedDerivSecondOrderODEIntegrator>(
    ...
    {
        return integ_utils::allocate_integrator<PositionVerletGeneralizedStepSecondOrderODEIntegrator>(
