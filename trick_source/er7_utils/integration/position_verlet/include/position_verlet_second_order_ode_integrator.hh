...
namespace er7_utils
{
    ...
    class PositionVerletSecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            PositionVerletSecondOrderODEIntegrator(const PositionVerletSecondOrderODEIntegrator& src);
             ...
             */
            PositionVerletSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls);
             ...
             * @param[in,out] controls       Integration controls
             */
            PositionVerletSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        ...
        private:
             ...
             * Not implemented.
             */
            PositionVerletSecondOrderODEIntegrator& operator=(const PositionVerletSecondOrderODEIntegrator&);
    };
     ...
     */
    class PositionVerletSimpleSecondOrderODEIntegrator : public PositionVerletSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            PositionVerletSimpleSecondOrderODEIntegrator(const PositionVerletSimpleSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
             ...
             * @param[in,out] controls  Integration controls
             */
            PositionVerletSimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
                : Er7UtilsDeletable()
             ...
             * @param[in] src  Object to be copied.
             */
            PositionVerletSimpleSecondOrderODEIntegrator& operator=(PositionVerletSimpleSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class PositionVerletGeneralizedDerivSecondOrderODEIntegrator : public PositionVerletSecondOrderODEIntegrator
    {
            ER7_UTILS_MAKE_SIM_INTERFACES(PositionVerletGeneralizedDerivSecondOrderODEIntegrator)
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            PositionVerletGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                unsigned int velocity_size, const GeneralizedPositionDerivativeFunctions deriv_funs,
                IntegrationControls& controls)
                : Er7UtilsDeletable()
                , PositionVerletSecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
            {
            }
             ...
             * @return Clone of 'this'.
             */
            virtual PositionVerletGeneralizedDerivSecondOrderODEIntegrator* create_copy() const;
     ...
     */
    class PositionVerletGeneralizedStepSecondOrderODEIntegrator : public PositionVerletSecondOrderODEIntegrator
    {
            ER7_UTILS_MAKE_SIM_INTERFACES(PositionVerletGeneralizedStepSecondOrderODEIntegrator)
        ...
        public:
             ...
             * @param[in,out] controls      Integration controls
             */
            PositionVerletGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                unsigned int velocity_size, const GeneralizedPositionStepFunctions& step_funs,
                IntegrationControls& controls)
                : Er7UtilsDeletable()
                , PositionVerletSecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
            {
            }
             ...
             * @return Clone of 'this'.
             */
            virtual PositionVerletGeneralizedStepSecondOrderODEIntegrator* create_copy() const;

            /**
             * Reset a Nystrom Lear 2 integrator.
             */
            virtual void reset_integrator(void) { restart = true; }
