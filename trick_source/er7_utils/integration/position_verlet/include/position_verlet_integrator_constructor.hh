...
namespace er7_utils
{
    ...
    class PositionVerletIntegratorConstructor : public IntegratorConstructor
    {
        ...
        public:
             ...
             */
            virtual const char* get_class_name(void) const { return "PositionVerletIntegratorConstructor"; }
             ...
             */
            virtual bool is_second_order_ode_technique(void) const { return true; }

            /**
             * PositionVerlet doesn't use acceleration on the initial step.
             * \return Always returns false.
             */
            virtual bool need_first_step_derivatives(void) const { return false; }

            /**
             * PositionVerlet uses two steps per cycle.
             * \return Always returns 2.
             */
            virtual unsigned int get_transition_table_size(void) const { return 2; }
    };
