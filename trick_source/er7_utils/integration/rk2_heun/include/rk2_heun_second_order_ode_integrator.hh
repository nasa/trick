...
namespace er7_utils
{
    ...
    class RK2HeunSecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             * @param[in,out] controls       Integration controls
             */
            RK2HeunSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
    ...
    class RK2HeunGeneralizedDerivSecondOrderODEIntegrator : public RK2HeunSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RK2HeunGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
    ...
    class RK2HeunGeneralizedStepSecondOrderODEIntegrator : public RK2HeunSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RK2HeunGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionStepFunctions& step_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
