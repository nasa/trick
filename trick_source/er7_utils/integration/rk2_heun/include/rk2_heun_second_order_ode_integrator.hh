...
protected:
     ...
     */
    RK2HeunSecondOrderODEIntegrator(const RK2HeunSecondOrderODEIntegrator & src);
     ...
     */
    RK2HeunSecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     * @param[in,out] controls       Integration controls
     */
    RK2HeunSecondOrderODEIntegrator(unsigned int position_size,
...
private:
     ...
     * Not implemented.
     */
    RK2HeunSecondOrderODEIntegrator & operator=(const RK2HeunSecondOrderODEIntegrator &);
};
 ...
 */
class RK2HeunSimpleSecondOrderODEIntegrator : public RK2HeunSecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RK2HeunSimpleSecondOrderODEIntegrator(const RK2HeunSimpleSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
     ...
     * @param[in,out] controls  Integration controls
     */
    RK2HeunSimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls)
        : Er7UtilsDeletable(),
     ...
     * @param[in] src  Object to be copied.
     */
    RK2HeunSimpleSecondOrderODEIntegrator & operator=(RK2HeunSimpleSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
 ...
 */
class RK2HeunGeneralizedDerivSecondOrderODEIntegrator : public RK2HeunSecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RK2HeunGeneralizedDerivSecondOrderODEIntegrator(const RK2HeunGeneralizedDerivSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RK2HeunSecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RK2HeunGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                                                    unsigned int velocity_size,
                                                    const GeneralizedPositionDerivativeFunctions & deriv_funs,
                                                    IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RK2HeunSecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
    {
    }
     ...
     * @param[in] src  Object to be copied.
     */
    RK2HeunGeneralizedDerivSecondOrderODEIntegrator & operator=(RK2HeunGeneralizedDerivSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RK2HeunGeneralizedDerivSecondOrderODEIntegrator * create_copy() const;
 ...
 * the generalized position and generalized velocity.
 */
class RK2HeunGeneralizedStepSecondOrderODEIntegrator : public RK2HeunSecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RK2HeunGeneralizedStepSecondOrderODEIntegrator(const RK2HeunGeneralizedStepSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RK2HeunSecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RK2HeunGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                                                   unsigned int velocity_size,
                                                   const GeneralizedPositionStepFunctions & step_funs,
                                                   IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RK2HeunSecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
    {
    }
     ...
     * @param[in] src  Object to be copied.
     */
    RK2HeunGeneralizedStepSecondOrderODEIntegrator & operator=(RK2HeunGeneralizedStepSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RK2HeunGeneralizedStepSecondOrderODEIntegrator * create_copy() const;
