...
namespace er7_utils
{
    ...
    RK2HeunSecondOrderODEIntegrator::RK2HeunSecondOrderODEIntegrator(void)
        : Er7UtilsDeletable()
    ...
    RK2HeunSecondOrderODEIntegrator::RK2HeunSecondOrderODEIntegrator(const RK2HeunSecondOrderODEIntegrator& src)
        : Er7UtilsDeletable()
        , SecondOrderODEIntegrator()
        , init_pos(NULL)
        , init_vel(NULL)
    ...
    RK2HeunSecondOrderODEIntegrator::RK2HeunSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
        : Er7UtilsDeletable()
    ...
    RK2HeunSecondOrderODEIntegrator::RK2HeunSecondOrderODEIntegrator(unsigned int position_size,
    ...
    // Non-throwing swap.
    void RK2HeunSecondOrderODEIntegrator::swap(RK2HeunSecondOrderODEIntegrator& other)
    {
    ...
    RK2HeunSimpleSecondOrderODEIntegrator* RK2HeunSimpleSecondOrderODEIntegrator::create_copy() const
    {
    ...
    RK2HeunGeneralizedDerivSecondOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }

    // Clone a RK2HeunGeneralizedStepSecondOrderODEIntegrator.
    RK2HeunGeneralizedStepSecondOrderODEIntegrator* RK2HeunGeneralizedStepSecondOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }
    ...
    // position.
    IntegratorResult RK2HeunSimpleSecondOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
        ...
        double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
            integ_utils::inplace_two_state_euler_step_save_pos_vel_acc(
                accel, dyn_dt, state_size[0], init_pos, init_vel, init_acc, position, velocity);
            break;
    ...
    IntegratorResult RK2HeunGeneralizedDerivSecondOrderODEIntegrator::integrate(double dyn_dt,
        ...
        double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
            ...
            integ_utils::inplace_two_state_euler_step_save_pos_vel_acc(
                init_posdot, accel, dyn_dt, state_size, init_pos, init_vel, init_acc, position, velocity);
            break;

        case 2:
            compute_posdot(position, velocity, final_posdot);
            rk::rk2_heun_final_step(init_pos, init_posdot, final_posdot, dyn_dt, state_size[0], position);
            rk::rk2_heun_final_step(init_vel, init_acc, accel, dyn_dt, state_size[1], velocity);
            break;
    ...
    IntegratorResult RK2HeunGeneralizedStepSecondOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
        double const* ER7_UTILS_RESTRICT accel, double* ER7_UTILS_RESTRICT velocity,
        double* ER7_UTILS_RESTRICT position)
    {
        // Advance state per Heun's method.
        ...
        case 1:
            ...
            integ_utils::inplace_euler_step_save_both(accel, dyn_dt, state_size[1], init_vel, init_acc, velocity);
            break;
