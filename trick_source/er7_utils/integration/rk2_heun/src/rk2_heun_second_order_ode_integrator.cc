...
RK2HeunGeneralizedDerivSecondOrderODEIntegrator * RK2HeunGeneralizedDerivSecondOrderODEIntegrator::create_copy() const
{
    return alloc::replicate_object(*this);
}
...
// position.
IntegratorResult RK2HeunSimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                  ...
                                                                  double * ER7_UTILS_RESTRICT position)
{
    ...
    {
        case 1:
            integ_utils::inplace_two_state_euler_step_save_pos_vel_acc(accel,
                                                                       dyn_dt,
                                                                       state_size[0],
                                                                       init_pos,
                                                                       init_vel,
                                                                            ...
                                                                            double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        case 1:
            ...
            integ_utils::inplace_two_state_euler_step_save_pos_vel_acc(init_posdot,
                                                                       accel,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
...
IntegratorResult RK2HeunGeneralizedStepSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                           unsigned int target_stage,
                                                                           const double * ER7_UTILS_RESTRICT accel,
                                                                           double * ER7_UTILS_RESTRICT velocity,
                                                                           double * ER7_UTILS_RESTRICT position)
