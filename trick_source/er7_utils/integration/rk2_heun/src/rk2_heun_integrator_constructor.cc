...
{
    return integ_utils::allocate_integrator<RK2HeunGeneralizedDerivSecondOrderODEIntegrator>(position_size,
                                                                                             velocity_size,
                                                                                             deriv_funs,
                                                                                             controls);
}
...
SecondOrderODEIntegrator * RK2HeunIntegratorConstructor::create_generalized_step_second_order_ode_integrator(
    ...
    IntegrationControls & controls) const
{
    return integ_utils::allocate_integrator<RK2HeunGeneralizedStepSecondOrderODEIntegrator>(position_size,
                                                                                            velocity_size,
                                                                                            step_funs,
                                                                                            controls);
}
