...
namespace er7_utils
{
    ...
    class RK2MidpointSecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             * @param[in,out] controls       Integration controls
             */
            RK2MidpointSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
    ...
    class RK2MidpointGeneralizedDerivSecondOrderODEIntegrator : public RK2MidpointSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RK2MidpointGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
    ...
    class RK2MidpointGeneralizedStepSecondOrderODEIntegrator : public RK2MidpointSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RK2MidpointGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionStepFunctions& step_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
