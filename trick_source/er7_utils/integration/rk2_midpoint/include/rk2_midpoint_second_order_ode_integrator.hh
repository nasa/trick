...
protected:
     ...
     */
    RK2MidpointSecondOrderODEIntegrator(const RK2MidpointSecondOrderODEIntegrator & src);
     ...
     */
    RK2MidpointSecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     * @param[in,out] controls       Integration controls
     */
    RK2MidpointSecondOrderODEIntegrator(unsigned int position_size,
...
private:
     ...
     * Not implemented.
     */
    RK2MidpointSecondOrderODEIntegrator & operator=(const RK2MidpointSecondOrderODEIntegrator &);
};
 ...
 */
class RK2MidpointSimpleSecondOrderODEIntegrator : public RK2MidpointSecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RK2MidpointSimpleSecondOrderODEIntegrator(const RK2MidpointSimpleSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
     ...
     * @param[in,out] controls  Integration controls
     */
    RK2MidpointSimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls)
        : Er7UtilsDeletable(),
     ...
     * @param[in] src  Object to be copied.
     */
    RK2MidpointSimpleSecondOrderODEIntegrator & operator=(RK2MidpointSimpleSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
     ...
     */
    virtual IntegratorResult integrate(double dyn_dt,
 ...
 */
class RK2MidpointGeneralizedDerivSecondOrderODEIntegrator : public RK2MidpointSecondOrderODEIntegrator
{
    ER7_UTILS_MAKE_SIM_INTERFACES(RK2MidpointGeneralizedDerivSecondOrderODEIntegrator)
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RK2MidpointGeneralizedDerivSecondOrderODEIntegrator(const RK2MidpointGeneralizedDerivSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RK2MidpointSecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RK2MidpointGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                                                        unsigned int velocity_size,
                                                        const GeneralizedPositionDerivativeFunctions & deriv_funs,
                                                        IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RK2MidpointSecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
    {
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RK2MidpointGeneralizedDerivSecondOrderODEIntegrator * create_copy() const;
 ...
 * the generalized position and generalized velocity.
 */
class RK2MidpointGeneralizedStepSecondOrderODEIntegrator : public RK2MidpointSecondOrderODEIntegrator
{
    ER7_UTILS_MAKE_SIM_INTERFACES(RK2MidpointGeneralizedStepSecondOrderODEIntegrator)
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RK2MidpointGeneralizedStepSecondOrderODEIntegrator(const RK2MidpointGeneralizedStepSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RK2MidpointSecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RK2MidpointGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                                                       unsigned int velocity_size,
                                                       const GeneralizedPositionStepFunctions & step_funs,
                                                       IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RK2MidpointSecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
    {
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RK2MidpointGeneralizedStepSecondOrderODEIntegrator * create_copy() const;
