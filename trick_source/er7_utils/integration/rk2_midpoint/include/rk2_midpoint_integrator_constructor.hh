...
/**
 * @file
 * Defines the class RK2MidpointIntegratorConstructor, which constructs
 * integrators that use the RK2 midpoint method.
 */
...
namespace er7_utils
{
    ...
    class RK2MidpointIntegratorConstructor : public IntegratorConstructor
    {
        ...
        public:
             ...
             */
            virtual const char* get_class_name(void) const { return "RK2MidpointIntegratorConstructor"; }
