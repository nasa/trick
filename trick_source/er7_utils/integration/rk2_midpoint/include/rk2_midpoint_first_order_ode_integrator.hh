...
public:
     ...
     */
    RK2MidpointFirstOrderODEIntegrator(const RK2MidpointFirstOrderODEIntegrator & src);
     ...
     */
    RK2MidpointFirstOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     */
    RK2MidpointFirstOrderODEIntegrator & operator=(RK2MidpointFirstOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
