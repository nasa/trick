...
RK2MidpointFirstOrderODEIntegrator::RK2MidpointFirstOrderODEIntegrator(void)
    : Er7UtilsDeletable(),
...
// Copy constructor.
RK2MidpointFirstOrderODEIntegrator::RK2MidpointFirstOrderODEIntegrator(const RK2MidpointFirstOrderODEIntegrator & src)
    : Er7UtilsDeletable(),
...
RK2MidpointFirstOrderODEIntegrator::RK2MidpointFirstOrderODEIntegrator(unsigned int size,
...
RK2MidpointFirstOrderODEIntegrator * RK2MidpointFirstOrderODEIntegrator::create_copy() const
{
    return alloc::replicate_object(*this);
}

// Non-throwing swap.
void RK2MidpointFirstOrderODEIntegrator::swap(RK2MidpointFirstOrderODEIntegrator & other)
{
...
IntegratorResult RK2MidpointFirstOrderODEIntegrator::integrate(double dt,
                                                               ...
                                                               double * ER7_UTILS_RESTRICT position)
{
    ...
    {
        case 1:
            integ_utils::inplace_euler_step_save_state(velocity, 0.5 * dt, state_size, init_state, position);
            step_factor = 0.5;
            break;
