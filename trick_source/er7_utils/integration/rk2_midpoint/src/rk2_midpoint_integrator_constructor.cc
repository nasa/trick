...
namespace er7_utils
{
    ...
    IntegratorConstructor* RK2MidpointIntegratorConstructor::create_constructor(void)
    {
        return alloc::allocate_object<RK2MidpointIntegratorConstructor>();
    }

    // Create a duplicate of the constructor.
    IntegratorConstructor* RK2MidpointIntegratorConstructor::create_copy(void) const
    {
        return alloc::replicate_object(*this);
    }

    // Create an RK2Midpoint integration controls.
    IntegrationControls* RK2MidpointIntegratorConstructor::create_integration_controls(void) const
    {
    ...
    FirstOrderODEIntegrator* RK2MidpointIntegratorConstructor::create_first_order_ode_integrator(
    ...
    SecondOrderODEIntegrator* RK2MidpointIntegratorConstructor::create_second_order_ode_integrator(
        unsigned int size, IntegrationControls& controls) const
    {
        return integ_utils::allocate_integrator<RK2MidpointSimpleSecondOrderODEIntegrator>(size, controls);
    }

    // Create an RK2Midpoint state integrator for a second order ODE.
    SecondOrderODEIntegrator* RK2MidpointIntegratorConstructor::create_generalized_deriv_second_order_ode_integrator(
    ...
    {
        return integ_utils::allocate_integrator<RK2MidpointGeneralizedDerivSecondOrderODEIntegrator>(
            position_size, velocity_size, deriv_funs, controls);
    }

    // Create an RK2Midpoint state integrator for a second order ODE.
    SecondOrderODEIntegrator* RK2MidpointIntegratorConstructor::create_generalized_step_second_order_ode_integrator(
    ...
    {
        return integ_utils::allocate_integrator<RK2MidpointGeneralizedStepSecondOrderODEIntegrator>(
