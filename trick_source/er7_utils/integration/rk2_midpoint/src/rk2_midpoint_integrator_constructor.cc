...
{
    return integ_utils::allocate_integrator<RK2MidpointGeneralizedDerivSecondOrderODEIntegrator>(position_size,
                                                                                                 velocity_size,
                                                                                                 deriv_funs,
                                                                                                 controls);
}
...
SecondOrderODEIntegrator * RK2MidpointIntegratorConstructor::create_generalized_step_second_order_ode_integrator(
    ...
    IntegrationControls & controls) const
{
    return integ_utils::allocate_integrator<RK2MidpointGeneralizedStepSecondOrderODEIntegrator>(position_size,
                                                                                                velocity_size,
                                                                                                step_funs,
                                                                                                controls);
}
