...
RK2MidpointSecondOrderODEIntegrator::RK2MidpointSecondOrderODEIntegrator(unsigned int size,
...
RK2MidpointGeneralizedDerivSecondOrderODEIntegrator * RK2MidpointGeneralizedDerivSecondOrderODEIntegrator::create_copy()
    const
{
    return alloc::replicate_object(*this);
}
...
RK2MidpointGeneralizedStepSecondOrderODEIntegrator * RK2MidpointGeneralizedStepSecondOrderODEIntegrator::create_copy()
    const
{
    return alloc::replicate_object(*this);
}
...
// position.
IntegratorResult RK2MidpointSimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                      ...
                                                                      double * ER7_UTILS_RESTRICT position)
{
    ...
    {
        case 1:
            integ_utils::inplace_two_state_euler_step_save_pos_vel(accel,
                                                                   0.5 * dyn_dt,
                                                                   state_size[0],
                                                                   init_pos,
                                                                   init_vel,
                                                                                ...
                                                                                double * ER7_UTILS_RESTRICT position)
{
    ...
    {
        case 1:
            integ_utils::inplace_two_state_euler_step_save_pos_vel(posdot,
                                                                   accel,
                                                                   0.5 * dyn_dt,
                                                                   state_size,
                                                                   init_pos,
        ...
        case 2:
            integ_utils::two_state_euler_step(init_pos,
                                              init_vel,
                                              posdot,
                                              accel,
                                              dyn_dt,
