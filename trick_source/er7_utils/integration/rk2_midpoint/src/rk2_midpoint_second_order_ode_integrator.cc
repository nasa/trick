...
namespace er7_utils
{
    ...
    RK2MidpointSecondOrderODEIntegrator::RK2MidpointSecondOrderODEIntegrator(void)
        : Er7UtilsDeletable()
    ...
    RK2MidpointSecondOrderODEIntegrator::RK2MidpointSecondOrderODEIntegrator(unsigned int position_size,
    ...
    // Non-throwing swap.
    void RK2MidpointSecondOrderODEIntegrator::swap(RK2MidpointSecondOrderODEIntegrator& other)
    {
    ...
    RK2MidpointSimpleSecondOrderODEIntegrator* RK2MidpointSimpleSecondOrderODEIntegrator::create_copy() const
    {
    ...
    RK2MidpointGeneralizedDerivSecondOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }
    ...
    RK2MidpointGeneralizedStepSecondOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }
    ...
    // position.
    IntegratorResult RK2MidpointSimpleSecondOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
        ...
        double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
            integ_utils::inplace_two_state_euler_step_save_pos_vel(
                accel, 0.5 * dyn_dt, state_size[0], init_pos, init_vel, position, velocity);
            step_factor = 0.5;
            break;

        case 2:
            integ_utils::two_state_euler_step(init_pos, init_vel, accel, dyn_dt, state_size[0], position, velocity);
            step_factor = 1.0;
            break;
    ...
    IntegratorResult RK2MidpointGeneralizedDerivSecondOrderODEIntegrator::integrate(double dyn_dt,
        ...
        double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
            integ_utils::inplace_two_state_euler_step_save_pos_vel(
                posdot, accel, 0.5 * dyn_dt, state_size, init_pos, init_vel, position, velocity);
            step_factor = 0.5;
            break;

        case 2:
            integ_utils::two_state_euler_step(
                init_pos, init_vel, posdot, accel, dyn_dt, state_size, position, velocity);
            step_factor = 1.0;
            break;
    ...
    IntegratorResult RK2MidpointGeneralizedStepSecondOrderODEIntegrator::integrate(double dyn_dt,
        unsigned int target_stage, double const* ER7_UTILS_RESTRICT accel, double* ER7_UTILS_RESTRICT velocity,
        double* ER7_UTILS_RESTRICT position)
    {
        double step_factor;
        ...
        case 2:
            ...
            // Integrate generalized velocity.
            integ_utils::euler_step(init_vel, accel, dyn_dt, state_size[1], velocity);
            step_factor = 1.0;
            break;
