...
namespace er7_utils
{
    ...
    {
        return integ_utils::allocate_integrator<VelocityVerletGeneralizedDerivSecondOrderODEIntegrator>(
    ...
    {
        return integ_utils::allocate_integrator<VelocityVerletGeneralizedStepSecondOrderODEIntegrator>(
