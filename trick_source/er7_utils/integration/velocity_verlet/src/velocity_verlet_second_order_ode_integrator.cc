...
namespace er7_utils
{
    ...
    VelocityVerletSecondOrderODEIntegrator::VelocityVerletSecondOrderODEIntegrator(unsigned int position_size,
     ...
     */
    inline void ER7_UTILS_ALWAYS_INLINE simple_velocity_verlet_step_one(double const* ER7_UTILS_RESTRICT accel,
        double deltat, int size, double* ER7_UTILS_RESTRICT position, double* ER7_UTILS_RESTRICT velocity,
        double* ER7_UTILS_RESTRICT init_vel, double* ER7_UTILS_RESTRICT init_acc)
    {
     ...
     * @param[out]    init_acc  Saved initial acceleration vector
     */
    inline void ER7_UTILS_ALWAYS_INLINE generalized_deriv_velocity_verlet_step_one(
        double const* ER7_UTILS_RESTRICT accel, double deltat, int size, double* ER7_UTILS_RESTRICT vel_mid,
        double* ER7_UTILS_RESTRICT velocity, double* ER7_UTILS_RESTRICT init_vel, double* ER7_UTILS_RESTRICT init_acc)
    {
        double hdt = 0.5 * deltat;
     ...
     * @param[out]    init_acc  Saved initial acceleration vector
     */
    inline void ER7_UTILS_ALWAYS_INLINE generalized_step_velocity_verlet_step_one(
        double const* ER7_UTILS_RESTRICT accel, double deltat, int size, double* ER7_UTILS_RESTRICT dtheta,
        double* ER7_UTILS_RESTRICT velocity, double* ER7_UTILS_RESTRICT init_vel, double* ER7_UTILS_RESTRICT init_acc)
    {
        double hdt = 0.5 * deltat;
     ...
     */
    inline void ER7_UTILS_ALWAYS_INLINE velocity_verlet_step_two(double const* ER7_UTILS_RESTRICT init_vel,
        double const* ER7_UTILS_RESTRICT init_acc, double const* ER7_UTILS_RESTRICT end_acc, double deltat, int size,
    ...
    // position.
    IntegratorResult VelocityVerletSimpleSecondOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
        ...
        double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
            generalized_deriv_velocity_verlet_step_one(
                accel, dyn_dt, state_size[1], dtheta, velocity, init_vel, init_acc);
