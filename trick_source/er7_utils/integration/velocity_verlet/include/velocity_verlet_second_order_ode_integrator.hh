...
namespace er7_utils
{
    ...
    class VelocityVerletSecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            VelocityVerletSecondOrderODEIntegrator(const VelocityVerletSecondOrderODEIntegrator& src);
             ...
             */
            VelocityVerletSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls);
             ...
             * @param[in,out] controls       Integration controls
             */
            VelocityVerletSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        ...
        private:
             ...
             * Not implemented.
             */
            VelocityVerletSecondOrderODEIntegrator& operator=(const VelocityVerletSecondOrderODEIntegrator&);
    };
     ...
     */
    class VelocityVerletSimpleSecondOrderODEIntegrator : public VelocityVerletSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            VelocityVerletSimpleSecondOrderODEIntegrator(const VelocityVerletSimpleSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
             ...
             * @param[in,out] controls  Integration controls
             */
            VelocityVerletSimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
                : Er7UtilsDeletable()
             ...
             * @param[in] src  Object to be copied.
             */
            VelocityVerletSimpleSecondOrderODEIntegrator& operator=(VelocityVerletSimpleSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class VelocityVerletGeneralizedDerivSecondOrderODEIntegrator : public VelocityVerletSecondOrderODEIntegrator
    {
            ER7_UTILS_MAKE_SIM_INTERFACES(VelocityVerletGeneralizedDerivSecondOrderODEIntegrator)
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            VelocityVerletGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                unsigned int velocity_size, const GeneralizedPositionDerivativeFunctions& deriv_funs,
                IntegrationControls& controls)
                : Er7UtilsDeletable()
                , VelocityVerletSecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
            {
            }
             ...
             * @return Clone of 'this'.
             */
            virtual VelocityVerletGeneralizedDerivSecondOrderODEIntegrator* create_copy() const;
     ...
     * the generalized position and generalized velocity.
     */
    class VelocityVerletGeneralizedStepSecondOrderODEIntegrator : public VelocityVerletSecondOrderODEIntegrator
    {
            ER7_UTILS_MAKE_SIM_INTERFACES(VelocityVerletGeneralizedStepSecondOrderODEIntegrator)
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            VelocityVerletGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                unsigned int velocity_size, const GeneralizedPositionStepFunctions& step_funs,
                IntegrationControls& controls)
                : Er7UtilsDeletable()
                , VelocityVerletSecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
            {
            }
             ...
             * @return Clone of 'this'.
             */
            virtual VelocityVerletGeneralizedStepSecondOrderODEIntegrator* create_copy() const;
