...
namespace er7_utils
{
    ...
    class EulerSecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            EulerSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls);
             ...
             * @param[in,out] controls       Integration controls
             */
            EulerSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        ...
        private:
             ...
             * Not implemented.
             */
            EulerSecondOrderODEIntegrator& operator=(const EulerSecondOrderODEIntegrator&);
    };
     ...
     */
    class EulerSimpleSecondOrderODEIntegrator : public EulerSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            EulerSimpleSecondOrderODEIntegrator(const EulerSimpleSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
             ...
             * @param[in,out] controls  Integration controls
             */
            EulerSimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
                : Er7UtilsDeletable()
             ...
             * @param[in] src  Object to be copied.
             */
            EulerSimpleSecondOrderODEIntegrator& operator=(EulerSimpleSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class EulerGeneralizedDerivSecondOrderODEIntegrator : public EulerSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            EulerGeneralizedDerivSecondOrderODEIntegrator(const EulerGeneralizedDerivSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
                , EulerSecondOrderODEIntegrator(src)
            {
            }
             ...
             * @param[in,out] controls       Integration controls
             */
            EulerGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
                , EulerSecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
            {
            }
             ...
             * @param[in] src  Object to be copied.
             */
            EulerGeneralizedDerivSecondOrderODEIntegrator& operator=(EulerGeneralizedDerivSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     * the generalized position and generalized velocity.
     */
    class EulerGeneralizedStepSecondOrderODEIntegrator : public EulerSecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            EulerGeneralizedStepSecondOrderODEIntegrator(const EulerGeneralizedStepSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
                , EulerSecondOrderODEIntegrator(src)
            {
            }
             ...
             * @param[in,out] controls       Integration controls
             */
            EulerGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionStepFunctions& step_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
                , EulerSecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
            {
            }
             ...
             * @param[in] src  Object to be copied.
             */
            EulerGeneralizedStepSecondOrderODEIntegrator& operator=(EulerGeneralizedStepSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
