...
protected:
     ...
     * @param[in,out] controls       Integration controls
     */
    EulerSecondOrderODEIntegrator(unsigned int position_size,
...
public:
     ...
     * @param[in,out] controls       Integration controls
     */
    EulerGeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                                                  unsigned int velocity_size,
                                                  const GeneralizedPositionDerivativeFunctions & deriv_funs,
                                                  IntegrationControls & controls)
        : Er7UtilsDeletable(),
...
public:
     ...
     * @param[in,out] controls       Integration controls
     */
    EulerGeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                                                 unsigned int velocity_size,
                                                 const GeneralizedPositionStepFunctions & step_funs,
                                                 IntegrationControls & controls)
        : Er7UtilsDeletable(),
