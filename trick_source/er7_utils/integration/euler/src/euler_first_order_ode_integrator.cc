...
namespace er7_utils
{
    ...
    EulerFirstOrderODEIntegrator::~EulerFirstOrderODEIntegrator(void) { ; /* Empty */ }
    ...
    IntegratorResult EulerFirstOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
