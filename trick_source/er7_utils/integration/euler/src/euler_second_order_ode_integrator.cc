...
EulerSecondOrderODEIntegrator::EulerSecondOrderODEIntegrator(unsigned int position_size,
...
// position.
IntegratorResult EulerSimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
...
IntegratorResult EulerGeneralizedDerivSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                          unsigned int target_stage,
                                                                          const double * ER7_UTILS_RESTRICT accel,
                                                                          double * ER7_UTILS_RESTRICT velocity,
                                                                          double * ER7_UTILS_RESTRICT position)
...
// Propagate state for the general case of the generalized position derivative
// being a function of generalized position and generalized velocity.
IntegratorResult EulerGeneralizedStepSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                         unsigned int target_stage,
                                                                         const double * ER7_UTILS_RESTRICT accel,
                                                                         double * ER7_UTILS_RESTRICT velocity,
                                                                         double * ER7_UTILS_RESTRICT position)
