...
namespace er7_utils
{
    ...
    NystromLear2SecondOrderODEIntegrator::NystromLear2SecondOrderODEIntegrator(void)
        : Er7UtilsDeletable()
    ...
    NystromLear2SecondOrderODEIntegrator::NystromLear2SecondOrderODEIntegrator(unsigned int position_size,
    ...
    // Non-throwing swap.
    void NystromLear2SecondOrderODEIntegrator::swap(NystromLear2SecondOrderODEIntegrator& other)
    {
    ...
    NystromLear2SimpleSecondOrderODEIntegrator* NystromLear2SimpleSecondOrderODEIntegrator::create_copy() const
    {
    ...
    NystromLear2GeneralizedDerivSecondOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }
     ...
     */
    inline void ER7_UTILS_ALWAYS_INLINE nl2_step2(double const* ER7_UTILS_RESTRICT accel, double deltat, int size,
    ...
    // position.
    IntegratorResult NystromLear2SimpleSecondOrderODEIntegrator::integrate(double dyn_dt, unsigned int target_stage,
    ...
    IntegratorResult NystromLear2GeneralizedDerivSecondOrderODEIntegrator::integrate(double dyn_dt,
