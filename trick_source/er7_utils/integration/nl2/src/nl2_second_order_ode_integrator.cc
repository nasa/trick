...
NystromLear2SecondOrderODEIntegrator::NystromLear2SecondOrderODEIntegrator(unsigned int size,
 ...
 */
inline void ER7_UTILS_ALWAYS_INLINE nl2_step2(const double * ER7_UTILS_RESTRICT accel,
                                              double deltat,
                                              int size,
...
// position.
IntegratorResult NystromLear2SimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
