...
namespace er7_utils
{
    ...
    class NystromLear2SecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             */
            NystromLear2SecondOrderODEIntegrator(const NystromLear2SecondOrderODEIntegrator& src);
             ...
             */
            NystromLear2SecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls);
             ...
             * @param[in,out] controls       Integration controls
             */
            NystromLear2SecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
        ...
        private:
             ...
             * Not implemented.
             */
            NystromLear2SecondOrderODEIntegrator& operator=(const NystromLear2SecondOrderODEIntegrator&);
    };
     ...
     */
    class NystromLear2SimpleSecondOrderODEIntegrator : public NystromLear2SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in] src  Object to be copied.
             */
            NystromLear2SimpleSecondOrderODEIntegrator(const NystromLear2SimpleSecondOrderODEIntegrator& src)
                : Er7UtilsDeletable()
             ...
             * @param[in,out] controls  Integration controls
             */
            NystromLear2SimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls& controls)
                : Er7UtilsDeletable()
             ...
             * @param[in] src  Object to be copied.
             */
            NystromLear2SimpleSecondOrderODEIntegrator& operator=(NystromLear2SimpleSecondOrderODEIntegrator src)
            {
                swap(src);
                return *this;
            }
     ...
     */
    class NystromLear2GeneralizedDerivSecondOrderODEIntegrator : public NystromLear2SecondOrderODEIntegrator
    {
            ER7_UTILS_MAKE_SIM_INTERFACES(NystromLear2GeneralizedDerivSecondOrderODEIntegrator)
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            NystromLear2GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionDerivativeFunctions deriv_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
                , NystromLear2SecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
            {
            }
             ...
             * @return Clone of 'this'.
             */
            virtual NystromLear2GeneralizedDerivSecondOrderODEIntegrator* create_copy() const;
