...
rkf78_simple_intermediate_step(double dyn_dt,
                               int state_size[2],
                               const double * ER7_UTILS_RESTRICT init_pos,
                               const double * ER7_UTILS_RESTRICT init_vel,
                               ...
                               double * ER7_UTILS_RESTRICT position)
{
    ...
    integ_utils::two_state_weighted_step_save_derivs<target_stage>(init_pos,
                                                                   init_vel,
                                                                   accel,
                                                                   RKF78_BUTCHER_TABLEAU::RKa[target_stage],
                                                                   dyn_dt,
                                                                   state_size[0],
                                                                   posdot_hist,
                                                                   veldot_hist,
...
template<int target_stage>
inline double ER7_UTILS_ALWAYS_INLINE
rkf78_generalized_deriv_intermediate_step(GeneralizedPositionDerivativeFunctions::FirstDerivative deriv_fun,
                                          double dyn_dt,
                                          int state_size[2],
                                          const double * ER7_UTILS_RESTRICT init_pos,
                                          const double * ER7_UTILS_RESTRICT init_vel,
                                          ...
                                          double * ER7_UTILS_RESTRICT position)
{
    ...
    integ_utils::two_state_weighted_step_save_veldot<target_stage>(init_pos,
                                                                   init_vel,
                                                                   accel,
                                                                   RKF78_BUTCHER_TABLEAU::RKa[target_stage],
                                                                   dyn_dt,
...
template<int target_stage>
inline double ER7_UTILS_ALWAYS_INLINE
rkf78_generalized_step_intermediate_step(GeneralizedPositionStepFunctions::DexpinvTransformVelocity xform_fun,
                                         ...
                                         double * ER7_UTILS_RESTRICT position)
{
    ...
    integ_utils::weighted_sum<target_stage>(posdot_hist,
                                            RKF78_BUTCHER_TABLEAU::RKa[target_stage],
                                            dyn_dt,
                                            vel_size,
                                            dtheta);
    ...
    integ_utils::weighted_step_save_deriv<target_stage>(init_vel,
                                                        accel,
                                                        RKF78_BUTCHER_TABLEAU::RKa[target_stage],
                                                        dyn_dt,
                                                        vel_size,
...
RKFehlberg78SecondOrderODEIntegrator::RKFehlberg78SecondOrderODEIntegrator(unsigned int size,
...
RKFehlberg78GeneralizedStepSecondOrderODEIntegrator * RKFehlberg78GeneralizedStepSecondOrderODEIntegrator::create_copy()
    const
{
    return alloc::replicate_object(*this);
}
...
// position.
IntegratorResult RKFehlberg78SimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                       ...
                                                                       double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 1:
            integ_utils::inplace_two_state_euler_step_save_all(accel,
        ...
        case 2:
            step_factor = rkf78_simple_intermediate_step<2>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 3:
            step_factor = rkf78_simple_intermediate_step<3>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 4:
            step_factor = rkf78_simple_intermediate_step<4>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 5:
            step_factor = rkf78_simple_intermediate_step<5>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 6:
            step_factor = rkf78_simple_intermediate_step<6>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 7:
            step_factor = rkf78_simple_intermediate_step<7>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 8:
            step_factor = rkf78_simple_intermediate_step<8>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 9:
            step_factor = rkf78_simple_intermediate_step<9>(dyn_dt,
                                                            state_size,
                                                            init_pos,
                                                            init_vel,
                                                            accel,
        ...
        case 10:
            step_factor = rkf78_simple_intermediate_step<10>(dyn_dt,
                                                             state_size,
                                                             init_pos,
                                                             init_vel,
                                                             accel,
        ...
        case 11:
            step_factor = rkf78_simple_intermediate_step<11>(dyn_dt,
                                                             state_size,
                                                             init_pos,
                                                             init_vel,
                                                             accel,
        ...
        case 12:
            step_factor = rkf78_simple_intermediate_step<12>(dyn_dt,
                                                             state_size,
                                                             init_pos,
                                                             init_vel,
                                                             accel,
        ...
        case 13:
            integ_utils::two_state_weighted_step<13>(init_pos,
                                                     init_vel,
                                                     accel,
                                                     posdot_hist,
                                                     veldot_hist,
                                                     RKF78_BUTCHER_TABLEAU::RKb8,
                                                     dyn_dt,
                                                     state_size[0],
                                                     position,
                                                     velocity);
                                                                                 ...
                                                                                 double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 1:
            ...
            integ_utils::inplace_two_state_euler_step_save_pos_vel_acc(posdot_hist[0],
                                                                       accel,
                                                                       RKF78_BUTCHER_TABLEAU::RKa[1][0] * dyn_dt,
                                                                       state_size,
                                                                       init_pos,
        ...
        // Update state per RKF78 RKa[target_stage] (target_stage elements).
        case 2:
            step_factor = rkf78_generalized_deriv_intermediate_step<2>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 3:
            step_factor = rkf78_generalized_deriv_intermediate_step<3>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 4:
            step_factor = rkf78_generalized_deriv_intermediate_step<4>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 5:
            step_factor = rkf78_generalized_deriv_intermediate_step<5>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 6:
            step_factor = rkf78_generalized_deriv_intermediate_step<6>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 7:
            step_factor = rkf78_generalized_deriv_intermediate_step<7>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 8:
            step_factor = rkf78_generalized_deriv_intermediate_step<8>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 9:
            step_factor = rkf78_generalized_deriv_intermediate_step<9>(compute_posdot,
                                                                       dyn_dt,
                                                                       state_size,
                                                                       init_pos,
                                                                       init_vel,
        ...
        case 10:
            step_factor = rkf78_generalized_deriv_intermediate_step<10>(compute_posdot,
                                                                        dyn_dt,
                                                                        state_size,
                                                                        init_pos,
                                                                        init_vel,
        ...
        case 11:
            step_factor = rkf78_generalized_deriv_intermediate_step<11>(compute_posdot,
                                                                        dyn_dt,
                                                                        state_size,
                                                                        init_pos,
                                                                        init_vel,
        ...
        case 12:
            step_factor = rkf78_generalized_deriv_intermediate_step<12>(compute_posdot,
                                                                        dyn_dt,
                                                                        state_size,
                                                                        init_pos,
                                                                        init_vel,
                                                                                ...
                                                                                double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 13:
            ...
            integ_utils::weighted_step<13>(init_vel,
                                           accel,
                                           veldot_hist,
                                           RKF78_BUTCHER_TABLEAU::RKb8,
                                           dyn_dt,
