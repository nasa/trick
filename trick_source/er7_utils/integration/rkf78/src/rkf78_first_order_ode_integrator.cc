...
RKFehlberg78FirstOrderODEIntegrator::RKFehlberg78FirstOrderODEIntegrator(unsigned int size,
...
IntegratorResult RKFehlberg78FirstOrderODEIntegrator::integrate(double dt,
                                                                ...
                                                                double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 1:
            integ_utils::inplace_euler_step_save_both(velocity,
                                                      RKF78_BUTCHER_TABLEAU::RKa[1][0] * dt,
                                                      state_size,
                                                      init_state,
                                                      deriv_hist[0],
                                                      position);
        ...
        case 2:
            integ_utils::weighted_step_save_deriv<2>(init_state,
                                                     velocity,
        ...
        case 3:
            integ_utils::weighted_step_save_deriv<3>(init_state,
                                                     velocity,
        ...
        case 4:
            integ_utils::weighted_step_save_deriv<4>(init_state,
                                                     velocity,
        ...
        case 5:
            integ_utils::weighted_step_save_deriv<5>(init_state,
                                                     velocity,
        ...
        case 6:
            integ_utils::weighted_step_save_deriv<6>(init_state,
                                                     velocity,
        ...
        case 7:
            integ_utils::weighted_step_save_deriv<7>(init_state,
                                                     velocity,
        ...
        case 8:
            integ_utils::weighted_step_save_deriv<8>(init_state,
                                                     velocity,
        ...
        case 9:
            integ_utils::weighted_step_save_deriv<9>(init_state,
                                                     velocity,
        ...
        case 10:
            integ_utils::weighted_step_save_deriv<10>(init_state,
                                                      velocity,
        ...
        case 11:
            integ_utils::weighted_step_save_deriv<11>(init_state,
                                                      velocity,
        ...
        case 12:
            integ_utils::weighted_step_save_deriv<12>(init_state,
                                                      velocity,
        ...
        case 13:
            integ_utils::weighted_step<13>(init_state,
                                           velocity,
                                           deriv_hist,
