...
namespace er7_utils
{
    ...
    RKFehlberg78FirstOrderODEIntegrator::RKFehlberg78FirstOrderODEIntegrator(void)
        : Er7UtilsDeletable()
    ...
    RKFehlberg78FirstOrderODEIntegrator* RKFehlberg78FirstOrderODEIntegrator::create_copy() const
    {
        return alloc::replicate_object(*this);
    }

    // Non-throwing swap.
    void RKFehlberg78FirstOrderODEIntegrator::swap(RKFehlberg78FirstOrderODEIntegrator& other)
    {
    ...
    IntegratorResult RKFehlberg78FirstOrderODEIntegrator::integrate(double dt, unsigned int target_stage,
        const double* ER7_UTILS_RESTRICT velocity, double* ER7_UTILS_RESTRICT position)
    {
        ...
        case 1:
            integ_utils::inplace_euler_step_save_both(
                velocity, RKF78_BUTCHER_TABLEAU::RKa[1][0] * dt, state_size, init_state, deriv_hist[0], position);
        ...
        case 2:
            integ_utils::weighted_step_save_deriv<2>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[2], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[2];
            break;

        case 3:
            integ_utils::weighted_step_save_deriv<3>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[3], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[3];
            break;

        case 4:
            integ_utils::weighted_step_save_deriv<4>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[4], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[4];
            break;

        case 5:
            integ_utils::weighted_step_save_deriv<5>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[5], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[5];
            break;

        case 6:
            integ_utils::weighted_step_save_deriv<6>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[6], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[6];
            break;

        case 7:
            integ_utils::weighted_step_save_deriv<7>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[7], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[7];
            break;

        case 8:
            integ_utils::weighted_step_save_deriv<8>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[8], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[8];
            break;

        case 9:
            integ_utils::weighted_step_save_deriv<9>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[9], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[9];
            break;

        case 10:
            integ_utils::weighted_step_save_deriv<10>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[10], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[10];
            break;

        case 11:
            integ_utils::weighted_step_save_deriv<11>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[11], dt, state_size, deriv_hist, position);
            step_factor = RKF78_BUTCHER_TABLEAU::RKc[11];
            break;

        case 12:
            integ_utils::weighted_step_save_deriv<12>(
                init_state, velocity, RKF78_BUTCHER_TABLEAU::RKa[12], dt, state_size, deriv_hist, position);
        ...
        case 13:
            integ_utils::weighted_step<13>(
                init_state, velocity, deriv_hist, RKF78_BUTCHER_TABLEAU::RKb8, dt, state_size, position);
            step_factor = 1.0;
            break;
