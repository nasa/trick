...
protected:
     ...
     */
    RKFehlberg78SecondOrderODEIntegrator(const RKFehlberg78SecondOrderODEIntegrator & src);
     ...
     */
    RKFehlberg78SecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     * @param[in,out] controls       Integration controls
     */
    RKFehlberg78SecondOrderODEIntegrator(unsigned int position_size,
...
private:
     ...
     * Not implemented.
     */
    RKFehlberg78SecondOrderODEIntegrator & operator=(const RKFehlberg78SecondOrderODEIntegrator &);
};
 ...
 */
class RKFehlberg78SimpleSecondOrderODEIntegrator : public RKFehlberg78SecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RKFehlberg78SimpleSecondOrderODEIntegrator(const RKFehlberg78SimpleSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
     ...
     * @param[in,out] controls  Integration controls
     */
    RKFehlberg78SimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls)
        : Er7UtilsDeletable(),
     ...
     * @param[in] src  Object to be copied.
     */
    RKFehlberg78SimpleSecondOrderODEIntegrator & operator=(RKFehlberg78SimpleSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
 ...
 */
class RKFehlberg78GeneralizedDerivSecondOrderODEIntegrator : public RKFehlberg78SecondOrderODEIntegrator
{
    ER7_UTILS_MAKE_SIM_INTERFACES(RKFehlberg78GeneralizedDerivSecondOrderODEIntegrator)
...
public:
     ...
     * @param[in,out] controls       Integration controls
     */
    RKFehlberg78GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                                                         unsigned int velocity_size,
                                                         const GeneralizedPositionDerivativeFunctions & deriv_funs,
                                                         IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RKFehlberg78SecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
    {
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RKFehlberg78GeneralizedDerivSecondOrderODEIntegrator * create_copy() const;
 ...
 * the generalized position and generalized velocity.
 */
class RKFehlberg78GeneralizedStepSecondOrderODEIntegrator : public RKFehlberg78SecondOrderODEIntegrator
{
    ER7_UTILS_MAKE_SIM_INTERFACES(RKFehlberg78GeneralizedStepSecondOrderODEIntegrator)
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RKFehlberg78GeneralizedStepSecondOrderODEIntegrator(const RKFehlberg78GeneralizedStepSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RKFehlberg78SecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RKFehlberg78GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                                                        unsigned int velocity_size,
                                                        const GeneralizedPositionStepFunctions & step_funs,
                                                        IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RKFehlberg78SecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
    {
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RKFehlberg78GeneralizedStepSecondOrderODEIntegrator * create_copy() const;
