...
namespace er7_utils
{
    ...
    class RKFehlberg78SecondOrderODEIntegrator : public SecondOrderODEIntegrator
    {
        ...
        protected:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKFehlberg78SecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
    ...
    class RKFehlberg78GeneralizedDerivSecondOrderODEIntegrator : public RKFehlberg78SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKFehlberg78GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionDerivativeFunctions& deriv_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
    ...
    class RKFehlberg78GeneralizedStepSecondOrderODEIntegrator : public RKFehlberg78SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKFehlberg78GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
                const GeneralizedPositionStepFunctions& step_funs, IntegrationControls& controls)
                : Er7UtilsDeletable()
