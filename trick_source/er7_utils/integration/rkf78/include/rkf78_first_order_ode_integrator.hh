...
public:
     ...
     */
    RKFehlberg78FirstOrderODEIntegrator(const RKFehlberg78FirstOrderODEIntegrator & src);
     ...
     */
    RKFehlberg78FirstOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     */
    RKFehlberg78FirstOrderODEIntegrator & operator=(RKFehlberg78FirstOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
