 ...
 */
class RKGill4SimpleSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
{
...
public:
     ...
     */
    RKGill4SimpleSecondOrderODEIntegrator(const RKGill4SimpleSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
     ...
     */
    RKGill4SimpleSecondOrderODEIntegrator(unsigned int size, IntegrationControls & controls)
        : Er7UtilsDeletable(),
     ...
     * @param[in] src  Object to be copied.
     */
    RKGill4SimpleSecondOrderODEIntegrator & operator=(RKGill4SimpleSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
 ...
 */
class RKGill4GeneralizedDerivSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RKGill4GeneralizedDerivSecondOrderODEIntegrator(const RKGill4GeneralizedDerivSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RK4SecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RKGill4GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size,
                                                    unsigned int velocity_size,
                                                    const GeneralizedPositionDerivativeFunctions & deriv_funs,
                                                    IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RK4SecondOrderODEIntegrator(position_size, velocity_size, deriv_funs, controls)
    {
    }
     ...
     * @param[in] src  Object to be copied.
     */
    RKGill4GeneralizedDerivSecondOrderODEIntegrator & operator=(RKGill4GeneralizedDerivSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RKGill4GeneralizedDerivSecondOrderODEIntegrator * create_copy() const;
 ...
 */
class RKGill4GeneralizedStepSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
{
...
public:
     ...
     * @param[in] src  Object to be copied.
     */
    RKGill4GeneralizedStepSecondOrderODEIntegrator(const RKGill4GeneralizedStepSecondOrderODEIntegrator & src)
        : Er7UtilsDeletable(),
          RK4SecondOrderODEIntegrator(src)
    {
    }
     ...
     * @param[in,out] controls       Integration controls
     */
    RKGill4GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size,
                                                   unsigned int velocity_size,
                                                   const GeneralizedPositionStepFunctions & step_funs,
                                                   IntegrationControls & controls)
        : Er7UtilsDeletable(),
          RK4SecondOrderODEIntegrator(position_size, velocity_size, step_funs, controls)
    {
    }
     ...
     * @param[in] src  Object to be copied.
     */
    RKGill4GeneralizedStepSecondOrderODEIntegrator & operator=(RKGill4GeneralizedStepSecondOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
     ...
     * @return Clone of 'this'.
     */
    virtual RKGill4GeneralizedStepSecondOrderODEIntegrator * create_copy() const;
