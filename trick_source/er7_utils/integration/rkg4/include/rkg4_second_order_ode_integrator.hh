...
namespace er7_utils
{
    ...
    class RKGill4GeneralizedDerivSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKGill4GeneralizedDerivSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
    ...
    class RKGill4GeneralizedStepSecondOrderODEIntegrator : public RK4SecondOrderODEIntegrator
    {
        ...
        public:
             ...
             * @param[in,out] controls       Integration controls
             */
            RKGill4GeneralizedStepSecondOrderODEIntegrator(unsigned int position_size, unsigned int velocity_size,
