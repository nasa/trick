...
public:
     ...
     */
    RKGill4FirstOrderODEIntegrator(unsigned int size, IntegrationControls & controls);
     ...
     */
    RKGill4FirstOrderODEIntegrator & operator=(RKGill4FirstOrderODEIntegrator src)
    {
        swap(src);
        return *this;
    }
