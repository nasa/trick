...
namespace er7_utils
{
    ...
    IntegratorConstructor* RKGill4IntegratorConstructor::create_constructor(void)
    {
        return alloc::allocate_object<RKGill4IntegratorConstructor>();
    }

    // Create a duplicate of the constructor.
    IntegratorConstructor* RKGill4IntegratorConstructor::create_copy(void) const
    {
        return alloc::replicate_object(*this);
    }

    // Create an RKGill4 integration controls.
    IntegrationControls* RKGill4IntegratorConstructor::create_integration_controls(void) const
    {
    ...
    FirstOrderODEIntegrator* RKGill4IntegratorConstructor::create_first_order_ode_integrator(
        unsigned int size, IntegrationControls& controls) const
    {
        return integ_utils::allocate_integrator<RKGill4FirstOrderODEIntegrator>(size, controls);
    }

    // Create an RKGill4 state integrator for a second order ODE.
    SecondOrderODEIntegrator* RKGill4IntegratorConstructor::create_second_order_ode_integrator(
        unsigned int size, IntegrationControls& controls) const
    {
        return integ_utils::allocate_integrator<RKGill4SimpleSecondOrderODEIntegrator>(size, controls);
    }

    // Create an RKGill4 state integrator for a generalized deriv second order ODE.
    SecondOrderODEIntegrator* RKGill4IntegratorConstructor::create_generalized_deriv_second_order_ode_integrator(
    ...
    {
        return integ_utils::allocate_integrator<RKGill4GeneralizedDerivSecondOrderODEIntegrator>(
    ...
    SecondOrderODEIntegrator* RKGill4IntegratorConstructor::create_generalized_step_second_order_ode_integrator(
    ...
    {
        return integ_utils::allocate_integrator<RK4GeneralizedStepSecondOrderODEIntegrator>(
