...
{
    return integ_utils::allocate_integrator<RKGill4GeneralizedDerivSecondOrderODEIntegrator>(position_size,
                                                                                             velocity_size,
                                                                                             deriv_funs,
                                                                                             controls);
}
...
SecondOrderODEIntegrator * RKGill4IntegratorConstructor::create_generalized_step_second_order_ode_integrator(
    ...
    IntegrationControls & controls) const
{
    return integ_utils::allocate_integrator<RK4GeneralizedStepSecondOrderODEIntegrator>(position_size,
                                                                                        velocity_size,
                                                                                        step_funs,
                                                                                        controls);
}
