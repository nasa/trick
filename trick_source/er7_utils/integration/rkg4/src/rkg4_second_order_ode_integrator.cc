...
RKGill4GeneralizedDerivSecondOrderODEIntegrator * RKGill4GeneralizedDerivSecondOrderODEIntegrator::create_copy() const
{
    return alloc::replicate_object(*this);
}
...
// position.
IntegratorResult RKGill4SimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
    ...
    switch(target_stage)
    {
        ...
        case 1:
            integ_utils::inplace_two_state_euler_step_save_all(accel,
                                                               RKGill4ButcherTableau::RKa[1][0] * dyn_dt,
                                                               state_size[0],
                                                               init_pos,
                                                               init_vel,
                                                               posdot_hist[0],
        ...
        case 2:
            integ_utils::two_state_weighted_step_save_derivs<2>(init_pos,
                                                                init_vel,
                                                                accel,
        ...
        case 4:
            integ_utils::two_state_weighted_step<4>(init_pos,
                                                    init_vel,
                                                    accel,
                                                    posdot_hist,
                                                    veldot_hist,
                                                                            ...
                                                                            double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        // Update state per RKGill4 RKa[2] (two elements).
        case 2:
            integ_utils::two_state_weighted_step_save_veldot<2>(init_pos,
                                                                init_vel,
                                                                accel,
                                                                RKGill4ButcherTableau::RKa[2],
                                                                dyn_dt,
...
IntegratorResult RKGill4GeneralizedStepSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                           unsigned int target_stage,
                                                                           const double * ER7_UTILS_RESTRICT accel,
                                                                           double * ER7_UTILS_RESTRICT velocity,
                                                                           double * ER7_UTILS_RESTRICT position)
{
    ...
    switch(target_stage)
    {
        ...
        case 2:
        {
            ...
            // Integrate generalized velocity.
            integ_utils::weighted_step_save_deriv<2>(init_vel,
                                                     accel,
                                                     RKGill4ButcherTableau::RKa[2],
                                                     dyn_dt,
                                                     state_size[1],
        ...
        case 4:
        {
            ...
            // Integrate generalized velocity.
            integ_utils::weighted_step<4>(init_vel,
                                          accel,
                                          veldot_hist,
                                          RKGill4ButcherTableau::RKb,
                                          dyn_dt,
