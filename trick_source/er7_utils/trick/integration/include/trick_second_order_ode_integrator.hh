...
public:
     ...
     */
    TrickSecondOrderOdeIntegrator(const TrickSecondOrderOdeIntegrator & src,
     ...
     */
    explicit TrickSecondOrderOdeIntegrator(er7_utils::IntegratorConstructor & integ_constructor_in,
     ...
     */
    TrickSecondOrderOdeIntegrator(er7_utils::IntegratorConstructor & integ_constructor_in,
                                  int state_size,
                                  double delta_t,
                                  bool use_deriv2_in = false)
...
protected:
     ...
     */
    void set_use_deriv2(bool value)
    {
        use_deriv2 = value;
    }
