...
public:
     ...
     */
    virtual int integrate_1st_order_ode(const double * derivs_in, double * state_in_out)
    {
     ...
     */
    virtual int integrate_2nd_order_ode(const double * accel, double * velocity, double * position)
    {
        if(intermediate_step == 0)
        {
            time_0 = time;
...
protected:
     ...
     *                                  do not use this flag.
     */
    TrickIntegrator(IntegratorConstructor & integ_constructor_in,
                    int state_size,
                    double delta_t,
    ...
    const double * cached_derivs; /**< trick_units(--)@n
    ...
    const double * cached_accel; /**< trick_units(--)@n
