...
namespace er7_utils
{
     ...
     */
    class TrickIntegrator : public Trick::Integrator,
                            ...
                            protected BaseIntegrationGroup
    {
        ...
        protected:
             ...
             */
            TrickIntegrator(const TrickIntegrator& source, IntegratorConstructor& integ_constructor_in);
             ...
             */
            explicit TrickIntegrator(IntegratorConstructor& integ_constructor_in, bool use_deriv2_in = false);
             ...
             *                                  do not use this flag.
             */
            TrickIntegrator(IntegratorConstructor& integ_constructor_in, int state_size, double delta_t,
             ...
             */
            virtual void update_time(double sim_time) { time = sim_time; }
             ...
             */
            virtual double get_time_scale_factor() const { return 1.0; }
             ...
             */
            virtual double get_dt() const { return dt; }
             ...
             */
            virtual bool get_first_step_derivs_flag() const { return first_step_deriv; }
             ...
             */
            virtual void set_first_step_derivs_flag(bool value) { first_step_deriv = value; }
             ...
             */
            virtual void restore_first_step_derivs_flag() { first_step_deriv = default_first_step_deriv; }

            /**
             * Set the step number within an integration cycle.
             * @param[in] stepno      Step number
             */
            virtual void set_step_number(unsigned int stepno) { intermediate_step = stepno; }

            /**
             * Update the time model given the simulation time.
             * @param[in] sim_time Simulation time
             */
            virtual void set_time(double sim_time) { time = sim_time; }
             ...
             */
            virtual void update_integration_interface(unsigned int step_number) { intermediate_step = step_number; }
             ...
             */
            virtual IntegratorResult integrate_bodies(double cycle_dyndt, unsigned int target_stage);
            ...
            const IntegratorConstructor* const trick_integ_constructor; /**< trick_units(--)@n
