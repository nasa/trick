...
namespace er7_utils
{
    ...
    class TrickFirstOrderOdeIntegrator : public TrickIntegrator
    {
        ...
        public:
             ...
             */
            TrickFirstOrderOdeIntegrator(
                const TrickFirstOrderOdeIntegrator& src, er7_utils::IntegratorConstructor& integ_constructor_in)
             ...
             */
            explicit TrickFirstOrderOdeIntegrator(IntegratorConstructor& integ_constructor_in)
             ...
             */
            TrickFirstOrderOdeIntegrator(IntegratorConstructor& integ_constructor_in, int state_size, double delta_t)
             ...
             */
            virtual ~TrickFirstOrderOdeIntegrator(void) { deallocate_integrators(); }
        ...
        private:
             ...
             * Not implemented.
             */
            TrickFirstOrderOdeIntegrator& operator=(const TrickFirstOrderOdeIntegrator&);
    };
