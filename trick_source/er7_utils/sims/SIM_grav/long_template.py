...
vehicle.earth_grav_ctrl.degree      = DEGREE_ORDER
vehicle.earth_grav_ctrl.order       = DEGREE_ORDER 
...
vehicle.trick_technique = trick.TRICK_TECHNIQUE
vehicle.er7_technique = trick.ER7_TECHNIQUE
vehicle.use_trick_integ = USE_TRICK_INTEG
end_time = 24*86400.0 / DERIVS_PER_STEP
