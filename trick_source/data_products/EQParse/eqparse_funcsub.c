...
#define NUM_FUNCTIONS 38
    char function_names[NUM_FUNCTIONS][32] = {"abs",  "acosh",  "acos",    "asinh",  "asin",  "atanh", "atan2",
                                              "atan", "besj0",  "besj1",   "besy0",  "besy1", "ceil",  "cosh",
                                              "cos",  "div",    "erfc",    "erf",    "exp",   "floor", "gamma",
                                              "int",  "inverf", "invnorm", "lgamma", "log10", "log",   "norm",
                                              "rand", "sgn",    "sinh",    "sin",    "sqrt",  "tanh",  "tan",
                                              "PI",   "M_PI",   "M_E"};
