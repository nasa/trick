...
TEST_F(DSTest, DataStream_Ascii)
{
    ...
    // GET FILE NAME
    output = run('f');
    result = strcmp_IgnoreWhiteSpace("getFileName : filename = \"../TEST_DATA/RUN_ASCII/log_helios.csv\"",
                                     output.c_str());
    EXPECT_EQ(result, 0);
    ...
    // GET
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 0     value = 351.283     return = 1", output.c_str());
    EXPECT_EQ(result, 0);

    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 1     value = 351.289     return = 1", output.c_str());
    EXPECT_EQ(result, 0);

    // PEEK
    output = run('p');
    result = strcmp_IgnoreWhiteSpace("peek : time = 2     value= 351.295     return = 1", output.c_str());
    EXPECT_EQ(result, 0);
    ...
    output = run('s');
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 3     value= 351.301    return = 1", output.c_str());
    EXPECT_EQ(result, 0);
...
TEST_F(DSTest, DataStream_Binary)
{
    ...
    // GET FILE NAME
    output = run('f');
    result = strcmp_IgnoreWhiteSpace("getFileName : filename = \"../TEST_DATA/RUN_BINARY/log_helios.trk\"",
                                     output.c_str());
    EXPECT_EQ(result, 0);
    ...
    // GET
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 0     value = -36.7426     return = 1", output.c_str());
    EXPECT_EQ(result, 0);

    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 1     value = -36.743     return = 1", output.c_str());
    EXPECT_EQ(result, 0);

    // PEEK
    output = run('p');
    result = strcmp_IgnoreWhiteSpace("peek : time = 2     value= -36.7434     return = 1", output.c_str());
    EXPECT_EQ(result, 0);
    ...
    output = run('s');
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 3     value= -36.7438     return = 1", output.c_str());
    EXPECT_EQ(result, 0);
...
TEST_F(DSTest, DataStream_MatLab)
{
    ...
    // GET FILE NAME
    output = run('f');
    result = strcmp_IgnoreWhiteSpace("getFileName : filename= \"../TEST_DATA/RUN_MATLAB/nasa_p1.mat\"", output.c_str());
    EXPECT_EQ(result, 0);
    ...
    // GET
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 0     value = -210.146     return = 1", output.c_str());
    EXPECT_EQ(result, 0);

    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 0.05     value = -210.146     return = 1", output.c_str());
    EXPECT_EQ(result, 0);

    // PEEK
    output = run('p');
    result = strcmp_IgnoreWhiteSpace("peek : time = 0.1     value= -210.146     return = 1", output.c_str());
    EXPECT_EQ(result, 0);
    ...
    output = run('s');
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 0.15     value= -210.146     return = 1", output.c_str());
    EXPECT_EQ(result, 0);
...
TEST_F(DSTest, DataStream_DPCUnitConv)
{
    ...
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 0     value = 1.56605     return = 1", output.c_str());
    EXPECT_EQ(result, 0);
...
TEST_F(DSTest, DataStream_DPCTimeCstr)
{
    ...
    output = run('g');
    result = strcmp_IgnoreWhiteSpace("get : time = 5	    value = 5     return = 0", output.c_str());
    EXPECT_EQ(result, 0);

    output = run('p');
    result = strcmp_IgnoreWhiteSpace("peek: Reached end of stream. No value to peek.     return = 0", output.c_str());
    EXPECT_EQ(result, 0);
