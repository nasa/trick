...
class DPC_plot
{
    public:
         ...
         */
        int getNumCurves() { return ((int)curve_list.size()); }

        /**
         * Set the title of the plot.
         */
        int setTitle(const char* in_title) { return (relation->setTitle(in_title)); }
         ...
         */
        const char* getAttribute(const char* key) { return (relation->AttributeValue(key)); }

        /**
         * Return the title of the plot, which may be NULL.
         */
        const char* getTitle() { return (relation->getTitle()); }

        /**
         * Return the X-axis label of the plot, which may be empty.
         */
        std::string getXLabel() { return (relation->getXAxisLabel()); }

        /**
         * Return the Y-axis label of the plot, which may be empty.
         */
        std::string getYLabel() { return (relation->getYAxisLabel()); }

        /**
         * Return the Y-axis format of the plot.
         */
        const char* getYFormat() { return (relation->getYAxisFormat()); }
