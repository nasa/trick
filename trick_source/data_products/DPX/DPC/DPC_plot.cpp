...
// MEMBER FUNCTION
DPV_pointer DPC_plot::render(DPV_view* view, DPV_pointer parent_view_data)
{
    if (view != NULL)
    {
        DPC_curve* curve;
...
double DPC_plot::getXMin() { return xMin; }
...
double DPC_plot::getXMax() { return xMax; }
...
double DPC_plot::getYMin() { return yMin; }
...
double DPC_plot::getYMax() { return yMax; }
