...
// CONSTRUCTOR
DPC_TimeCstrDataStream::DPC_TimeCstrDataStream(DataStream* in_ds, DPM_time_constraints* time_constraints)
{
...
// MEMBER FUNCTION
std::string DPC_TimeCstrDataStream::getFileName() { return ds->getFileName(); }

// MEMBER FUNCTION
std::string DPC_TimeCstrDataStream::getUnit() { return ds->getUnit(); }

// MEMBER FUNCTION
std::string DPC_TimeCstrDataStream::getTimeUnit() { return ds->getTimeUnit(); }
