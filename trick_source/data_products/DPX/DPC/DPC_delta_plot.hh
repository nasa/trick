...
class DPC_delta_plot : public DPC_plot
{
    public:
         ...
         */
        DPC_delta_plot(DPC_datastream_supplier* DS_Supplier, DPM_run* Run1, DPM_run* Run2, DPM_relation* Relation,
            DPM_time_constraints* parent_time_constraints);

        /**
         * Constructor for Contrast session
         */
        DPC_delta_plot(DPC_datastream_supplier* DS_Supplier, std::vector<DPM_run*>* RunListp, DPM_relation* Relation,
            DPM_time_constraints* parent_time_constraints);
