...
class DPC_curve
{
    public:
         ...
         */
        const char* getXVarName() { return (x_var->getName()); };

        /**
         * Return the name of the X variable.
         */
        std::string getXVarShortName() { return (x_var->getShortName()); };

        /**
         * Return the name of the Y variable.
         */
        const char* getYVarName() { return (y_var->getName()); }

        /**
         * Return the name of the Y variable.
         */
        std::string getYVarShortName() { return (y_var->getShortName()); };
         ...
         */
        virtual const char* getDataSrcLbl() { return ("None"); }

        /**
         * Return the value of the attribute associated with the
         * given key for the X variable.
         */
        const char* getXAttribute(const char* key) { return (x_var->AttributeValue(key)); }

        /**
         * Return the value of the attribute associated with the
         * given key for the Y variable.
         */
        const char* getYAttribute(const char* key) { return (y_var->AttributeValue(key)); }

        /**
         * Get the next (X, Y) pair for the curve.
         * @return 1 if data was returned in x_value and y_value, 0 if there is no more data.
         */
        virtual int getXY(double*, double*) { return 0; }
