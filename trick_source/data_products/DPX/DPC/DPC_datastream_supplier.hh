...
class DPC_datastream_supplier
{
    public:
         ...
         */
        DataStream* getDataStream(const char* VarName, const char* ToUnits, const char* FromUnitsHint, DPM_run* Run,
            DPM_time_constraints* time_constraints);

        DataStream* getDataStream(const char* VarName, const char* ToUnits, const char* FromUnitsHint,
            const char* Machine, const unsigned short Port, DPM_time_constraints* time_constraints);
