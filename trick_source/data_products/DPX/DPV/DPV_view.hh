...
class DPV_view
{
    public:
         ...
         */
        virtual DPV_pointer render_product(DPC_product*) { return ((DPV_pointer)NULL); };
         ...
         */
        virtual DPV_pointer render_page(DPV_pointer, DPC_page*) { return ((DPV_pointer)NULL); };
         ...
         *        viewable representation is to be rendered.
         */
        virtual DPV_pointer render_plot(DPV_pointer, DPC_plot*) { return ((DPV_pointer)NULL); };
         ...
         *        viewable representation is to be rendered.
         */
        virtual DPV_pointer render_table(DPV_pointer, DPC_table*) { return ((DPV_pointer)NULL); };
         ...
         */
        virtual DPV_pointer render_curve(DPV_pointer, DPC_curve*) { return ((DPV_pointer)NULL); };
