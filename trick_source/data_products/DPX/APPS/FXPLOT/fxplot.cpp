...
Widget Create_Main_Window(Widget top)
{
    ...
    label_widget_1 = XtVaCreateManagedWidget("ProductListLabel",
                                             xmLabelGadgetClass,
                                             form_widget,
                                             XmNlabelString,
                                             label_str,
    ...
    label_widget_2 = XtVaCreateManagedWidget("PageListLabel",
                                             xmLabelGadgetClass,
                                             form_widget,
                                             XmNlabelString,
                                             label_str,
    ...
    label_widget_3 = XtVaCreateManagedWidget("TableListLabel",
                                             xmLabelGadgetClass,
                                             form_widget,
                                             XmNlabelString,
                                             label_str,
    ...
    scrolled_w_widget_1 = XtVaCreateManagedWidget("scrolled_w_1",
                                                  ...
                                                  XmATTACH_FORM,
                                                  NULL);
    scrolled_w_widget_2 = XtVaCreateManagedWidget("scrolled_w_2",
                                                  xmScrolledWindowWidgetClass,
                                                  form_widget,
                                                  XmNscrollingPolicy,
                                                  XmAUTOMATIC,
                                                  ...
                                                  XmATTACH_FORM,
                                                  NULL);
    scrolled_w_widget_3 = XtVaCreateManagedWidget("scrolled_w_3",
                                                  xmScrolledWindowWidgetClass,
                                                  form_widget,
                                                  XmNscrollingPolicy,
                                                  XmAUTOMATIC,
    ...
    product_list_widget = XtVaCreateManagedWidget("list_of_products",
                                                  xmListWidgetClass,
                                                  scrolled_w_widget_1,
                                                  XmNselectionPolicy,
                                                  XmSINGLE_SELECT,
    ...
    page_list_widget = XtVaCreateManagedWidget("list_of_pages",
                                               xmListWidgetClass,
                                               scrolled_w_widget_2,
                                               XmNselectionPolicy,
                                               XmSINGLE_SELECT,
    ...
    table_list_widget = XtVaCreateManagedWidget("list_of_tables",
                                                xmListWidgetClass,
                                                scrolled_w_widget_3,
                                                XmNselectionPolicy,
                                                XmSINGLE_SELECT,
