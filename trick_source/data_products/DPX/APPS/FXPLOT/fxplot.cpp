...
void terminate_app_callback(Widget w, XtPointer client_data, XtPointer call_data) { run_app = 0; }
...
void pdf_all(Widget w, XtPointer client_data, XtPointer call_data)
{
    ...
    {
        post_dialog(
            toplevel, XmDIALOG_ERROR, "Unable to generate a temporary file name for some mind boggling reason.");
        return;
    }
                ...
                if (ret != 0) {
                        ...
                        if (ret != 0) {
                                ...
                                if (ret != 0) {
                                        ...
                                        std::cout << "Couldn't find a proper application to view the PDF file.\nThe PDF
        file of all plots is saved as fxplot.PDF!\n";
                                }
                        }
                }
        }*/
...
Widget Create_Main_Window(Widget top)
{
    ...
    main_window = XtVaCreateManagedWidget("main_w", xmMainWindowWidgetClass, top, NULL);
    ...
    XtVaCreateManagedWidget(
        "file", xmCascadeButtonWidgetClass, menu_bar, XmNlabelString, label_str, XmNsubMenuId, file_pull_down, NULL);
    ...
    form_widget = XtVaCreateWidget(
        "topform", xmFormWidgetClass, main_window, XmNfractionBase, 3, XmNwidth, 400, XmNheight, 200, NULL);

    label_str      = XmStringCreateLocalized((char*)"Products");
    label_widget_1 = XtVaCreateManagedWidget("ProductListLabel", xmLabelGadgetClass, form_widget, XmNlabelString,
        label_str, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 0,
        XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 1, XmNbottomAttachment, XmATTACH_NONE, NULL);
    XmStringFree(label_str);

    label_str      = XmStringCreateLocalized((char*)"Pages");
    label_widget_2 = XtVaCreateManagedWidget("PageListLabel", xmLabelGadgetClass, form_widget, XmNlabelString,
        label_str, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1,
        XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 2, XmNbottomAttachment, XmATTACH_NONE, NULL);
    XmStringFree(label_str);

    label_str      = XmStringCreateLocalized((char*)"Tables");
    label_widget_3 = XtVaCreateManagedWidget("TableListLabel", xmLabelGadgetClass, form_widget, XmNlabelString,
        label_str, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 2,
        XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 3, XmNbottomAttachment, XmATTACH_NONE, NULL);
    XmStringFree(label_str);

    scrolled_w_widget_1 = XtVaCreateManagedWidget("scrolled_w_1", xmScrolledWindowWidgetClass, form_widget,
        XmNscrollingPolicy, XmAUTOMATIC, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, label_widget_1,
        XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 0, XmNrightAttachment, XmATTACH_POSITION,
        XmNrightPosition, 1, XmNbottomAttachment, XmATTACH_FORM, NULL);
    scrolled_w_widget_2 = XtVaCreateManagedWidget("scrolled_w_2", xmScrolledWindowWidgetClass, form_widget,
        XmNscrollingPolicy, XmAUTOMATIC, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, label_widget_2,
        XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 1, XmNrightAttachment, XmATTACH_POSITION,
        XmNrightPosition, 2, XmNbottomAttachment, XmATTACH_FORM, NULL);
    scrolled_w_widget_3 = XtVaCreateManagedWidget("scrolled_w_3", xmScrolledWindowWidgetClass, form_widget,
        XmNscrollingPolicy, XmAUTOMATIC, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, label_widget_3,
        XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 2, XmNrightAttachment, XmATTACH_POSITION,
        XmNrightPosition, 3, XmNbottomAttachment, XmATTACH_FORM, NULL);

    product_list_widget = XtVaCreateManagedWidget("list_of_products", xmListWidgetClass, scrolled_w_widget_1,
        XmNselectionPolicy, XmSINGLE_SELECT, XmNheight, 500, NULL);
    ...
    page_list_widget = XtVaCreateManagedWidget("list_of_pages", xmListWidgetClass, scrolled_w_widget_2,
        XmNselectionPolicy, XmSINGLE_SELECT, XmNheight, 500, NULL);
    ...
    table_list_widget = XtVaCreateManagedWidget("list_of_tables", xmListWidgetClass, scrolled_w_widget_3,
        XmNselectionPolicy, XmSINGLE_SELECT, XmNheight, 500, NULL);
...
int main(int argc, char* argv[])
{
    ...
    for (product_ix = 0; product_ix < n_product_files; product_ix++)
    {
        ...
        {
            std::cerr << "ERROR: Unable to create the product specified by file: \"" << product_file_name << "\""
                      << std::endl;
            product = NULL;
        }
