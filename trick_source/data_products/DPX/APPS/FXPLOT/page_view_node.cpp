...
void PageViewNode::pdf_file_cb(Widget w, XtPointer client_data, XtPointer call_data)
{
    ...
    {
        post_dialog(page_view_node->toplevel,
                    XmDIALOG_ERROR,
...
PageViewNode::PageViewNode(Widget Toplevel, DPC_page * Page, int Xpos, int Ypos, int Width, int Height)
{
    ...
    // ----------------------------------------------
    main_form_widget = XtVaCreateWidget("PageForm",
                                        xmFormWidgetClass,
                                        dialog_shell_widget,
                                        XmNresizePolicy,
                                        XmRESIZE_GROW,
    ...
    {
        print_button_widget = XtVaCreateManagedWidget("PrintPage",
    ...
    if(pixmap == XmUNSPECIFIED_PIXMAP)
    {
        expand_plot_button_widget = XtVaCreateManagedWidget("Expand",
                                                            xmPushButtonWidgetClass,
                                                            ctrls_form_widget,
                                                            XmNleftAttachment,
                                                            XmATTACH_WIDGET,
    ...
    pdf_button_widget = XtVaCreateManagedWidget("PDF",
                                                xmPushButtonWidgetClass,
                                                ctrls_form_widget,
                                                XmNleftAttachment,
                                                XmATTACH_WIDGET,
                                                XmNleftWidget,
                                                expand_plot_button_widget,
                                                NULL);
    ...
    if(pixmap == XmUNSPECIFIED_PIXMAP)
    {
        trick_label = XtVaCreateManagedWidget("Trick",
                                              xmLabelGadgetClass,
                                              ctrls_form_widget,
                                              XmNrightAttachment,
                                              XmATTACH_FORM,
    ...
    plots_form_widget = XtVaCreateManagedWidget("PlotsForm",
                                                xmFormWidgetClass,
                                                main_form_widget,
                                                XmNresizePolicy,
                                                XmRESIZE_GROW,
