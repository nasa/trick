...
// MEMBER FUNCTION
DPV_pointer fermi_view::render_page(DPV_pointer parent_data, DPC_page * page)
{
...
// MEMBER FUNCTION
DPV_pointer fermi_view::render_table(DPV_pointer parent_data, DPC_table * table)
{
...
// MEMBER FUNCTION
DPV_pointer fermi_view::render_plot(DPV_pointer parent_data, DPC_plot * plot)
{
    PageViewNode * page_view_node;
...
DPV_pointer fermi_view::update_plot(DPV_pointer view_data, DPC_plot * plot)
{
...
// MEMBER FUNCTION
DPV_pointer fermi_view::render_curve(DPV_pointer parent_data, DPC_curve * abstract_curve)
{
...
// MEMBER FUNCTION
int fermi_view::update_curve(DPV_pointer parent_data, DPC_curve * curve)
{
    XYCurve * fermi_curve;
...
void fermi_view::update_finalize_plot_view(DPV_pointer plot_view)
{
    ...
    XYSetContents(plot_view_node->xy_widget, plot_view_node->curves, plot_view_node->n_curves, XY_RESCALE);
}
