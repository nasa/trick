...
static void print_plot_cb(Widget w, XtPointer client_data, XtPointer call_data)
{
    ...
    {
        post_dialog(plot_view_node->toplevel,
                    XmDIALOG_ERROR,
...
PlotViewNode::PlotViewNode(Widget Toplevel, Widget Parent_form, DPC_plot * Plot)
{
    ...
    {
        toggle1 = XtVaCreateManagedWidget("X",
    ...
    if(pixmap == XmUNSPECIFIED_PIXMAP)
    {
        toggle2 = XtVaCreateManagedWidget("V",
                                          xmToggleButtonGadgetClass,
                                          ctrls_form_widget,
                                          XmNleftAttachment,
                                          XmATTACH_WIDGET,
    ...
    if(pixmap == XmUNSPECIFIED_PIXMAP)
    {
        toggle3 = XtVaCreateManagedWidget("G",
                                          xmToggleButtonGadgetClass,
                                          ctrls_form_widget,
                                          XmNleftAttachment,
                                          XmATTACH_WIDGET,
    ...
    if(pixmap == XmUNSPECIFIED_PIXMAP)
    {
        toggle4 = XtVaCreateManagedWidget("Sel",
                                          xmToggleButtonGadgetClass,
                                          ctrls_form_widget,
                                          XmNleftAttachment,
                                          XmATTACH_WIDGET,
    ...
    if(pixmap == XmUNSPECIFIED_PIXMAP)
    {
        print_button = XtVaCreateManagedWidget("PrintPlot",
