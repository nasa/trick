...
// MEMBER FUNCTION
DPV_pointer gnuplot_view::render_page(DPV_pointer parent_data, DPC_page* page)
{
...
// MEMBER FUNCTION
DPV_pointer gnuplot_view::render_table(DPV_pointer parent_data, DPC_table* table) { return NULL; }

// MEMBER FUNCTION
DPV_pointer gnuplot_view::render_plot(DPV_pointer parent_data, DPC_plot* plot)
{
    ...
    plot_view_node = new GPViewPlotNode(toplevel, &page_view_node->textbuf, plot, plot_number);
...
DPV_pointer gnuplot_view::update_plot(DPV_pointer view_data, DPC_plot* plot)
{
...
// MEMBER FUNCTION
DPV_pointer gnuplot_view::render_curve(DPV_pointer parent_data, DPC_curve* abstract_curve)
{
    ...
    curve_view_node = new GPViewCurveNode(toplevel, plot_view_node->textbuf, abstract_curve, curve_number);
...
int gnuplot_view::update_curve(DPV_pointer parent_data, DPC_curve* curve)
{
