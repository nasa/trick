...
// MEMBER FUNCTION
const char* DPM_extfn::getFName() { return ((const char*)fname); }

// MEMBER FUNCTION
int DPM_extfn::NumberOfInputs() { return (inputs->NumberOfInputs()); }

// MEMBER FUNCTION
const char* DPM_extfn::getInputVar(unsigned int index) { return (inputs->getVarName(index)); }

// MEMBER FUNCTION
int DPM_extfn::NumberOfOutputs() { return (outputs->NumberOfOutputs()); }

// MEMBER FUNCTION
const char* DPM_extfn::getOutputVar(unsigned int index) { return (outputs->getVarName(index)); }

// MEMBER FUNCTION
const char* DPM_extfn::getOutputUnits(unsigned int index) { return (outputs->getUnits(index)); }
