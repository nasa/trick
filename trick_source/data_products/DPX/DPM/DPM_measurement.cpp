...
int DPM_measurement::Initialize(xmlNode* base_node)
{
    ...
    else
    {
        ...
        {
            std::cerr << "ERROR: <measurement> specification contains an invalid <units> specification: \"" << unitspec
                      << "\"." << std::endl;
            return -1;
        }
...
// MEMEBR FUNCTION
const char* DPM_measurement::getVarName() { return var; }

// MEMEBR FUNCTION
const char* DPM_measurement::getUnits() { return unitspec; }
