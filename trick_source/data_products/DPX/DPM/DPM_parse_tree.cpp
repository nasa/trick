    ...
    else
    {
        ...
        else
        {
            std::cerr << std::endl
                      ...
                      << "It will therefore be parsed without validation." << std::endl
                      << std::endl;
...
// MEMBER FUNCTION
xmlNode* DPM_parse_tree::getRootNode() { return (xmlDocGetRootElement(doc)); }

// MEMBER FUNCTION
int DPM_parse_tree::is_valid() { return (valid); }
