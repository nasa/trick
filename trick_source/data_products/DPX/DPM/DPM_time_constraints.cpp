...
// CONSTRUCTOR.
DPM_time_constraints::DPM_time_constraints() { Initialize(); }

// CONSTRUCTOR.
DPM_time_constraints::DPM_time_constraints(double start, double stop, double freq)
{
    Initialize();
    if (start >= 0.0)
    {
...
// MEMBER FUNCTION
double DPM_time_constraints::getStart() { return (start_time); }

// MEMBER FUNCTION
double DPM_time_constraints::getStop() { return (stop_time); }
...
// MEMBER FUNCTION
double DPM_time_constraints::getFrequency() { return (frequency); }

// MEMBER FUNCTION
DPM_time_constraints operator+(DPM_time_constraints& tc1, DPM_time_constraints& tc2)
{
