...
DPV_pointer test_view::create_page_view(DPV_pointer parent_data, DPC_page * page)
{
...
DPV_pointer test_view::create_plot_view(DPV_pointer parent_data, DPC_plot * plot)
{
    long pdata = (long)parent_data;
...
DPV_pointer test_view::create_table_view(DPV_pointer parent_data, DPC_table * table)
{
    int n_columns, colix;
    int i, j;
    double * values;
...
DPV_pointer test_view::create_curve_view(DPV_pointer parent_data, DPC_curve * curve)
{
    int i;
    long pdata = (long)parent_data;
    const char * temp_cstr;
