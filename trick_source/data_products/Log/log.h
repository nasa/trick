...
class LogData
{
    ...
    public:
        ...
        int getValueAtTime(int timeIdx, double time, int valIdx, double* value);
        ...
        // Stats (Min/Max...)
        void getMinMaxStats(int paramIdx, double* timeMin, double* min, double* timeMax, double* max);
...
class LogGroup
{
    ...
    public:
        ...
        void getMinMaxStats(const char* paramName, double* timeMin, double* min, double* timeMax, double* max);

        // Get value of a parameter at a given time stamp
        int getValueAtTime(const char* paramName, double time, double* value);
...
{
    public:
        IterPreserveTime(LogGroup* lg, set<int>& logIndices, double freq, double startTime, double stoptime);
        ~IterPreserveTime();
...
{
    public:
        IterMultiRun(LogGroup* lg1, set<int>& logIndices1, LogGroup* lg2, set<int>& logIndices2, double freq,
...
{
    public:
        IterOverLogGroups(LogMultiGroup* lmg, vector<string>& runDirs, vector<string>& paramNames);
