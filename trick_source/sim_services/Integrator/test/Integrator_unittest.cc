...
{
    public:
        int derivative() { return 1; }

        int integration() { return 2; }

        int pre_integration() { return 3; }

        int post_integration() { return 4; }

        double dynamic_event() { return 1.1; }
...
namespace Trick
{
    class Donna_Integrator : public Integrator
    {
        public:
            Donna_Integrator() { };
            Donna_Integrator(int State_size, double Dt) { initialize(State_size, Dt); }
