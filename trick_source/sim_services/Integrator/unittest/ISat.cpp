...
void calc_gravity(SATELLITE * S, PLANET * P, double * G)
{
    double distance;
    double pos_hat[3];
    double g_force_mag;
    ...
    distance = sqrt(S->pos[0] * S->pos[0] + S->pos[1] * S->pos[1] + S->pos[2] * S->pos[2]);
...
int main(int argc, const char * argv[])
{
    ...
    orb_elem_to_intl(&orbital_elements, &planet, satellite.pos, satellite.vel);
    ...
    { // sim loop
        ...
        { // Integration Loop
            ...
            std::cout << "step #" << I->intermediate_step << std::endl;
            std::cout.flush();
