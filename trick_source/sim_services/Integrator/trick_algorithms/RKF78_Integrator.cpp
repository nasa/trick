...
int Trick::RKF78_Integrator::integrate()
{
    ...
    static double b10_78[] = {0.0, -91.0 / 108.0, 0.0, 0.0, 23.0 / 108.0, -976.0 / 135.0, 311.0 / 54.0, -19.0 / 60.0,
        17.0 / 6.0, -1.0 / 12.0};
    static double b12_78[]
        = {0.0, 3.0 / 205.0, 0.0, 0.0, 0.0, 0.0, -6.0 / 41.0, -3.0 / 205.0, -3.0 / 41.0, 3.0 / 41.0, 6.0 / 41.0};
    ...
    case 1:
        ...
        b_2 = b3_78[2] * dt;
        for (i = 0; i < num_state; i++)
            state_ws[2][i] = state_ws[0][i] + deriv[0][i] * b_1 + deriv[1][i] * b_2;
        intermediate_step = 2;
        break;
    ...
    case 2:
        ...
        b_3 = b4_78[3] * dt;
        for (i = 0; i < num_state; i++)
            state_ws[3][i] = state_ws[0][i] + deriv[0][i] * b_1 + deriv[2][i] * b_3;
        intermediate_step = 3;
        break;
    ...
    case 3:
        ...
        b_3 = b5_78[3] * dt;
        for (i = 0; i < num_state; i++)
            state_ws[4][i] = state_ws[0][i] + deriv[0][i] * b_1 + (deriv[2][i] - deriv[3][i]) * b_3;
        intermediate_step = 4;
        break;
    ...
    case 4:
        ...
        b_5 = b6_78[5] * dt;
        for (i = 0; i < num_state; i++)
            state_ws[5][i] = state_ws[0][i] + deriv[0][i] * b_1 + deriv[3][i] * b_4 + deriv[4][i] * b_5;
        intermediate_step = 5;
        break;
    ...
    case 5:
        ...
        for (i = 0; i < num_state; i++)
            state_ws[6][i]
                = state_ws[0][i] + deriv[0][i] * b_1 + deriv[3][i] * b_4 + deriv[4][i] * b_5 + deriv[5][i] * b_6;
        intermediate_step = 6;
        break;
    ...
    case 6:
        ...
        for (i = 0; i < num_state; i++)
            state_ws[7][i]
                = state_ws[0][i] + deriv[0][i] * b_1 + deriv[4][i] * b_5 + deriv[5][i] * b_6 + deriv[6][i] * b_7;
        intermediate_step = 7;
        break;
    ...
    case 7:
        /* Compute the next state */
        for (i = 0; i < num_state; i++)
            state_ws[8][i] = state_ws[0][i]
                + (deriv[0][i] * b9_78[1] + deriv[3][i] * b9_78[4] + deriv[4][i] * b9_78[5] + deriv[5][i] * b9_78[6]
                      + deriv[6][i] * b9_78[7] + deriv[7][i] * b9_78[8])
                    * dt;
        intermediate_step = 8;
        break;
    ...
    case 8:
        /* Compute the next state */
        for (i = 0; i < num_state; i++)
            state_ws[9][i] = state_ws[0][i]
                + (deriv[0][i] * b10_78[1] + deriv[3][i] * b10_78[4] + deriv[4][i] * b10_78[5] + deriv[5][i] * b10_78[6]
                      + deriv[6][i] * b10_78[7] + deriv[7][i] * b10_78[8] + deriv[8][i] * b10_78[9])
                    * dt;
        intermediate_step = 9;
        break;
    ...
    case 9:
        /* Compute the next state */
        for (i = 0; i < num_state; i++)
            state_ws[10][i] = state_ws[0][i]
                + (deriv[0][i] * b12_78[1] + deriv[5][i] * b12_78[6] + deriv[6][i] * b12_78[7] + deriv[7][i] * b12_78[8]
                      + deriv[8][i] * b12_78[9] + deriv[9][i] * b12_78[10])
                    * dt;
    ...
    case 10:
        /* Compute the next state */
        for (i = 0; i < num_state; i++)
            state_ws[11][i] = state_ws[0][i]
                + (deriv[0][i] * b13_78[1] + deriv[3][i] * b13_78[4] + deriv[4][i] * b13_78[5] + deriv[5][i] * b13_78[6]
                      + deriv[6][i] * b13_78[7] + deriv[7][i] * b13_78[8] + deriv[8][i] * b13_78[9]
                      + deriv[9][i] * b13_78[10] + deriv[10][i])
                    * dt;
    ...
    case 11:
        ...
        for (i = 0; i < num_state; i++)
            state_ws[0][i] += (deriv[5][i] * c_1 + (deriv[6][i] + deriv[7][i]) * c_2 + (deriv[8][i] + deriv[9][i]) * c_3
                + (deriv[10][i] + deriv[11][i]) * c_4);
