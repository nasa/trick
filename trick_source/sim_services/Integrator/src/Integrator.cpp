...
/**
 */
int Trick::Integrator::integrate_1st_order_ode(const double * derivs_in, double * state_in_out)
{
    int rc;
...
/**
 */
int Trick::Integrator::integrate_2nd_order_ode(const double * accel, double * velocity, double * position)
{
    int rc;
