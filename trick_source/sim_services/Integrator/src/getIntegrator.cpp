 ...
 */
template<typename T> static T * allocate_integrator(unsigned int state_size, double delta_t)
{
 ...
 */
Trick::Integrator * Trick::getIntegrator(Integrator_type alg, unsigned int state_size, double delta_t)
{
    switch(alg)
    {
        case Euler:
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return er7_utils::alloc::allocate_object<Trick::Euler_Integrator, unsigned int, double>(state_size,
                                                                                                    delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::NL2_Integrator>(state_size, delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::RK2_Integrator>(state_size, delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::MM4_Integrator>(state_size, delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::RK4_Integrator>(state_size, delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::RKG4_Integrator>(state_size, delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::RKF45_Integrator>(state_size, delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::RKF78_Integrator>(state_size, delta_t);
#else
        ...
        {
#ifdef USE_ER7_UTILS_INTEGRATORS
            return allocate_integrator<Trick::ABM_Integrator>(state_size, delta_t);
#else
        ...
        default:
            message_publish(MSG_ERROR, "Integ getIntegrator ERROR: No such Integrator.\n");
            return (NULL);
    }
}
