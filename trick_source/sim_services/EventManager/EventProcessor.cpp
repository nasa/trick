...
*/
void Trick::EventProcessor::add_event(Trick::Event* in_event) { pending_events.push_back(in_event); }
...
void Trick::EventProcessor::preload_checkpoint() { event_set.clear(); }
