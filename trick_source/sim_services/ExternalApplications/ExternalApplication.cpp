...
void Trick::ExternalApplication::set_startup_command(std::string in_command) { command = in_command; }

std::string Trick::ExternalApplication::get_startup_command() { return command; }

const char* Trick::ExternalApplication::get_startup_command_c_str() { return command.c_str(); }

void Trick::ExternalApplication::add_arguments(std::string args) { arguments << " " << args; }
...
std::string Trick::ExternalApplication::get_arguments() { return arguments.str() + create_arguments_string(); }
...
std::string Trick::ExternalApplication::get_host() { return host; }
...
unsigned short Trick::ExternalApplication::get_port() { return port; }
...
bool Trick::ExternalApplication::get_auto_reconnect() { return auto_reconnect; }
...
double Trick::ExternalApplication::get_cycle_period() { return cycle_period; }
...
double Trick::ExternalApplication::get_minimum_cycle_period() { return minimum_cycle_period; }
...
int Trick::ExternalApplication::get_height() { return height; }
...
int Trick::ExternalApplication::get_width() { return width; }
...
int Trick::ExternalApplication::get_x() { return x; }
...
int Trick::ExternalApplication::get_y() { return y; }
    ...
    if (disconnect_behavior_set)
    {
        ...
        default:
            std::cout << __FILE__ << ":" << __LINE__ << ": [33;1mwarning:[0m "
                      << "Ignoring invalid value (" << disconnect_behavior << ") for disconnect_behavior." << std::endl;
            break;
        }
    }
