...
bool Trick::TrickView::get_strip_charts_only() { return strip_charts_only; }
...
std::string Trick::TrickView::get_auto_open_file() { return open_file; }
...
std::string Trick::TrickView::get_auto_open_and_set_file() { return open_set_file; }
...
std::string Trick::TrickView::get_auto_set_file() { return set_file; }
