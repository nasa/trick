...
void Trick::DataRecordGroup::configure_jobs(DR_Type type) {
    ...
    case DR_Type::DR_Type_FrameLogDataRecord:
        ...
        add_job(0, CLEAR_CHECKPOINT_VARS_JOB_ID, (char*)"post_checkpoint", NULL, 1.0, (char*)"clear_checkpoint_vars",
                (char*)"TRK");
        add_job(0, SHUTDOWN_JOB_ID, (char*)"shutdown", NULL, 1.0, (char*)"shutdown", (char*)"TRK");

        write_job
            = add_job(0, DATA_RECORD_JOB_ID, (char*)job_class.c_str(), NULL, cycle, (char*)"data_record", (char*)"TRK");
        break ;
    }
