...
void Trick::DataRecordDispatcher::set_verif_onoff(bool state) { verify_log_vars = state; }

/** @brief set verification warning level */
void Trick::DataRecordDispatcher::set_warning_level(int level) { warning_level = level; }
 ...
 */
int Trick::DataRecordDispatcher::get_groups_size() { return groups.size(); }
