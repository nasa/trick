 ...
 * @copydoc Trick::CheckPointRestart::set_pre_init_checkpoint
 */
extern "C" int get_checkpoint_pre_init() { return (int)the_cpr->pre_init_checkpoint; }

/**
 * @relates Trick::CheckPointRestart
 * @copydoc Trick::CheckPointRestart::set_post_init_checkpoint
 */
extern "C" int get_checkpoint_post_init() { return (int)the_cpr->post_init_checkpoint; }

/**
 * @relates Trick::CheckPointRestart
 * @copydoc Trick::CheckPointRestart::set_end_checkpoint
 */
extern "C" int get_checkpoint_end() { return (int)the_cpr->end_checkpoint; }
...
#if __APPLE__
    message_publish(
        MSG_WARNING, "Warning: (Setting checkpoint cpu) Trick on Darwin does not yet support processor assignment.\n");
#endif
    return (0);
}
 ...
 */
extern "C" const char* checkpoint_get_output_file() { return the_cpr->get_output_file(); }

/**
 * @relates Trick::CheckPointRestart
 * @copydoc Trick::CheckPointRestart::get_load_file
 */
extern "C" const char* checkpoint_get_load_file() { return the_cpr->get_load_file(); }
 ...
 * @relates Trick::CheckPointRestart
 ...
 This is invoked when the user clicks the "Dump ASCII Chkpnt" button on the sim control panel after having set
 "Checkpoint Objects" under the "Actions" menu.
 @par Python Usage:
