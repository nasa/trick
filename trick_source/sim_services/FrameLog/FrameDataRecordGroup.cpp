...
Trick::FrameDataRecordGroup::FrameDataRecordGroup(int in_thread_id, std::string in_name)
    : Trick::DRBinary(in_name, false, Trick::DR_Type::DR_Type_FrameLogDataRecord)
...
*/
void Trick::FrameDataRecordGroup::add_rec_job(Trick::JobData* new_job) { rec_jobs.push_back(new_job); }
...
*/
void Trick::FrameDataRecordGroup::start_timer() { start_time = clock_time(); }
