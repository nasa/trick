...
void MonteCarloMaster::add_variable(MonteCarloVariable& variable)
{
    ...
    {
        std::string message = std::string("File: ") + __FILE__ + ", Line: " + std::to_string(__LINE__)
            + ", Invalid sequence\nAttempted to add a " + "new variable " + variable.get_variable_name().c_str()
            + " to run " + run_name.c_str() + ", but the input files have already been "
...
void MonteCarloMaster::set_num_runs(unsigned int num_runs_)
{
    ...
    {
        std::string message = std::string("File: ") + __FILE__ + ", Line: " + std::to_string(__LINE__)
            + ", Invalid sequence\nAttempted to set the " + "number of runs to " + std::to_string(num_runs_)
            + ", but the " + "input files have\nalready been generated.";
        message_publish(MSG_ERROR, message.c_str());
    }
    else
    {
