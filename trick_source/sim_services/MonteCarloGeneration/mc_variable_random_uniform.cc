...
MonteCarloVariableRandomUniform::MonteCarloVariableRandomUniform(
    const std::string& var_name, unsigned int seed, double lower_bound, double upper_bound)
...
*****************************************************************************/
void MonteCarloVariableRandomUniform::generate_assignment() { assign_double(distribution(random_generator)); }
...
Purpose:(generates the random number and the input-file assignment)
*****************************************************************************/
void MonteCarloVariableRandomUniformInt::generate_assignment() { assign_int(distribution(random_generator)); }
/*****************************************************************************
summarize_variable
Purpose:(Provide a string summarizing the attributes of this MonteCarloVariable)
*****************************************************************************/
