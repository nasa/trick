...
Constructor
*****************************************************************************/
MonteCarloVariable::MonteCarloVariable(const std::string & var_name)
    : units(),
...
*****************************************************************************/
void MonteCarloVariable::insert_units()
{
    ...
    if(command.empty())
    {
        std::string message = std::string("File: ") + __FILE__ + ", Line: " + std::to_string(__LINE__) +
                              ", Sequencing error\nVariable " + variable_name.c_str() + "  has units specified (" +
                              units.c_str() + ") but no command generated.\nThe command must be generated before " +
...
Purpose:(inserts the Trick unit conversion mechanism into an established
         command string.)
*****************************************************************************/
void MonteCarloVariable::trick_units(size_t insertion_pt)
{
...
Purpose:()
*****************************************************************************/
void MonteCarloVariable::assign_double(double value)
{
...
/****************************************************************************/
void MonteCarloVariable::assign_int(int value)
{
...
/****************************************************************************/
void MonteCarloVariable::generate_command()
{
