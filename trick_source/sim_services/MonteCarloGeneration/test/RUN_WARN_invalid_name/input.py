test.mc_master.activate("RUN_WARN_invalid_name")
test.mc_master.set_num_runs(1)

print('*********************************************************************************')
print('this message is expected:')
print('  Warning Invalid name')
print('  Attempt to remove MonteCarlo variable with name test.not_found_variable FAILED.')
...
test.mc_master.remove_variable("test.not_found_variable")
