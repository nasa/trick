...
{
    gmt_sec_ref = gmt_ref.day * 86400 + gmt_ref.hour * 3600 + gmt_ref.min * 60 + gmt_ref.sec;

    met_sec_ref = met_ref.day * 86400 + met_ref.hour * 3600 + met_ref.min * 60 + met_ref.sec;
...
double Trick::SimTime::get_gmttime() { return (exec_get_sim_time() + gmt_sec_ref); }
