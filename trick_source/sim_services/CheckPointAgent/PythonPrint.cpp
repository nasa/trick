...
// MEMBER FUNCTION
bool Trick::PythonPrint::input_perm_check(ATTRIBUTES* attr __attribute__((unused))) { return true; }

// MEMBER FUNCTION
bool Trick::PythonPrint::output_perm_check(ATTRIBUTES* attr __attribute__((unused))) { return true; }
...
// MEMBER FUNCTION
void Trick::PythonPrint::assign_rvalue(
...
void Trick::PythonPrint::write_singleton(
    std::ostream& chkpnt_os, void* address, ATTRIBUTES* attr, int offset, bool write_units, bool in_list)
{
    void* src_addr;
...
// MEMBER FUNCTION
std::string Trick::PythonPrint::ref_string_from_ptr(void* pointer, ATTRIBUTES* attr, int curr_dim)
{
    ...
    else
    {
        ...
        {
            message_publish(MSG_ERROR,
                "Checkpoint Agent ERROR: Pointer <%p> is not in Trick managed memory\n"
...
// MEMBER FUNCTION
void Trick::PythonPrint::write_rvalue(std::ostream& chkpnt_os, void* address, ATTRIBUTES* attr, int curr_dim,
    int offset, bool write_units, bool in_list, int* startingIndex)
{
                ...
                else
                {
                    ...
                    for (ii = 0; ii < array_len; ii++)
                    {
                        ...
                        write_rvalue(chkpnt_os, address, attr, curr_dim + 1, offset * attr->index[curr_dim].size + ii,
                            write_units, true, startingIndex);
                    }
                    chkpnt_os << "]";
                }
            }
