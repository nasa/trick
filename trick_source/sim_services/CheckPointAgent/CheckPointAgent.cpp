...
// MEMBER FUNCTION
void Trick::CheckPointAgent::pop_elem() { leftside_stack.pop_back(); }

void Trick::CheckPointAgent::set_debug_level(int level) { debug_level = level; }

void Trick::CheckPointAgent::set_reduced_checkpoint(bool flag) { reduced_checkpoint = flag; }

void Trick::CheckPointAgent::set_hexfloat_checkpoint(bool flag) { hexfloat_checkpoint = flag; }
