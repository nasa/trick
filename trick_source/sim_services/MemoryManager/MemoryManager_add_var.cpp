...
void* Trick::MemoryManager::add_var(
    TRICK_TYPE type, const char* class_name, VAR_DECLARE* var_declare, char* units __attribute__((unused)))
{
    int ii;
    int n_stars;
    int n_cdims;
 ...
 */
int Trick::MemoryManager::add_vars(TRICK_TYPE type, const char* class_name, VAR_LIST* var_list, char* units)
{
    int i;
    int ret = 0;
