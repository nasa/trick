 ...
 *
 */
int Trick::MemoryManager::add_attr_info(const std::string & user_type_string,
                                        ATTRIBUTES * attr,
                                        ...
                                        unsigned int line_num)
{
    ...
    */
    ...
    std::replace(user_type_name.begin(), user_type_name.end(), ']', '_');
    // remove spaces
    user_type_name.erase(std::remove_if(user_type_name.begin(), user_type_name.end(), (int (*)(int))std::isspace),
                         user_type_name.end());
