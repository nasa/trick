...
int Trick::MemoryManager::get_checkpoint_restore_state() {
    return checkpoint_restore_success;
}

void Trick::MemoryManager::set_checkpoint_restore_state(bool state) {
    checkpoint_restore_success = state;
}