...
/**
 ...
 The arguments and return value are the same except that std::string args are replaced with const char * args.
 */
extern "C" void * TMM_declare_operatornew_var(const char * class_name,
...
extern "C" void * TMM_declare_operatornew_var_with_name(const char * class_name,
                                                        unsigned int alloc_size,
                                                        unsigned int element_size,
                                                        const char * alloc_name)
{
    if(trick_MM != NULL)
    {
        return trick_MM->declare_operatornew_var(std::string(class_name),
                                                 alloc_size,
                                                 element_size,
