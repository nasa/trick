 ...
 */
extern "C" void* TMM_declare_var(
    TRICK_TYPE type, const char* class_name, int n_stars, const char* var_name, int n_cdims, int* cdims)
{
    if (trick_MM != NULL)
    {
...
extern "C" void* TMM_declare_var_1d(const char* enh_type_spec, int e_elems)
{
    ...
    else
    {
        Trick::MemoryManager::emitError(
            "TMM_declare_var_1d() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
extern "C" void* TMM_declare_var_s(const char* declaration)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_declare_var_s() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
extern "C" void* TMM_declare_operatornew_var(const char* class_name, unsigned int alloc_size, unsigned int element_size)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_declare_var() called before MemoryManager instantiation. Returning NULL.\n");
        return (void*)NULL;
    }
}

extern "C" void* TMM_declare_operatornew_var_with_name(
    const char* class_name, unsigned int alloc_size, unsigned int element_size, const char* alloc_name)
{
    if (trick_MM != NULL)
    {
        return trick_MM->declare_operatornew_var(
            std::string(class_name), alloc_size, element_size, std::string(alloc_name));
    }
    else
    {
        Trick::MemoryManager::emitError(
...
/**
 ...
 The arguments and return value are the same except that std::string args are replaced with const char * args.
 */
extern "C" void* TMM_declare_ext_var(
    void* addr, TRICK_TYPE type, const char* class_name, int n_stars, const char* var_name, int n_cdims, int* cdims)
{
    if (trick_MM != NULL)
    {
        std::string sclass_name = class_name;
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_declare_ext_var() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
extern "C" void* TMM_declare_ext_var_1d(void* addr, const char* elem_decl, int n_elems)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_declare_ext_var_1d() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
extern "C" void* TMM_declare_ext_var_s(void* addr, const char* declaration)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_declare_ext_var_s() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
void* TMM_resize_array_a(void* address, int n_cdims, int* cdims)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_resize_array_a() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
void* TMM_resize_array_n(const char* name, int n_cdims, int* cdims)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_resize_array_n() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
void* TMM_resize_array_1d_a(void* address, int num)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_resize_array_1d_a() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
void* TMM_resize_array_1d_n(const char* name, int num)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_resize_array_1d_n() called before MemoryManager instantiation. Returning NULL.\n");
        return ((void*)NULL);
    }
}
...
extern "C" void TMM_hexfloat_decimal_comment_checkpoint(int yesno)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_hexfloat_decimal_comment_checkpoint() called before MemoryManager instantiation.\n");
    }
}
...
extern "C" int TMM_read_checkpoint_from_string(const char* str)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_read_checkpoint_from_string() called before MemoryManager instantiation.\n");
        return (1);
    }
}
...
extern "C" int TMM_add_shared_library_symbols(const char* filename)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "TMM_add_shared_library_symbols() called before MemoryManager instantiation.\n");
        return (1);
    }
}
...
extern "C" REF2* ref_attributes(const char* name)
{
    ...
    {
        Trick::MemoryManager::emitError(
            "ref_attributes() called before MemoryManager instantiation. Returning NULL.\n");
        return ((REF2*)NULL);
    }
}
 ...
 */
extern "C" int io_get_fixed_truncated_size(char* ptr __attribute__((unused)), ATTRIBUTES* A __attribute__((unused)),
    char* str __attribute__((unused)), int dims __attribute__((unused)), ATTRIBUTES* left_type __attribute__((unused)))
{
