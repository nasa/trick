    ...
    void* base_addr, ATTRIBUTES* attr, int curr_dim, int offset, V_TREE* v_tree, cv_converter* cf)
{
    ...
    if (remaining_dimensions == 0)
    {
            ...
            if (v_tree && v_tree->v_data)
            {
                if ((size_t)attr->size == sizeof(int))
                {
                    ...
                    *(int*)assign_addr = vval_int(v_tree->v_data);
                    ...
                    {
                        std::cout << std::endl
                                  << "Assignment (Enum): *(int*)" << (void*)assign_addr << " = " << *(int*)assign_addr
                                  << ";" << std::endl;
                        std::cout.flush();
                    }
                }
                ...
                else if ((size_t)attr->size == sizeof(char))
                {
                    ...
                    *(char*)assign_addr = vval_char(v_tree->v_data);
                    ...
                    {
                        std::cout << std::endl
                                  << "Assignment (Enum): *(char*)" << (void*)assign_addr << " = " << *(char*)assign_addr
                                  << ";" << std::endl;
                        std::cout.flush();
                    }
                }
        ...
        case TRICK_UNSIGNED_LONG_LONG:
            ...
            {
                std::cout << std::endl
                          << "Assignment: *(long long*)" << (void*)assign_addr << " = " << *(long long*)assign_addr
                          << ";" << std::endl;
                std::cout.flush();
            }
            break;
        ...
        case TRICK_FILE_PTR:
            if (debug_level)
            {
                std::cout << std::endl << "Assignment: TRICK_FILE_PTR assignments not yet implemented." << std::endl;
                std::cout.flush();
            }
            break;
        case TRICK_VOID_PTR:
            if (debug_level)
            {
                std::cout << std::endl << "Assignment: TRICK_VOID_PTR assignments not yet implemented." << std::endl;
                std::cout.flush();
            }
            break;
        case TRICK_STRING:
            ...
            {
                std::cout << std::endl
                          << "Assignment: *(std::string)" << (void*)assign_addr << " = \"" << *(std::string*)assign_addr
                          << "\";" << std::endl;
                std::cout.flush();
            }
            break;
    ...
    else if (remaining_dimensions > 0)
    {
        ...
        { // next dimension is fixed.
            ...
            else
            {
                ...
                {
                    int ret;
                    ret = assign_recursive(
                        base_addr, attr, curr_dim + 1, offset * size_of_curr_dim + ii, curr_vt_node, cf);
