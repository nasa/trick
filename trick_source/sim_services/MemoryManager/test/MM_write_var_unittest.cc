...
TEST_F(MM_write_var, UserDefinedType1VarByAddr)
{
    ...
    int result = strcmp_IgnoringWhiteSpace("var_udt1.x = 1.23456789;"
...
TEST_F(MM_write_var, ArrayOfCharStringsVarByAddr)
{
    ...
    int result = strcmp_IgnoringWhiteSpace("var_strings = {\"Huey\",\"Dewey\",\"Louie\"};", ss.str().c_str());
    EXPECT_EQ(result, 0);
}
...
TEST_F(MM_write_var, DoubleOneDimArrayVarByAddr)
{
    ...
    memmgr->write_var(ss, (void*)test_var);
    int result
        = strcmp_IgnoringWhiteSpace("var_double_array = {1.000000000000001, 2.000000000000002, 3.000000000000003,"
...
TEST_F(MM_write_var, DoubleTwoDimArrayVarByAddr)
{
    ...
    memmgr->write_var(ss, (void*)test_var);
    int result
        = strcmp_IgnoringWhiteSpace("var_double_2d_array = {{1.000000000000001, 2.000000000000001, 3.000000000000001},"
