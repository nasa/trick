 ...
 */
template <typename T>
void validate_alloc_info_local(Trick::MemoryManager* memmgr, T* test_var, TRICK_TYPE trick_type, const char* type_name,
...
{
    std::cout << ISO_6429_White_Background << ISO_6429_Blue_Foreground << ISO_6429_Underline
              << "NOTE: An error message is expected in this test." << ISO_6429_Restore_Default << std::endl;
