...
size_t wcs_to_ncs_len(const wchar_t* wcs) { return wcs_to_ncs(wcs, (char*)NULL, (size_t)0); }

size_t ncs_to_wcs_len(const char* ncs) { return ncs_to_wcs(ncs, (wchar_t*)NULL, (size_t)0); }
...
#else
int wcs_to_ncs_len(void) { return (0); }

int ncs_to_wcs_len(void) { return (0); }

int wcs_to_ncs(void) { return (0); }

int ncs_to_wcs(void) { return (0); }
#endif
