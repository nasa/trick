...
unsigned short Trick::VariableServerListenThread::get_port() { return _requested_port; }
...
std::string Trick::VariableServerListenThread::get_user_tag() { return _user_tag; }

const std::string& Trick::VariableServerListenThread::get_user_tag_ref() { return _user_tag; }

void Trick::VariableServerListenThread::set_user_tag(std::string in_tag) { _user_tag = in_tag; }
...
std::string Trick::VariableServerListenThread::get_source_address() { return _requested_source_address; }

bool Trick::VariableServerListenThread::get_broadcast() { return _broadcast; }

void Trick::VariableServerListenThread::set_broadcast(bool in_broadcast) { _broadcast = in_broadcast; }
...
void Trick::VariableServerListenThread::pause_listening() { force_thread_to_pause(); }
