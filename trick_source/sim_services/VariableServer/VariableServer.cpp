...
Trick::VariableServer::~VariableServer() { the_vs = NULL; }

void Trick::VariableServer::shutdownConnections() { listen_thread.shutdownConnections(); }
...
bool Trick::VariableServer::get_enabled() { return enabled; }
...
bool Trick::VariableServer::get_info_msg() { return info_msg; }
...
bool Trick::VariableServer::get_log() { return log; }

bool Trick::VariableServer::get_session_log() { return session_log; }
...
const char* Trick::VariableServer::get_hostname() { return listen_thread.get_hostname(); }

Trick::VariableServerListenThread& Trick::VariableServer::get_listen_thread() { return listen_thread; }
...
void Trick::VariableServer::set_copy_data_job(Trick::JobData* in_job) { copy_data_job = in_job; }
