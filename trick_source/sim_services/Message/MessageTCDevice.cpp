...
int Trick::MessageTCDeviceListenThread::get_port() { return listen_dev.port; }

int Trick::MessageTCDeviceListenThread::init_listen_device() { return tc_init(&listen_dev); }
...
// DESTRUCTOR
Trick::MessageTCDevice::~MessageTCDevice() { delete[] combined_message; }

Trick::MessageTCDeviceListenThread& Trick::MessageTCDevice::get_listen_thread() { return listen_thread; }

void Trick::MessageTCDevice::add_connection(TCDevice* new_conn) { connections.push_back(new_conn); }
