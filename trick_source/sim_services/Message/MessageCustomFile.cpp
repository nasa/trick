...
*/
Trick::MessageCustomFile::MessageCustomFile()
    : _this_level(level_counter++)
{
}
...
int Trick::MessageCustomFile::get_level() const { return _this_level; }
...
void Trick::MessageCustomFile::set_file_name(std::string file_name) { this->file_name = file_name; }
