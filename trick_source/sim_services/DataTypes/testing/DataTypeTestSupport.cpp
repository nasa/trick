...
static short get_ClassFour__f1(void * addr)
{
    return ((ClassFour *)addr)->f1;
}

static void set_ClassFour__f1(void * addr, short v)
{
    ((ClassFour *)addr)->f1 = v;
}

static short get_ClassFour__f2(void * addr)
{
    return ((ClassFour *)addr)->f2;
}

static void set_ClassFour__f2(void * addr, short v)
{
    ((ClassFour *)addr)->f2 = v;
}

static short get_ClassFour__f3(void * addr)
{
    return ((ClassFour *)addr)->f3;
}

static void set_ClassFour__f3(void * addr, short v)
{
    ((ClassFour *)addr)->f3 = v;
}
...
bool addClassOneToTypeDictionary(TypeDictionary * typeDictionary)
{
    ...
    try
    {
        CompositeDataType * classOneTypeSpec = new CompositeDataType(typeDictionary,
                                                                     "ClassOne",
                                                                     sizeof(ClassOne),
                                                                     &construct<ClassOne>,
                                                                     &destruct<ClassOne>);
...
bool addClassTwoToTypeDictionary(TypeDictionary * typeDictionary)
{
    ...
    try
    {
        CompositeDataType * classTwoTypeSpec = new CompositeDataType(typeDictionary,
                                                                     "ClassTwo",
                                                                     sizeof(ClassTwo),
                                                                     &construct<ClassTwo>,
                                                                     &destruct<ClassTwo>);
...
bool addClassThreeToTypeDictionary(TypeDictionary * typeDictionary)
{
    ...
    try
    {
        CompositeDataType * classThreeTypeSpec = new CompositeDataType(typeDictionary,
                                                                       "ClassThree",
                                                                       sizeof(ClassThree),
                                                                       &construct<ClassThree>,
                                                                       &destruct<ClassThree>);
        int x_dims[] = {2};
...
bool addClassFourToTypeDictionary(TypeDictionary * typeDictionary)
{
    ...
    try
    {
        CompositeDataType * classFourTypeSpec = new CompositeDataType(typeDictionary,
                                                                      "ClassFour",
                                                                      sizeof(ClassFour),
                                                                      &construct<ClassFour>,
                                                                      &destruct<ClassFour>);
...
bool addClassFiveToTypeDictionary(TypeDictionary * typeDictionary)
{
    ...
    try
    {
        CompositeDataType * classFiveTypeSpec = new CompositeDataType(typeDictionary,
                                                                      "ClassFive",
                                                                      sizeof(ClassFive),
                                                                      &construct<ClassFive>,
                                                                      &destruct<ClassFive>);
