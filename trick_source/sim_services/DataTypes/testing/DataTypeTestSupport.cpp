...
bool addClassOneToTypeDictionary(TypeDictionary* typeDictionary)
{
    ...
    try
    {
        CompositeDataType* classOneTypeSpec = new CompositeDataType(
            typeDictionary, "ClassOne", sizeof(ClassOne), &construct<ClassOne>, &destruct<ClassOne>);
...
bool addClassTwoToTypeDictionary(TypeDictionary* typeDictionary)
{
    ...
    try
    {
        CompositeDataType* classTwoTypeSpec = new CompositeDataType(
            typeDictionary, "ClassTwo", sizeof(ClassTwo), &construct<ClassTwo>, &destruct<ClassTwo>);
...
bool addClassThreeToTypeDictionary(TypeDictionary* typeDictionary)
{
    ...
    try
    {
        CompositeDataType* classThreeTypeSpec = new CompositeDataType(
            typeDictionary, "ClassThree", sizeof(ClassThree), &construct<ClassThree>, &destruct<ClassThree>);
        int x_dims[] = {2};
...
bool addClassFourToTypeDictionary(TypeDictionary* typeDictionary)
{
    ...
    try
    {
        CompositeDataType* classFourTypeSpec = new CompositeDataType(
            typeDictionary, "ClassFour", sizeof(ClassFour), &construct<ClassFour>, &destruct<ClassFour>);
        int x_dims[] = {2};
...
bool addClassFiveToTypeDictionary(TypeDictionary* typeDictionary)
{
    ...
    try
    {
        CompositeDataType* classFiveTypeSpec = new CompositeDataType(
            typeDictionary, "ClassFive", sizeof(ClassFive), &construct<ClassFive>, &destruct<ClassFive>);
