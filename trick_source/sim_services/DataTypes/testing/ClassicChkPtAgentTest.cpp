...
TEST_F(ClassicChkPtAgentTest, getSubName1)
{
    ...
    checkPointAgent->getSubName(
        nameStream2, &(classOneVariable->b), doubleDataType, classOneVariable, classOneDataType);
...
TEST_F(ClassicChkPtAgentTest, getSubName2)
{
    ...
    std::stringstream nameStream2;
    checkPointAgent->getSubName(
        nameStream2, &(classTwoVariable->y), doubleDataType, classTwoVariable, classTwoDataType);
    EXPECT_EQ(".y", nameStream2.str());

    std::stringstream nameStream3;
    checkPointAgent->getSubName(
        nameStream3, &(classTwoVariable->c1), classOneDataType, classTwoVariable, classTwoDataType);
    EXPECT_EQ(".c1", nameStream3.str());

    std::stringstream nameStream4;
    checkPointAgent->getSubName(
        nameStream4, &(classTwoVariable->c1.a), intDataType, classTwoVariable, classTwoDataType);
    EXPECT_EQ(".c1.a", nameStream4.str());

    std::stringstream nameStream5;
    checkPointAgent->getSubName(
        nameStream5, &(classTwoVariable->c1.b), doubleDataType, classTwoVariable, classTwoDataType);
...
TEST_F(ClassicChkPtAgentTest, getSubName3)
{
    ...
    std::stringstream nameStream1;
    checkPointAgent->getSubName(
        nameStream1, &(classThreeVariable->pos[0]), doubleDataType, classThreeVariable, classThreeDataType);
    EXPECT_EQ(".pos[0]", nameStream1.str());

    std::stringstream nameStream2;
    checkPointAgent->getSubName(
        nameStream2, &(classThreeVariable->pos[1]), doubleDataType, classThreeVariable, classThreeDataType);
    EXPECT_EQ(".pos[1]", nameStream2.str());

    std::stringstream nameStream3;
    checkPointAgent->getSubName(
        nameStream3, &(classThreeVariable->vel[0]), doubleDataType, classThreeVariable, classThreeDataType);
    EXPECT_EQ(".vel[0]", nameStream3.str());

    std::stringstream nameStream4;
    checkPointAgent->getSubName(
        nameStream4, &(classThreeVariable->vel[1]), doubleDataType, classThreeVariable, classThreeDataType);
