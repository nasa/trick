...
TEST_F(ClassicChkPtAgentTest, getSubName1)
{
    ...
    checkPointAgent->getSubName(nameStream2,
                                &(classOneVariable->b),
                                doubleDataType,
                                classOneVariable,
                                classOneDataType);
...
TEST_F(ClassicChkPtAgentTest, getSubName2)
{
    ...
    checkPointAgent->getSubName(nameStream3,
                                &(classTwoVariable->c1),
                                classOneDataType,
                                classTwoVariable,
                                classTwoDataType);
    ...
    checkPointAgent->getSubName(nameStream4,
                                &(classTwoVariable->c1.a),
                                intDataType,
                                classTwoVariable,
                                classTwoDataType);
    ...
    checkPointAgent->getSubName(nameStream5,
                                &(classTwoVariable->c1.b),
                                doubleDataType,
                                classTwoVariable,
                                classTwoDataType);
...
TEST_F(ClassicChkPtAgentTest, getSubName3)
{
    ...
    std::stringstream nameStream1;
    checkPointAgent->getSubName(nameStream1,
                                &(classThreeVariable->pos[0]),
                                doubleDataType,
                                classThreeVariable,
                                classThreeDataType);
