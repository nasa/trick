...
class MemMgr
{
    public:
        ...
        void* declare_var(const std::string& typeSpecName, const std::string& varName, unsigned int DimensionsCount,
            int* Dimensions, void* suppliedAllocation = 0);
        ...
        void* declare_var(
            const std::string& typeSpecName, const std::string& varName, int n, void* suppliedAllocation = 0);
        ...
        //    int add_attr_info(std::string& type_name , ATTRIBUTES* attr , const char * file_name = "None" , unsigned
        //    int line_num = 0 ) ; int add_template_name_trans(std::string template_name , std::string attr_name) ;
