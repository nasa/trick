...
class CompositeDataType : public DataType
{
    public:
         ...
         */
        CompositeDataType(TypeDictionary* typeDictionary, std::string name, size_t sizeof_struct,
        ...
        */
        ...
        /**
         */
        TypeClass::e getTypeClass() const { return TypeClass::COMPOSITE; };
         ...
         */
        template <class T>
        void addBitFieldMember(
            std::string member_name, T (*getter)(void* address), void (*setter)(void* address, T value))
        {
