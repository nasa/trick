...
class ClassicChkPtAgent : public ChkPtAgent
{
    public:
        /**
         */
        ClassicChkPtAgent(std::ostream& errs)
            : errorStream(errs)
        {
         ...
         */
        bool writeDeclaration(std::ostream& out_s, std::string name, const DataType* dataType);
         ...
         */
        bool writeVariable(std::ostream& out_s, MemMgr* memMgr, void* address, const DataType* dataType);
        /**
         Restore Checkpoint.
         */
         ...
         */
        void writeAssignment(std::ostream& out_s, std::string rhs);
         ...
         */
        bool getSubName(std::ostream& nameStream, void* searchAddress, const DataType* searchType, void* baseAddress,
        ...
        /**
         Tested in: ClassicChkPtAgentTest::getSubName1,
                    ...
                    ClassicChkPtAgentTest::getSubName3.
         */
        bool getCompositeSubName(std::ostream& nameStream, void* searchAddress, const DataType* searchType,
            void* baseAddress, const CompositeDataType* baseType);
        /**
         Tested in: ClassicChkPtAgentTest::getSubName2,
                    ClassicChkPtAgentTest::getSubName3.
         */
        bool getArraySubName(std::ostream& nameStream, void* searchAddress, const DataType* searchType,
