...
class AllocInfo
{
    public:
         ...
         */
        AllocInfo(const std::string& varName, const std::string& typeSpecName, unsigned int dimensionsCount,
            int* dimensions, TypeDictionary* typeDictionary, void* suppliedAllocation = 0);
        /**
          AllocInfo destructor.
         */
        AllocInfo(const std::string& declaration, TypeDictionary* typeDictionary, void* suppliedAllocation = 0);
        /**
          AllocInfo destructor.
         */
        ~AllocInfo();
        ...
        /**
         ...
         Tested in: FIXME
         */
        void appendDependencies(MemMgr* memMgr, std::vector<AllocInfo*>& dependencies);

        /**
         Tested in: FIXME
         */
        void appendDependenciesfromComposite(const CompositeDataType* compDataType, void* address, MemMgr* memMgr,
            std::vector<AllocInfo*>& dependencies);

        /**
         Tested in: FIXME
         */
        void appendDependenciesfromArray(
    ...
    private:
        void initialize(const std::string& varName, const std::string& typeSpecName, unsigned int dimensionsCount,
            int* dimensions, TypeDictionary* typeDictionary, void* suppliedAllocation);
