...
/**
 */
template <class T> class PrimitiveDataType : public DataType
{
    public:
        /**
        ...
        TypeClass::e getTypeClass() const { return TypeClass::PRIMITIVE; }

        /**
         */
        DataType* clone() const { return new PrimitiveDataType<T>(); }
        ...
        /**
         */
        void deleteInstance(void* address) const { delete (T*)address; }
        ...
        /**
         ...
         @param address Address of the variable.
         */
        void printValue(std::ostream& s, void* address) const { s << *(T*)address; }
