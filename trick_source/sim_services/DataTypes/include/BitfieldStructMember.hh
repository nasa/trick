 ...
 */
template <class T> class BitfieldStructMember : public StructMember
{
    public:
        /**
        ...
        */
        ...
        Clone.
        */
        StructMember* clone() const { return new BitfieldStructMember(*this); }
        ...
        /**
         */
        MemberClass::e getMemberClass() const { return MemberClass::BITFIELD; }
        ...
        */
        ...
        /**
         */
        void clearValue(void* struct_address) const { (*set_bitfield_value)(struct_address, 0); }
