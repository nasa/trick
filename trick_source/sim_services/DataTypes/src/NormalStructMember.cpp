...
// CONSTRUCTOR
NormalStructMember::NormalStructMember(std::string memberName, int offset, TypeDictionary* typeDictionary,
...
StructMember* NormalStructMember::clone() const { return new NormalStructMember(*this); }
...
// MEMBER FUNCTION
const DataType* NormalStructMember::getDataType() { return subType; }

// MEMBER FUNCTION
int NormalStructMember::getOffset() { return byte_offset; }
