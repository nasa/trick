...
EnumDataType::EnumDataType(EnumDictionary* enumDictionary, std::string name, size_t enumSize)
{
...
DataType* EnumDataType::clone() const { return new EnumDataType(*this); }

bool EnumDataType::validate() { return true; }

size_t EnumDataType::getSize() const { return enumSize; }
...
void EnumDataType::deleteInstance(void* address) const { free(address); }
...
// MEMBER FUNCTION
std::string EnumDataType::getTypeSpecName() const { return name; }
