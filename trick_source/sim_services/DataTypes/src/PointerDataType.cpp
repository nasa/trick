...
bool PointerDataType::initPointerDataType(
    TypeDictionary* typeDictionary, std::string typeSpecName, unsigned int n_dims, int dims[])
{
...
bool PointerDataType::containsPointers() const { return true; }

// CLONE
DataType* PointerDataType::clone() const { return new PointerDataType(*this); }
...
// MEMBER FUNCTION
size_t PointerDataType::getSize() const { return sizeof(void*); }
...
// MEMBER FUNCTION
void PointerDataType::deleteInstance(void* address) const { free(address); }

// MEMBER FUNCTION
void PointerDataType::clearValue(void* address) const { *(void**)address = (void*)NULL; }
...
// MEMBER FUNCTION
void PointerDataType::printValue(std::ostream& s, void* address) const { s << *(void**)address; }

// MEMBER FUNCTION
std::string PointerDataType::getTypeSpecName() const { return typeSpecName; }
...
// MEMBER FUNCTION
const DataType* PointerDataType::getSubType() const { return subType; }
