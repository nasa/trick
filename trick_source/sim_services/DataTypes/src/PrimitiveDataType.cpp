...
{
    std::cerr << "WARNING: Cannot delete the object, of type <void> at address (" << address << ")." << std::endl;
}
...
{
    std::cerr << "WARNING: Cannot clear the value of the object, of type <void> at address (" << address << ")."
              << std::endl;
}

template<> void PrimitiveDataType<void>::assignValue(void * address, Value * value) const
{
    std::cerr << "WARNING: Cannot assign a value to the object, of type <void> at address (" << address << ")."
              << std::endl;
}
