...
TEST_F(GetTimeOfDayClockTest, Initialize)
{
    ...
    //"The system clock shall initialize with time equal to computer system time, reference time of 0, and all ratios
    // set to 1.");
...
TEST_F(GetTimeOfDayClockTest, ClockSync)
{
    ...
    align_tics_mult = 1.5;
    clock_unit = int((TICS_PER_SEC * align_tics_mult) / (timclk->rt_clock_ratio * timclk->sim_tic_ratio));
