...
extern "C" int ip_parse(const char* in_string) { return the_ip->parse(in_string); }
...
*/
int ippython_add_read(double in_time, char* in_string) { return ippython_add_read(0, in_time, in_string); }
