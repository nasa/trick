...
namespace Trick
{
    ...
    */
    ...
    {
        // req.add_requirement("r_exec_jobs");
        //"The Executive Scheduler shall assign job class id of the following classes < 1000, default_data ,
        // input_processor , initialization , top_of_frame , end_of_frame , shutdown , freeze_init , freeze_scheduled ,
        // freeze_automatic, freeze , unfreeze, and exec_time_tic_changed"
    ...
    TEST_F(ExecutiveTest, AdvanceSimTimeToNextJob)
    {
        ...
        //"The Executive Scheduler shall advance simulation time to the time of the next lowest job call time if the
        // next lowest job call time is less than the next software frame boundary ") ;
