...
Trick::ScheduledJobQueueInstrument::ScheduledJobQueueInstrument(
    Trick::JobData* in_inst_job, Trick::JobData* in_targ_job)
{
...
*/
Trick::ScheduledJobQueueInstrument::~ScheduledJobQueueInstrument() { delete instru_job; }
...
*/
int Trick::ScheduledJobQueueInstrument::call() { return instru_job->parent_object->call_function(instru_job); }
