    ...
    StlRandomGenerator::StlEngine       in_engine_type)
{
    ...
    case StlRandomGenerator::MINSTD_RAND_ENGINE*1000 + StlRandomGenerator::POISSON:
        return static_cast<StlRandomGenerator*>(
            new StlRandomGeneratorSub<std::minstd_rand, std::poisson_distribution<int>>(in_param_a, in_param_b, in_seed,
                                                                                        in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::MT19937_ENGINE*1000 + StlRandomGenerator::POISSON:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::mt19937, std::poisson_distribution<int>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::MT19937_64_ENGINE*1000 + StlRandomGenerator::POISSON:
        return static_cast<StlRandomGenerator*>(
            new StlRandomGeneratorSub<std::mt19937_64, std::poisson_distribution<int>>(in_param_a, in_param_b, in_seed,
                                                                                       in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::RANLUX_24_ENGINE*1000 + StlRandomGenerator::POISSON:
        return static_cast<StlRandomGenerator*>(
            new StlRandomGeneratorSub<std::ranlux24, std::poisson_distribution<int>>(in_param_a, in_param_b, in_seed,
                                                                                     in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::RANLUX_44_ENGINE*1000 + StlRandomGenerator::POISSON:
        return static_cast<StlRandomGenerator*>(
            new StlRandomGeneratorSub<std::ranlux48, std::poisson_distribution<int>>(in_param_a, in_param_b, in_seed,
                                                                                     in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::KNUTH_B_ENGINE*1000 + StlRandomGenerator::POISSON:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::knuth_b, std::poisson_distribution<int>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
