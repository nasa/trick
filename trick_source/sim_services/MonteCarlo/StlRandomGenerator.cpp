...
StlRandomGenerator* StlRandomGeneratorFactory::newGenerator(double in_param_a, double in_param_b, unsigned long in_seed,
    StlRandomGenerator::StlDistribution in_dist_type, StlRandomGenerator::StlEngine in_engine_type)
{
...
#define TRICK_DEFAULT_ENGINE_CLASS                                                                                     \
    ...
    case StlRandomGenerator::TRICK_DEFAULT_ENGINE * 1000 + StlRandomGenerator::POISSON:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<TRICK_DEFAULT_ENGINE_CLASS,
    ...
    case StlRandomGenerator::MINSTD_RAND_ENGINE * 1000 + StlRandomGenerator::FLAT:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::minstd_rand, UNIFORM_REAL_DIST<double>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::MT19937_ENGINE * 1000 + StlRandomGenerator::FLAT:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::mt19937, UNIFORM_REAL_DIST<double>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::MT19937_64_ENGINE * 1000 + StlRandomGenerator::FLAT:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::mt19937_64, UNIFORM_REAL_DIST<double>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::RANLUX_24_ENGINE * 1000 + StlRandomGenerator::FLAT:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::ranlux24, UNIFORM_REAL_DIST<double>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::RANLUX_44_ENGINE * 1000 + StlRandomGenerator::FLAT:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::ranlux48, UNIFORM_REAL_DIST<double>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
    ...
    case StlRandomGenerator::KNUTH_B_ENGINE * 1000 + StlRandomGenerator::FLAT:
        return static_cast<StlRandomGenerator*>(new StlRandomGeneratorSub<std::knuth_b, UNIFORM_REAL_DIST<double>>(
            in_param_a, in_param_b, in_seed, in_dist_type, in_engine_type));
        break;
