...
StlRandomGenerator::StlRandomGenerator(
    double in_param_a, double in_param_b, unsigned long in_seed, StlDistribution in_dist_type, StlEngine in_engine_type)
    : initialSeed(in_seed),
...
StlRandomGenerator * StlRandomGeneratorFactory::newGenerator(double in_param_a,
                                                             double in_param_b,
...
#define TRICK_DEFAULT_ENGINE_CLASS                                                                                     \
    std::ranlux_base_01 // because mt19937 doesnt return within canonical range for GCC 4.4.7
#endif
    ...
    switch(in_engine_type * 1000 + in_dist_type)
    {
        ...
        case StlRandomGenerator::TRICK_DEFAULT_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<TRICK_DEFAULT_ENGINE_CLASS, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                                 in_param_b,
                                                                                                 in_seed,
                                                                                                 in_dist_type,
                                                                                                 in_engine_type));
        ...
        case StlRandomGenerator::TRICK_DEFAULT_ENGINE * 1000 + StlRandomGenerator::POISSON:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<TRICK_DEFAULT_ENGINE_CLASS,
                                          std::poisson_distribution<STL_POISSON_TEMPLATE_TYPES>>(in_param_a,
                                                                                                 in_param_b,
                                                                                                 in_seed,
                                                                                                 in_dist_type,
                                                                                                 in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_BASE_01_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux_base_01, std::normal_distribution<double>>(in_param_a,
                                                                                                 in_param_b,
                                                                                                 in_seed,
                                                                                                 in_dist_type,
                                                                                                 in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_BASE_01_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux_base_01, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                          in_param_b,
                                                                                          in_seed,
                                                                                          in_dist_type,
                                                                                          in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_64_BASE_01_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux64_base_01, std::normal_distribution<double>>(in_param_a,
                                                                                                   in_param_b,
                                                                                                   in_seed,
                                                                                                   in_dist_type,
                                                                                                   in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_64_BASE_01_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux64_base_01, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                            in_param_b,
                                                                                            in_seed,
                                                                                            in_dist_type,
                                                                                            in_engine_type));
        ...
        case StlRandomGenerator::MINSTD_RAND_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::minstd_rand, std::normal_distribution<double>>(in_param_a,
                                                                                              in_param_b,
                                                                                              in_seed,
                                                                                              in_dist_type,
                                                                                              in_engine_type));
        ...
        case StlRandomGenerator::MINSTD_RAND_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::minstd_rand, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                       in_param_b,
                                                                                       in_seed,
                                                                                       in_dist_type,
                                                                                       in_engine_type));
        ...
        case StlRandomGenerator::MT19937_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::mt19937, std::normal_distribution<double>>(in_param_a,
                                                                                          in_param_b,
                                                                                          in_seed,
                                                                                          in_dist_type,
                                                                                          in_engine_type));
        ...
        case StlRandomGenerator::MT19937_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::mt19937, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                   in_param_b,
                                                                                   in_seed,
                                                                                   in_dist_type,
                                                                                   in_engine_type));
        ...
        case StlRandomGenerator::MT19937_64_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::mt19937_64, std::normal_distribution<double>>(in_param_a,
                                                                                             in_param_b,
                                                                                             in_seed,
                                                                                             in_dist_type,
                                                                                             in_engine_type));
        ...
        case StlRandomGenerator::MT19937_64_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::mt19937_64, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                      in_param_b,
                                                                                      in_seed,
                                                                                      in_dist_type,
                                                                                      in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_24_BASE_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux24_base, std::normal_distribution<double>>(in_param_a,
                                                                                                in_param_b,
                                                                                                in_seed,
                                                                                                in_dist_type,
                                                                                                in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_24_BASE_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux24_base, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                         in_param_b,
                                                                                         in_seed,
                                                                                         in_dist_type,
                                                                                         in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_44_BASE_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux48_base, std::normal_distribution<double>>(in_param_a,
                                                                                                in_param_b,
                                                                                                in_seed,
                                                                                                in_dist_type,
                                                                                                in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_44_BASE_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux48_base, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                         in_param_b,
                                                                                         in_seed,
                                                                                         in_dist_type,
                                                                                         in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_24_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux24, std::normal_distribution<double>>(in_param_a,
                                                                                           in_param_b,
                                                                                           in_seed,
                                                                                           in_dist_type,
                                                                                           in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_24_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux24, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                    in_param_b,
                                                                                    in_seed,
                                                                                    in_dist_type,
                                                                                    in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_44_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux48, std::normal_distribution<double>>(in_param_a,
                                                                                           in_param_b,
                                                                                           in_seed,
                                                                                           in_dist_type,
                                                                                           in_engine_type));
        ...
        case StlRandomGenerator::RANLUX_44_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::ranlux48, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                    in_param_b,
                                                                                    in_seed,
                                                                                    in_dist_type,
                                                                                    in_engine_type));
        ...
        case StlRandomGenerator::KNUTH_B_ENGINE * 1000 + StlRandomGenerator::GAUSSIAN:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::knuth_b, std::normal_distribution<double>>(in_param_a,
                                                                                          in_param_b,
                                                                                          in_seed,
                                                                                          in_dist_type,
                                                                                          in_engine_type));
        ...
        case StlRandomGenerator::KNUTH_B_ENGINE * 1000 + StlRandomGenerator::FLAT:
            return static_cast<StlRandomGenerator *>(
                new StlRandomGeneratorSub<std::knuth_b, UNIFORM_REAL_DIST<double>>(in_param_a,
                                                                                   in_param_b,
                                                                                   in_seed,
                                                                                   in_dist_type,
                                                                                   in_engine_type));
        ...
        default:
            throw std::invalid_argument(std::string("error: StlRandomGeneratorFactory::newGenerator called for "
                                                    "unimplemented std::random  (engine,distribution) combination."));
    }
