...
int Trick::MonteCarlo::execute_as_slave()
{
    ...
    while (true)
    {
        ...
        case MonteSlave::MC_PROCESS_RUN:
            /**
             * <ul><li> MonteSlave::MC_PROCESS_RUN: Call #slave_process_run. This will return a non-zero value when run
             * in a child process to indicate that this function should return so that the sim can complete.
             */
