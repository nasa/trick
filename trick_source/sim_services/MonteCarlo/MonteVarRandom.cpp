...
Trick::MonteVarRandom::MonteVarRandom(std::string in_name,
      ...
      stlGenPtr(0)
{
    ...
    if(engineType != NO_ENGINE)
    {
        ...
        {
            case GAUSSIAN:
                stlGenPtr = StlRandomGeneratorFactory::newGenerator(randist.mu,
                                                                    randist.sigma,
                                                                    seed,
                                                                    stlDist,
                                                                    stlEngine);
            ...
            case FLAT:
                ...
                stlGenPtr = StlRandomGeneratorFactory::newGenerator(get_absolute_min(),
                                                                    get_absolute_max(),
                                                                    seed,
                                                                    stlDist,
                                                                    stlEngine);
