...
int Array_GetCount(RecordArray* pArray) { return pArray->RecordCount; }
...
void Array_SetRecordSize(int size, RecordArray* pArray) { pArray->RecordSize = size; }

int Array_GetBufferSize(RecordArray* pArray) { return *(pArray->BufferSize); }

int Array_GetRecordSize(RecordArray* pArray) { return pArray->RecordSize; }

void* Array_GetBuffer(RecordArray* pArray) { return pArray->Buffer; }

void* Array_GetBufferWithSize(RecordArray* pArray) { return pArray->BufferSize; }
