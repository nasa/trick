...
TEST(Interpolator_unittest, OneDimension)
{
    ...
    Trick::Interpolator* my_interpolator
        = new Trick::Interpolator(table, break_point_arrays, break_point_array_sizes, 1);
...
TEST(Interpolator_unittest, TwoDimension)
{
    ...
    double weight_lb[]
        = {88.2, 110.25, 132.3, 154.35, 176.4, 198.45, 220.5, 242.55, 264.65, 286.65, 308.6, 330.75, 352.7};
    ...
    double bmi_table[]                          = {/*  1.5m    1.6m    1.7m    1.8m    1.9m     2.0m */
    ...
    Trick::Interpolator* bmi_interpolator
        = new Trick::Interpolator(bmi_table, bmi_break_point_arrays, bmi_break_point_array_sizes, 2);
    double bmi;
