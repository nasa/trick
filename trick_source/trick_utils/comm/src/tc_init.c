...
int tc_init_with_connection_info(
    TCDevice* listen_device, int domain, int type, const char* address, unsigned short in_port)
{
    int listen_socket;
    int on = 1;
    ...
    {
        trick_error_report(listen_device->error_handler, TRICK_ERROR_ALERT, __FILE__, __LINE__,
    ...
    {
        trick_error_report(listen_device->error_handler, TRICK_ERROR_ADVISORY, __FILE__, __LINE__,
