...
static TrickErrorHndlr trick_error_hndlr_default = {
    (TrickErrorFuncPtr)trick_error_func_default, (TrickErrorDataPtr*)NULL, TRICK_ERROR_ADVISORY,
    {0,           0,           0,           0,           0,           0,           0,           0,           0},
    {(FILE*)NULL, (FILE*)NULL, (FILE*)NULL, (FILE*)NULL, (FILE*)NULL, (FILE*)NULL, (FILE*)NULL, (FILE*)NULL,
                                                                                                (FILE*)NULL                                                                                              }
};
...
{ /* In: Error message.  */
    ...
    char* label[] = {"ALL", "TRIVIAL", "ADVISORY", "CAUTION", "WARNING", "ALERT", "FATAL", "ABORT", "SILENT"};
    ...
    default:
        if (msg != (char*)NULL)
        {
            snprintf(unknown, sizeof(unknown),
                "Unknown error level: %d!  Something is "
                "seriously wrong!\n   ",
                level);
...
{ /* IN: Err stream for report level */
    ...
    {
        trick_error_report(error_hndlr, TRICK_ERROR_ALERT, __FILE__, __LINE__,
            "Unknown error level for "
...
{ /* In: ** variable length arg list.  */
    ...
    {
        va_end(args);
        (*(error_hndlr->error_func))(
            error_hndlr, TRICK_ERROR_ALERT, __FILE__, __LINE__, "Empty message for trick_error_report.\n");
        return;
    }
