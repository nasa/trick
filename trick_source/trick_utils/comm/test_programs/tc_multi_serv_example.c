...
ATTRIBUTES attrBUFFER[] = {
    {"i1", "int", "--", "", "Not Specified", "", 3, 5, sizeof(int), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"s1", "short", "--", "", "Not Specified", "", 3, 3, sizeof(short), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"s2", "short", "--", "", "Not Specified", "", 3, 3, sizeof(short), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"c1", "char", "--", "", "Not Specified", "", 3, 0, sizeof(char), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"c2", "char", "--", "", "Not Specified", "", 3, 0, sizeof(char), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"c3", "char", "--", "", "Not Specified", "", 3, 0, sizeof(char), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"c4", "char", "--", "", "Not Specified", "", 3, 0, sizeof(char), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"f1", "float", "--", "", "Not Specified", "", 3, 9, sizeof(float), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"b1", "int", "--", "", "Not Specified", "", 3, 11, 0, 0, 0, Language_C, 0, 0, (char *)0, 0, {{5, 27}}},
    {"b2", "int", "--", "", "Not Specified", "", 3, 11, 0, 0, 0, Language_C, 0, 0, (char *)0, 0, {{4, 23}}},
    {"b3", "int", "--", "", "Not Specified", "", 3, 11, 0, 0, 0, Language_C, 0, 0, (char *)0, 0, {{7, 16}}},
    {"b4", "int", "--", "", "Not Specified", "", 3, 11, 0, 0, 0, Language_C, 0, 0, (char *)0, 0, {{13, 3}}},
    {"b5", "int", "--", "", "Not Specified", "", 3, 11, 0, 0, 0, Language_C, 0, 0, (char *)0, 0, {{3, 0}}},
    {"i2", "int", "--", "", "Not Specified", "", 3, 5, sizeof(int), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {"d1", "double", "--", "", "Not Specified", "", 3, 10, sizeof(double), 0, 0, Language_C, 0, 0, (char *)0, 0},
    {""}
};
...
int main(int argc, char * argv[])
{
    ...
    trick_error_init(&err_hndlr, (TrickErrorFuncPtr)NULL, (TrickErrorDataPtr)NULL, TRICK_ERROR_TRIVIAL);
