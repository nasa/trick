...
Trick::TCPConnection::TCPConnection()
    : TCPConnection(0, new SystemInterface())
{
}

Trick::TCPConnection::TCPConnection(SystemInterface* system_interface)
    : TCPConnection(0, system_interface)
{
}

Trick::TCPConnection::TCPConnection(int listen_socket)
    : TCPConnection(listen_socket, new SystemInterface())
{
}

Trick::TCPConnection::TCPConnection(int listen_socket, SystemInterface* system_interface)
...
bool Trick::TCPConnection::isInitialized() { return _connected; }
...
std::string Trick::TCPConnection::getClientTag() { return _client_tag; }
