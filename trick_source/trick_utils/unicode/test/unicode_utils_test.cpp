...
TEST(escape_to_ascii, normal_2)
{
    char output[256];
    /* escape_to_ascii() should escape all Unicode and non-printable ASCII characters. */
    const char ascii[128] = {'\x01', '\x02', '\x03', '\x04', '\x05', '\x06', '\x07', '\x08', '\x09', '\x0a', '\x0b',
...
{
    wchar_t resultant_wchar_s[128];
    const char input[30] = {'e', '\xe2', '\x81', '\xb1', '\xe1', '\xb5', '\xa0', ' ', '=', ' ', 'c', 'o', 's', '(',
        '\xcf', '\x95', ')', ' ', '+', ' ', 'i', '*', 's', 'i', 'n', '(', '\xcf', '\x95', ')', '\0'};
    const wchar_t* expected_wide_s = L"eⁱᵠ = cos(ϕ) + i*sin(ϕ)";
...
{
    wchar_t resultant_wchar_s[128];
    char input[30] = {'e', '\xe2', '\x81', '\xb1', '\xe1', '\xb5', '\xa0', ' ', '=', ' ', 'c', 'o', 's', '(', '\xcf',
        '\x95', ')', ' ', '+', ' ', 'i', '*', 's', 'i', 'n', '(', '\xcf', '\x95', ')', '\0'};
...
TEST(wchar_to_utf8, test2)
{
    ...
    char resultant_utf8_s[128];
    wchar_t wide_s[32] = {L'e', L'ⁱ', L'ᵠ', L' ', L'=', L' ', L'c', L'o', L's', L'(', L'ϕ', L')', L' ', L'+', L' ',
        L'i', L'*', L's', L'i', L'n', L'(', L'ϕ', L')'};
    const char* expected_utf8_s = "eⁱᵠ = cos(ϕ) + i*sin(ϕ)";
