...
int LexicalAnalyzer::next_lexeme()
{
    ...
    while((ch = getch()) != 0)
    {
        switch(state)
        {
            ...
            break;
            case 1:
            { // String literal accumulation state.
                while((ch != 0) && (ch != '"'))
                {
                    ch = getch();
                }
            ...
            break;
            case 2:
            { // Integer literal accumulation state.
...
const char * token_description(int token)
{
    ...
    switch(token)
    {
        case LexicalAnalyzer::END_OF_INPUT:
            text = "END_OF_INPUT";
            break;
        ...
        case LexicalAnalyzer::RIGHT_BRACE:
            text = "RIGHT_BRACE";
            break;
        case LexicalAnalyzer::LEFT_SQUARE_BRACKET:
            text = "LEFT_SQUARE_BRACKET";
            break;
        case LexicalAnalyzer::RIGHT_SQUARE_BRACKET:
            text = "RIGHT_SQUARE_BRACKET";
            break;
