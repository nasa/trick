...
bool FieldDescription::isSTLContainer(const std::string & type_name)
{
    ...
    return (type_name.find("std::vector<") == 0 || type_name.find("std::array<") == 0 ||
            type_name.find("std::list<") == 0 || type_name.find("std::deque<") == 0 ||
            type_name.find("std::set<") == 0 || type_name.find("std::multiset<") == 0 ||
            type_name.find("std::map<") == 0 || type_name.find("std::multimap<") == 0 ||
            type_name.find("std::unordered_set<") == 0 || type_name.find("std::unordered_multiset<") == 0 ||
            type_name.find("std::unordered_map<") == 0 || type_name.find("std::unordered_multimap<") == 0 ||
            type_name.find("std::stack<") == 0 || type_name.find("std::queue<") == 0 ||
            type_name.find("std::priority_queue<") == 0 || type_name.find("std::pair<") == 0);
}
