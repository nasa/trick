...
void EnumValues::setHasDefinition(bool in) { has_definition = in; }

bool EnumValues::getHasDefinition() { return has_definition; }

void EnumValues::setIsUnsigned(bool in) { is_unsigned = in; }

bool EnumValues::getIsUnsigned() { return is_unsigned; }
