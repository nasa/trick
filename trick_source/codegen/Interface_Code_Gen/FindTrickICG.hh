...
class FindTrickICG : public clang::PPCallbacks
{
    public:
        ...
        virtual void FileSkipped(const clang::FileEntry& SkippedFile, const clang::Token& FilenameTok,
        ...
        virtual void Ifdef(
            clang::SourceLocation Loc, const clang::Token& MacroNameTok, const clang::MacroDefinition& MD);
        virtual void Ifndef(
            clang::SourceLocation Loc, const clang::Token& MacroNameTok, const clang::MacroDefinition& MD);
#else
        virtual void Ifdef(
            clang::SourceLocation Loc, const clang::Token& MacroNameTok, const clang::MacroDirective* MD);
        virtual void Ifndef(
            clang::SourceLocation Loc, const clang::Token& MacroNameTok, const clang::MacroDirective* MD);
#endif
