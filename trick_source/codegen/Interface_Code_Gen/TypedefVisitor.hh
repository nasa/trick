...
/**
  ...
  This class is a recursive AST visitor that is called when a TypedefDecl node
...
{
    public:
        TypedefVisitor(clang::CompilerInstance& in_ci, CommentSaver& cs, HeaderSearchDirs& hsd, PrintAttributes& in_pa,
            std::set<std::string>& fdc);
        ...
        // See comment in VisitElaboratedType function for details.
