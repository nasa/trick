...
void PrintFileContents10::print_field_init_attr_stmts(std::ostream & ostream,
...
{
    printStlFunction("checkpoint",
                     "void* start_address, const char* obj_name , const char* var_name",
                     "checkpoint_stl(*stl, obj_name, var_name)",
                     ostream,
                     *fdes,
                     *cv);
}
...
{
    printStlFunction("post_checkpoint",
                     "void* start_address, const char* obj_name , const char* var_name",
                     "delete_stl(*stl, obj_name, var_name)",
                     ostream,
                     *fdes,
                     *cv);
}
...
{
    printStlFunction("restore",
                     "void* start_address, const char* obj_name , const char* var_name",
                     "restore_stl(*stl, obj_name, var_name)",
                     ostream,
                     *fdes,
                     *cv);
}
...
void PrintFileContents10::print_get_stl_element(std::ostream & ostream, FieldDescription * fdes, ClassValues * cv)
{
    ...
    printStlFunction("get_stl_element",
                     "void* start_address, size_t index",
                     element_access,
                     ostream,
                     *fdes,
                     *cv,
...
void PrintFileContents10::print_set_stl_element(std::ostream & ostream, FieldDescription * fdes, ClassValues * cv)
{
    ...
    if(fdes->getSTLTypeEnumString() == "TRICK_STL_VECTOR" && fdes->getSTLElementTypeName() == "bool")
    {
        ...
        printStlFunction("set_stl_element",
                         "void* start_address, size_t index, void* value_ptr",
                         element_write,
                         ostream,
                         *fdes,
                         *cv);
...
void PrintFileContents10::print_stl_helper(std::ostream & ostream, ClassValues * cv)
{
    ...
    fieldDescriptions.erase(std::remove_if(fieldDescriptions.begin(),
...
void PrintFileContents10::printStlFunction(const std::string & name,
...
void PrintFileContents10::addTemplateArgumentHeaderDependency(const std::string & header,
...
void PrintFileContents10::print_template_argument_header_dependencies(std::ostream & outfile,
