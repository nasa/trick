...
void PrintFileContents10::printExternInitAttrHeader(std::ostream& ostream)
{
    ostream << "/*\n"
               " * This file was automatically generated by the ICG\n"
               " * This file contains declarations of the init_attr functions to classes\n"
               " */\n\n";
}

void PrintFileContents10::printExternInitAttr(std::ostream& ostream, ClassValues* cv)
{
    std::string name = cv->getFullyQualifiedMangledTypeName("__");
    ostream << "    extern \"C\" void init_attr" << name << "_c_intf() ;" << std::endl;
}

void PrintFileContents10::printExternInitAttrFooter(std::ostream& ostream) { ostream << std::endl; }
...
void PrintFileContents10::printClassMap(std::ostream& ostream, ClassValues* cv, bool sim_services_flag)
{
    ...
    {
        ostream << "    init_attr" << name << "_c_intf() ;" << std::endl;
    }
}
