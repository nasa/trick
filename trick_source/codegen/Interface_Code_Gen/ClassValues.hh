...
class ClassValues : public ConstructValues
{
    public:
        ...
        void addInheritedFieldDescriptions(
            std::vector<FieldDescription*>, unsigned int class_offset, bool virtual_inherited);

        /** Gets the list of fields in this class */
        const std::vector<FieldDescription*>& getFieldDescriptions() { return field_descripts; }
        ...
        const std::vector<std::string>& getInheritedClasses() { return inherited_classes; }
