...
class PrintFileContents10 : public PrintFileContentsBase
{
    ...
    private:
        ...
        void print_field_init_attr_stmts(
            std::ostream& outfile, FieldDescription* fdes, ClassValues* cv, unsigned int index);
        ...
        void printStlFunction(const std::string& name, const std::string& parameters, const std::string& call,
            std::ostream& ostream, FieldDescription& fieldDescription, ClassValues& classValues,
        ...
        struct HeaderInfo
        {
                ...
                bool operator<(const HeaderInfo& other) const { return header_path < other.header_path; }
        };
