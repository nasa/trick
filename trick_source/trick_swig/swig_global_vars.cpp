...
#define SWIG_InstallConstants(d, constants) SWIG_Python_InstallConstants(d, constants)
...
#else
                PyObject_HEAD_INIT(NULL) 0, /* Number of items in variable part (ob_size) */
#endif
    ...
    SWIGINTERN void SWIG_Python_addvarlink(
        PyObject* p, char* name, PyObject* (*get_attr)(void), int (*set_attr)(PyObject* p))
    {
    ...
    PyObject* new_cvar_list() { return SWIG_globals(); }
