...
bool LabeledRuler::_isFits(const QList<LabelBox> &boxes,
...
//
QList<LabelBox> LabeledRuler::_moveCurrBoxToFit(const QList<LabelBox> &boxes,
                                       int currBoxIdx,
                                       int lastBoxIdx,
                                       const QRectF &W, double minGap)
{
...
//     Return:  {0.4,0.8}
//
QList<LabelBox> LabeledRuler::_halfBoxSet(const QList<LabelBox> &boxes,
                                          Qt::Alignment alignment)
{
    QList<LabelBox> bxs;
